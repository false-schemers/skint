    ...
    (let recur ([form (sub-read p)])
      (cond [(eof-object? form)
            ...
            [(or (and (eq? ts 'u8)  (fixnum? form) (fx<=? 0 form 255))
                 ...
                 (and (eq? ts 'u32) (integer? form) (exact? form) (>= form 0) (fx<=? (integer-length form) 32))
                 (and (eq? ts 's32) (integer? form) (exact? form) (fx<? (integer-length form) 32))
                 (and (eq? ts 'u64) (integer? form) (exact? form) (>= form 0) (fx<=? (integer-length form) 64))
                 (and (eq? ts 's64) (integer? form) (exact? form) (fx<? (integer-length form) 64))
                 (and (eq? ts 'f32) (flonum? form))
                 (and (eq? ts 'f64) (flonum? form))
                 (and (eq? ts 'c64) (number? form) (inexact? form))
                 (and (eq? ts 'c128) (number? form) (inexact? form)))
