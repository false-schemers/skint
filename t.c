...
char *t_code[] = {
  ...
  "C", 0,
  "${'(l563:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  "6:flcosh;;l1:y6:fltanh;;l1:y7:fllog10;;l1:y14:string->flonum;;l1:y8:li"
  "st-cat;;l1:y9:last-pair;;l1:y9:list-head;;l1:y4:meme;;l1:y4:asse;;l1:y"
  "4:memp;;l1:y4:assp;;l1:y8:reverse!;;l1:y9:circular?;;l1:y5:cons*;;l1:y"
  "5:list*;;l1:y8:char-cmp;;l1:y11:char-ci-cmp;;l1:y10:string-cat;;l1:y15"
  ":string-position;;l1:y10:string-cmp;;l1:y13:string-ci-cmp;;l1:y10:vect"
  "or-cat;;l1:y12:bytevector=?;;l1:y16:bytevector->list;;l1:y16:list->byt"
  "evector;;l1:y13:subbytevector;;l1:y10:numvector?;;l1:y14:make-numvecto"
  "r;;l1:y16:numvector-length;;l1:y13:numvector-ref;;l1:y14:numvector-set"
  "!;;l1:y15:list->numvector;;l1:y19:standard-input-port;;l1:y20:standard"
  "-output-port;;l1:y19:standard-error-port;;l1:y9:tty-port?;;l1:y15:port"
  "-fold-case?;;l1:y19:set-port-fold-case!;;l1:y11:rename-file;;l1:y17:cu"
  "rrent-directory;;l1:y19:directory-separator;;l1:y14:path-separator;;l1"
  ":y4:void;;l1:y5:void?;;l1:y19:implementation-name;;l1:y22:implementati"
  "on-version;;l1:y13:version-alist;;l1:y16:current-language;;l1:y15:curr"
  "ent-country;;l1:y22:current-locale-details;;l1:y3:id?;;l1:y10:string->"
  "id;;l1:y10:id->string;;py10:flcopysign;y8:c99-math;;py10:flsign-bit;y8"
  ":c99-math;;py10:fladjacent;y8:c99-math;;py13:flnormalized?;y8:c99-math"
  ";;py15:fldenormalized?;y8:c99-math;;py10:flexponent;y8:c99-math;;py7:f"
  "lilogb;y8:c99-math;;py4:fl+*;y8:c99-math;;py9:flposdiff;y8:c99-math;;p"
  "y6:flexp2;y8:c99-math;;py7:flexp-1;y8:c99-math;;py6:flcbrt;y8:c99-math"
  ";;py7:flhypot;y8:c99-math;;py7:fllog1+;y8:c99-math;;py6:fllog2;y8:c99-"
  "math;;py7:flasinh;y8:c99-math;;py7:flacosh;y8:c99-math;;py7:flatanh;y8"
  ":c99-math;;py9:%25flremquo;y8:c99-math;;py7:flgamma;y8:c99-math;;py8:f"
  "llgamma;y8:c99-math;;py5:flerf;y8:c99-math;;py6:flerfc;y8:c99-math;;py"
  "14:flfirst-bessel;y8:xsi-math;;py15:flsecond-bessel;y8:xsi-math;;py20:"
  "*user-name-registry*;y6:hidden;;py25:make-readonly-environment;y6:hidd"
  "en;;py27:make-controlled-environment;y6:hidden;;py20:make-sld-environm"
  "ent;y6:hidden;;py21:make-repl-environment;y6:hidden;;py19:find-library"
  "-in-env;y6:hidden;;py16:root-environment;y6:hidden;;py16:repl-environm"
  "ent;y6:hidden;;py17:empty-environment;y6:hidden;;py32:make-historic-re"
  "port-environment;y6:hidden;;py16:r5rs-environment;y6:hidden;;py21:r5rs"
  "-null-environment;y6:hidden;;py9:*verbose*;y6:hidden;;py7:*quiet*;y6:h"
  "idden;;py25:compile-and-run-core-expr;y6:hidden;;py17:evaluate-top-for"
  "m;y6:hidden;;py10:run-script;y6:hidden;;py11:run-program;y6:hidden;;py"
  "22:repl-evaluate-top-form;y6:hidden;;py9:repl-read;y6:hidden;;py17:rep"
  "l-exec-command;y6:hidden;;py14:repl-from-port;y6:hidden;;py13:run-benc"
  "hmark;y6:hidden;;py4:repl;y6:hidden;;),&0{%1,,,,#0#1#2#3&0{%1.0,'(y1:w"
  "),.1v?{'(l2:y6:scheme;y5:write;)]2}'(y1:t),.1v?{'(l2:y6:scheme;y4:time"
  ";)]2}'(y1:p),.1v?{'(l2:y6:scheme;y4:repl;)]2}'(y1:r),.1v?{'(l2:y6:sche"
  "me;y4:read;)]2}'(y1:v),.1v?{'(l2:y6:scheme;y4:r5rs;)]2}'(y1:u),.1v?{'("
  "l2:y6:scheme;y9:r5rs-null;)]2}'(y1:d),.1v?{'(l2:y6:scheme;y4:load;)]2}"
  "'(y1:z),.1v?{'(l2:y6:scheme;y4:lazy;)]2}'(y1:s),.1v?{'(l2:y6:scheme;y1"
  "5:process-context;)]2}'(y1:i),.1v?{'(l2:y6:scheme;y7:inexact;)]2}'(y1:"
  "f),.1v?{'(l2:y6:scheme;y4:file;)]2}'(y1:e),.1v?{'(l2:y6:scheme;y4:eval"
  ";)]2}'(y1:o),.1v?{'(l2:y6:scheme;y7:complex;)]2}'(y1:h),.1v?{'(l2:y6:s"
  "cheme;y4:char;)]2}'(y1:l),.1v?{'(l2:y6:scheme;y11:case-lambda;)]2}'(y1"
  ":a),.1v?{'(l2:y6:scheme;y3:cxr;)]2}'(y1:b),.1v?{'(l2:y6:scheme;y4:base"
  ";)]2}'(y1:x),.1v?{'(l2:y6:scheme;y3:box;)]2}.1Nw!?{.1,'(y4:srfi),l2]2}"
  ...
  "10),&5{%2.1u?{${.2,:0^[01},.1,${'(l1:y5:skint;),:1^[01},:3^[23}'(y8:c9"
  "9-math),.2q?{@(y10:*features*),'(y8:c99-math)A0~}{f},.0?{.0]3}'(y8:xsi"
  "-math),.3q?{@(y10:*features*),'(y8:xsi-math)A0~}{f},.0?{.0]4}.3p~?{${."
  "4,:0^[01},.3,${n,.8c,'(y5:skint)c,:1^[01},:3^[43}${${.6,:0^[01},.5,${$"
  "{.(i11)a,:2^[01},:1^[01},:3^[03}.3d,.3,:4^[42}.!0.0^_1[52},@(y10:%25fo"
  "r-each1)[02}",
