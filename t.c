...
char *t_code[] = {
  ...
  "C", 0,
  "${'(l577:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  ";l3:y8:set-box!;y1:x;i111;;l1:y6:format;;l1:y7:fprintf;;l1:y19:format-"
  "pretty-print;;l1:y18:format-fixed-print;;l1:y17:format-fresh-line;;l1:"
  "y18:format-help-string;;l1:y4:set&;;l1:y7:lambda*;;l1:y4:body;;l1:y5:l"
  "etcc;;l1:y6:withcc;;l1:y13:syntax-lambda;;l1:y13:syntax-length;;l1:y6:"
  "expand;;l1:y7:record?;;l1:y11:make-record;;l1:y13:record-length;;l1:y1"
  "0:record-ref;;l1:y11:record-set!;;l1:y22:record-type-descriptor;;l1:y7"
  ":fixnum?;;l1:y11:fxpositive?;;l1:y11:fxnegative?;;l1:y7:fxeven?;;l1:y6"
  ":fxodd?;;l1:y7:fxzero?;;l1:y3:fx+;;l1:y3:fx*;;l1:y3:fx-;;l1:y3:fx/;;l1"
  ":y10:fxquotient;;l1:y11:fxremainder;;l1:y8:fxmodquo;;l1:y8:fxmodulo;;l"
  "1:y8:fxeucquo;;l1:y8:fxeucrem;;l1:y5:fxneg;;l1:y5:fxabs;;l1:y4:fx<?;;l"
  "1:y5:fx<=?;;l1:y4:fx>?;;l1:y5:fx>=?;;l1:y4:fx=?;;l1:y5:fx!=?;;l1:y5:fx"
  "min;;l1:y5:fxmax;;l1:y5:fxneg;;l1:y5:fxabs;;l1:y5:fxgcd;;l1:y6:fxexpt;"
  ";l1:y7:%25fxsqrt;;l1:y5:fxnot;;l1:y5:fxand;;l1:y5:fxior;;l1:y5:fxxor;;"
  "l1:y5:fxsll;;l1:y5:fxsra;;l1:y5:fxsrl;;l1:y5:fxeqv;;l1:y8:fxlength;;l1"
  ":y11:fxbit-count;;l1:y6:fxaddc;;l1:y6:fxsubc;;l1:y6:fxmulc;;l1:y6:fxfm"
  "ar;;l1:y14:fixnum->flonum;;l1:y14:fixnum->string;;l1:y14:string->fixnu"
  ...
  "y11:flremainder;;l1:y8:flmodulo;;l1:y10:flquotient;;l1:y8:flmodquo;;l1"
  ":y14:flonum->fixnum;;l1:y14:flonum->string;;l1:y7:flldexp;;l1:y6:flmod"
  "f;;l1:y7:flfrexp;;l1:y6:flsinh;;l1:y6:flcosh;;l1:y6:fltanh;;l1:y7:fllo"
  "g10;;l1:y14:string->flonum;;l1:y11:bitwise-not;;l1:y11:bitwise-and;;l1"
  ":y11:bitwise-ior;;l1:y11:bitwise-xor;;l1:y16:arithmetic-shift;;l1:y14:"
  "integer-length;;l1:y9:bit-count;;l1:y7:bignum?;;l1:y7:ratnum?;;l1:y8:c"
  "ompnum?;;l1:y8:rectnum?;;l1:y15:inexact->string;;l1:y8:list-cat;;l1:y9"
  ":last-pair;;l1:y9:list-head;;l1:y4:meme;;l1:y4:asse;;l1:y4:memp;;l1:y4"
  ":assp;;l1:y8:reverse!;;l1:y9:circular?;;l1:y5:cons*;;l1:y5:list*;;l1:y"
  "8:char-cmp;;l1:y11:char-ci-cmp;;l1:y10:string-cat;;l1:y15:string-posit"
  "ion;;l1:y10:string-cmp;;l1:y13:string-ci-cmp;;l1:y10:vector-cat;;l1:y1"
  "2:bytevector=?;;l1:y16:bytevector->list;;l1:y16:list->bytevector;;l1:y"
  "13:subbytevector;;l1:y10:numvector?;;l1:y14:make-numvector;;l1:y16:num"
  "vector-length;;l1:y13:numvector-ref;;l1:y14:numvector-set!;;l1:y15:lis"
  "t->numvector;;l1:y19:standard-input-port;;l1:y20:standard-output-port;"
  ";l1:y19:standard-error-port;;l1:y9:tty-port?;;l1:y15:port-fold-case?;;"
  "l1:y19:set-port-fold-case!;;l1:y11:rename-file;;l1:y17:current-directo"
  "ry;;l1:y19:directory-separator;;l1:y14:path-separator;;l1:y4:void;;l1:"
  "y5:void?;;l1:y19:implementation-name;;l1:y22:implementation-version;;l"
  "1:y13:version-alist;;l1:y16:current-language;;l1:y15:current-country;;"
  "l1:y22:current-locale-details;;l1:y3:id?;;l1:y10:string->id;;l1:y10:id"
  "->string;;py10:flcopysign;y8:c99-math;;py10:flsign-bit;y8:c99-math;;py"
  "10:fladjacent;y8:c99-math;;py13:flnormalized?;y8:c99-math;;py15:fldeno"
  "rmalized?;y8:c99-math;;py10:flexponent;y8:c99-math;;py7:flilogb;y8:c99"
  "-math;;py4:fl+*;y8:c99-math;;py9:flposdiff;y8:c99-math;;py6:flexp2;y8:"
  "c99-math;;py7:flexp-1;y8:c99-math;;py6:flcbrt;y8:c99-math;;py7:flhypot"
  ";y8:c99-math;;py7:fllog1+;y8:c99-math;;py6:fllog2;y8:c99-math;;py7:fla"
  "sinh;y8:c99-math;;py7:flacosh;y8:c99-math;;py7:flatanh;y8:c99-math;;py"
  "9:%25flremquo;y8:c99-math;;py7:flgamma;y8:c99-math;;py8:fllgamma;y8:c9"
  "9-math;;py5:flerf;y8:c99-math;;py6:flerfc;y8:c99-math;;py14:flfirst-be"
  "ssel;y8:xsi-math;;py15:flsecond-bessel;y8:xsi-math;;py20:*user-name-re"
  "gistry*;y6:hidden;;py25:make-readonly-environment;y6:hidden;;py27:make"
  "-controlled-environment;y6:hidden;;py20:make-sld-environment;y6:hidden"
  ";;py21:make-repl-environment;y6:hidden;;py19:find-library-in-env;y6:hi"
  "dden;;py16:root-environment;y6:hidden;;py16:repl-environment;y6:hidden"
  ";;py17:empty-environment;y6:hidden;;py32:make-historic-report-environm"
  "ent;y6:hidden;;py16:r5rs-environment;y6:hidden;;py21:r5rs-null-environ"
  "ment;y6:hidden;;py9:*verbose*;y6:hidden;;py7:*quiet*;y6:hidden;;py25:c"
  "ompile-and-run-core-expr;y6:hidden;;py17:evaluate-top-form;y6:hidden;;"
  "py10:run-script;y6:hidden;;py11:run-program;y6:hidden;;py22:repl-evalu"
  "ate-top-form;y6:hidden;;py9:repl-read;y6:hidden;;py17:repl-exec-comman"
  "d;y6:hidden;;py14:repl-from-port;y6:hidden;;py13:run-benchmark;y6:hidd"
  "en;;py4:repl;y6:hidden;;),&0{%1,,,,#0#1#2#3&0{%1.0,'(y1:w),.1v?{'(l2:y"
  "6:scheme;y5:write;)]2}'(y1:t),.1v?{'(l2:y6:scheme;y4:time;)]2}'(y1:p),"
  ".1v?{'(l2:y6:scheme;y4:repl;)]2}'(y1:r),.1v?{'(l2:y6:scheme;y4:read;)]"
  "2}'(y1:v),.1v?{'(l2:y6:scheme;y4:r5rs;)]2}'(y1:u),.1v?{'(l2:y6:scheme;"
  "y9:r5rs-null;)]2}'(y1:d),.1v?{'(l2:y6:scheme;y4:load;)]2}'(y1:z),.1v?{"
  "'(l2:y6:scheme;y4:lazy;)]2}'(y1:s),.1v?{'(l2:y6:scheme;y15:process-con"
  "text;)]2}'(y1:i),.1v?{'(l2:y6:scheme;y7:inexact;)]2}'(y1:f),.1v?{'(l2:"
  "y6:scheme;y4:file;)]2}'(y1:e),.1v?{'(l2:y6:scheme;y4:eval;)]2}'(y1:o),"
  ".1v?{'(l2:y6:scheme;y7:complex;)]2}'(y1:h),.1v?{'(l2:y6:scheme;y4:char"
  ";)]2}'(y1:l),.1v?{'(l2:y6:scheme;y11:case-lambda;)]2}'(y1:a),.1v?{'(l2"
  ":y6:scheme;y3:cxr;)]2}'(y1:b),.1v?{'(l2:y6:scheme;y4:base;)]2}'(y1:x),"
  ".1v?{'(l2:y6:scheme;y3:box;)]2}.1Nw!?{.1,'(y4:srfi),l2]2}.1,l1]2}.!0&0"
  "{%1${&0{%1n,'(l1:y5:begin;),V12]1},.3,@(y20:*root-name-registry*),@(y1"
  "1:name-lookup)[03}z]1}.!1&0{%3'1,.1V4,.0,.3A3,.0?{.4,.1sd]5}.1,.5,.5cc"
  ",'1,.4V5]5}.!2&0{%1&0{%1.0,'(y5:const),l2]1},.1,@(y20:*root-name-regis"
  "try*),@(y11:name-lookup)[13}.!3.4d,.5a,,#0.0,.6,.5,.7,.(i10),&5{%2.1u?"
  "{${.2,:0^[01},.1,${'(l1:y5:skint;),:1^[01},:3^[23}'(y8:c99-math),.2q?{"
  "@(y10:*features*),'(y8:c99-math)A0~}{f},.0?{.0]3}'(y8:xsi-math),.3q?{@"
  "(y10:*features*),'(y8:xsi-math)A0~}{f},.0?{.0]4}.3p~?{${.4,:0^[01},.3,"
  "${n,.8c,'(y5:skint)c,:1^[01},:3^[43}${${.6,:0^[01},.5,${${.(i11)a,:2^["
  "01},:1^[01},:3^[03}.3d,.3,:4^[42}.!0.0^_1[52},@(y10:%25for-each1)[02}",
