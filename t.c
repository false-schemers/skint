...
char *t_code[] = {
  ...
  "C", 0,
  "${'(l580:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  "e;;l1:y18:format-help-string;;l1:y4:set&;;l1:y7:lambda*;;l1:y4:body;;l"
  ...
  "xexpt;;l1:y7:%25fxsqrt;;l1:y5:fxnot;;l1:y5:fxand;;l1:y5:fxior;;l1:y5:f"
  "xxor;;l1:y5:fxsll;;l1:y5:fxsra;;l1:y5:fxsrl;;l1:y5:fxeqv;;l1:y8:fxleng"
  "th;;l1:y11:fxbit-count;;l1:y6:fxaddc;;l1:y6:fxsubc;;l1:y6:fxmulc;;l1:y"
  "6:fxfmar;;l1:y14:fixnum->flonum;;l1:y14:fixnum->string;;l1:y14:string-"
  ">fixnum;;l1:y7:flonum?;;l1:y7:flzero?;;l1:y11:flpositive?;;l1:y11:flne"
  "gative?;;l1:y10:flinteger?;;l1:y6:flnan?;;l1:y11:flinfinite?;;l1:y9:fl"
  "finite?;;l1:y7:fleven?;;l1:y6:flodd?;;l1:y3:fl+;;l1:y3:fl*;;l1:y3:fl-;"
  ";l1:y3:fl/;;l1:y5:flneg;;l1:y5:flabs;;l1:y5:flgcd;;l1:y6:flexpt;;l1:y6"
  ":flsqrt;;l1:y7:flfloor;;l1:y9:flceiling;;l1:y10:fltruncate;;l1:y7:flro"
  "und;;l1:y5:flexp;;l1:y5:fllog;;l1:y5:flsin;;l1:y5:flcos;;l1:y5:fltan;;"
  "l1:y6:flasin;;l1:y6:flacos;;l1:y6:flatan;;l1:y4:fl<?;;l1:y5:fl<=?;;l1:"
  "y4:fl>?;;l1:y5:fl>=?;;l1:y4:fl=?;;l1:y5:fl!=?;;l1:y5:flmin;;l1:y5:flma"
  "x;;l1:y11:flremainder;;l1:y8:flmodulo;;l1:y10:flquotient;;l1:y8:flmodq"
  "uo;;l1:y14:flonum->fixnum;;l1:y14:flonum->string;;l1:y7:flldexp;;l1:y6"
  ":flmodf;;l1:y7:flfrexp;;l1:y6:flsinh;;l1:y6:flcosh;;l1:y6:fltanh;;l1:y"
  "7:fllog10;;l1:y14:string->flonum;;l1:y11:bitwise-not;;l1:y11:bitwise-a"
  "nd;;l1:y11:bitwise-ior;;l1:y11:bitwise-xor;;l1:y16:arithmetic-shift;;l"
  "1:y14:integer-length;;l1:y9:bit-count;;l1:y7:bignum?;;l1:y7:ratnum?;;l"
  "1:y8:compnum?;;l1:y8:rectnum?;;l1:y15:inexact->string;;l1:y8:list-cat;"
  ";l1:y9:last-pair;;l1:y9:list-head;;l1:y4:meme;;l1:y4:asse;;l1:y4:memp;"
  ";l1:y4:assp;;l1:y8:reverse!;;l1:y9:circular?;;l1:y5:cons*;;l1:y5:list*"
  ...
  ";;l1:y13:subbytevector;;l1:y10:numvector?;;l1:y14:make-numvector;;l1:y"
  "16:numvector-length;;l1:y13:numvector-ref;;l1:y14:numvector-set!;;l1:y"
  "15:list->numvector;;l1:y19:standard-input-port;;l1:y20:standard-output"
  "-port;;l1:y19:standard-error-port;;l1:y9:tty-port?;;l1:y15:port-fold-c"
  "ase?;;l1:y19:set-port-fold-case!;;l1:y11:rename-file;;l1:y17:current-d"
  "irectory;;l1:y19:directory-separator;;l1:y14:path-separator;;l1:y4:voi"
  "d;;l1:y5:void?;;l1:y19:implementation-name;;l1:y22:implementation-vers"
  "ion;;l1:y13:version-alist;;l1:y16:current-language;;l1:y15:current-cou"
  "ntry;;l1:y22:current-locale-details;;l1:y3:id?;;l1:y10:string->id;;l1:"
  "y10:id->string;;py10:flcopysign;y8:c99-math;;py10:flsign-bit;y8:c99-ma"
  "th;;py10:fladjacent;y8:c99-math;;py13:flnormalized?;y8:c99-math;;py15:"
  "fldenormalized?;y8:c99-math;;py10:flexponent;y8:c99-math;;py7:flilogb;"
  "y8:c99-math;;py4:fl+*;y8:c99-math;;py9:flposdiff;y8:c99-math;;py6:flex"
  "p2;y8:c99-math;;py7:flexp-1;y8:c99-math;;py6:flcbrt;y8:c99-math;;py7:f"
  "lhypot;y8:c99-math;;py7:fllog1+;y8:c99-math;;py6:fllog2;y8:c99-math;;p"
  "y7:flasinh;y8:c99-math;;py7:flacosh;y8:c99-math;;py7:flatanh;y8:c99-ma"
  "th;;py9:%25flremquo;y8:c99-math;;py7:flgamma;y8:c99-math;;py8:fllgamma"
  ";y8:c99-math;;py5:flerf;y8:c99-math;;py6:flerfc;y8:c99-math;;py14:flfi"
  "rst-bessel;y8:xsi-math;;py15:flsecond-bessel;y8:xsi-math;;py20:*user-n"
  "ame-registry*;y6:hidden;;py25:make-readonly-environment;y6:hidden;;py2"
  "7:make-controlled-environment;y6:hidden;;py20:make-sld-environment;y6:"
  "hidden;;py21:make-repl-environment;y6:hidden;;py19:find-library-in-env"
  ";y6:hidden;;py16:root-environment;y6:hidden;;py16:repl-environment;y6:"
  "hidden;;py17:empty-environment;y6:hidden;;py32:make-historic-report-en"
  "vironment;y6:hidden;;py16:r5rs-environment;y6:hidden;;py21:r5rs-null-e"
  "nvironment;y6:hidden;;py9:*verbose*;y6:hidden;;py7:*quiet*;y6:hidden;;"
  "py25:compile-and-run-core-expr;y6:hidden;;py17:evaluate-top-form;y6:hi"
  "dden;;py10:run-script;y6:hidden;;py11:run-program;y6:hidden;;py22:repl"
  "-evaluate-top-form;y6:hidden;;py9:repl-read;y6:hidden;;py17:repl-exec-"
  "command;y6:hidden;;py14:repl-from-port;y6:hidden;;py13:run-benchmark;y"
  "6:hidden;;py4:repl;y6:hidden;;),&0{%1,,,,#0#1#2#3&0{%1.0,'(y1:w),.1v?{"
  "'(l2:y6:scheme;y5:write;)]2}'(y1:t),.1v?{'(l2:y6:scheme;y4:time;)]2}'("
  "y1:p),.1v?{'(l2:y6:scheme;y4:repl;)]2}'(y1:r),.1v?{'(l2:y6:scheme;y4:r"
  "ead;)]2}'(y1:v),.1v?{'(l2:y6:scheme;y4:r5rs;)]2}'(y1:u),.1v?{'(l2:y6:s"
  "cheme;y9:r5rs-null;)]2}'(y1:d),.1v?{'(l2:y6:scheme;y4:load;)]2}'(y1:z)"
  ",.1v?{'(l2:y6:scheme;y4:lazy;)]2}'(y1:s),.1v?{'(l2:y6:scheme;y15:proce"
  "ss-context;)]2}'(y1:i),.1v?{'(l2:y6:scheme;y7:inexact;)]2}'(y1:f),.1v?"
  "{'(l2:y6:scheme;y4:file;)]2}'(y1:e),.1v?{'(l2:y6:scheme;y4:eval;)]2}'("
  "y1:o),.1v?{'(l2:y6:scheme;y7:complex;)]2}'(y1:h),.1v?{'(l2:y6:scheme;y"
  "4:char;)]2}'(y1:l),.1v?{'(l2:y6:scheme;y11:case-lambda;)]2}'(y1:a),.1v"
  "?{'(l2:y6:scheme;y3:cxr;)]2}'(y1:b),.1v?{'(l2:y6:scheme;y4:base;)]2}'("
  "y1:x),.1v?{'(l2:y6:scheme;y3:box;)]2}.1Nw!?{.1,'(y4:srfi),l2]2}.1,l1]2"
  "}.!0&0{%1${&0{%1n,'(l1:y5:begin;),V12]1},.3,@(y20:*root-name-registry*"
  "),@(y11:name-lookup)[03}z]1}.!1&0{%3'1,.1V4,.0,.3A3,.0?{.4,.1sd]5}.1,."
  "5,.5cc,'1,.4V5]5}.!2&0{%1&0{%1.0,'(y5:const),l2]1},.1,@(y20:*root-name"
  "-registry*),@(y11:name-lookup)[13}.!3.4d,.5a,,#0.0,.6,.5,.7,.(i10),&5{"
  "%2.1u?{${.2,:0^[01},.1,${'(l1:y5:skint;),:1^[01},:3^[23}'(y8:c99-math)"
  ",.2q?{@(y10:*features*),'(y8:c99-math)A0~}{f},.0?{.0]3}'(y8:xsi-math),"
  ".3q?{@(y10:*features*),'(y8:xsi-math)A0~}{f},.0?{.0]4}.3p~?{${.4,:0^[0"
  "1},.3,${n,.8c,'(y5:skint)c,:1^[01},:3^[43}${${.6,:0^[01},.5,${${.(i11)"
  "a,:2^[01},:1^[01},:3^[03}.3d,.3,:4^[42}.!0.0^_1[52},@(y10:%25for-each1"
  ")[02}",
