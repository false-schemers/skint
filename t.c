...
char *t_code[] = {
  ...
  "C", 0,
  "${'(l576:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  "ompnum?;;l1:y8:rectnum?;;l1:y8:list-cat;;l1:y9:last-pair;;l1:y9:list-h"
  "ead;;l1:y4:meme;;l1:y4:asse;;l1:y4:memp;;l1:y4:assp;;l1:y8:reverse!;;l"
  "1:y9:circular?;;l1:y5:cons*;;l1:y5:list*;;l1:y8:char-cmp;;l1:y11:char-"
  "ci-cmp;;l1:y10:string-cat;;l1:y15:string-position;;l1:y10:string-cmp;;"
  "l1:y13:string-ci-cmp;;l1:y10:vector-cat;;l1:y12:bytevector=?;;l1:y16:b"
  "ytevector->list;;l1:y16:list->bytevector;;l1:y13:subbytevector;;l1:y10"
  ":numvector?;;l1:y14:make-numvector;;l1:y16:numvector-length;;l1:y13:nu"
  "mvector-ref;;l1:y14:numvector-set!;;l1:y15:list->numvector;;l1:y19:sta"
  ...
  "ntation-name;;l1:y22:implementation-version;;l1:y13:version-alist;;l1:"
  "y16:current-language;;l1:y15:current-country;;l1:y22:current-locale-de"
  "tails;;l1:y3:id?;;l1:y10:string->id;;l1:y10:id->string;;py10:flcopysig"
  "n;y8:c99-math;;py10:flsign-bit;y8:c99-math;;py10:fladjacent;y8:c99-mat"
  "h;;py13:flnormalized?;y8:c99-math;;py15:fldenormalized?;y8:c99-math;;p"
  "y10:flexponent;y8:c99-math;;py7:flilogb;y8:c99-math;;py4:fl+*;y8:c99-m"
  "ath;;py9:flposdiff;y8:c99-math;;py6:flexp2;y8:c99-math;;py7:flexp-1;y8"
  ":c99-math;;py6:flcbrt;y8:c99-math;;py7:flhypot;y8:c99-math;;py7:fllog1"
  "+;y8:c99-math;;py6:fllog2;y8:c99-math;;py7:flasinh;y8:c99-math;;py7:fl"
  "acosh;y8:c99-math;;py7:flatanh;y8:c99-math;;py9:%25flremquo;y8:c99-mat"
  "h;;py7:flgamma;y8:c99-math;;py8:fllgamma;y8:c99-math;;py5:flerf;y8:c99"
  "-math;;py6:flerfc;y8:c99-math;;py14:flfirst-bessel;y8:xsi-math;;py15:f"
  "lsecond-bessel;y8:xsi-math;;py20:*user-name-registry*;y6:hidden;;py25:"
  "make-readonly-environment;y6:hidden;;py27:make-controlled-environment;"
  "y6:hidden;;py20:make-sld-environment;y6:hidden;;py21:make-repl-environ"
  "ment;y6:hidden;;py19:find-library-in-env;y6:hidden;;py16:root-environm"
  "ent;y6:hidden;;py16:repl-environment;y6:hidden;;py17:empty-environment"
  ";y6:hidden;;py32:make-historic-report-environment;y6:hidden;;py16:r5rs"
  "-environment;y6:hidden;;py21:r5rs-null-environment;y6:hidden;;py9:*ver"
  "bose*;y6:hidden;;py7:*quiet*;y6:hidden;;py25:compile-and-run-core-expr"
  ";y6:hidden;;py17:evaluate-top-form;y6:hidden;;py10:run-script;y6:hidde"
  "n;;py11:run-program;y6:hidden;;py22:repl-evaluate-top-form;y6:hidden;;"
  "py9:repl-read;y6:hidden;;py17:repl-exec-command;y6:hidden;;py14:repl-f"
  "rom-port;y6:hidden;;py13:run-benchmark;y6:hidden;;py4:repl;y6:hidden;;"
  ...
  "6:scheme;y11:case-lambda;)]2}'(y1:a),.1v?{'(l2:y6:scheme;y3:cxr;)]2}'("
  "y1:b),.1v?{'(l2:y6:scheme;y4:base;)]2}'(y1:x),.1v?{'(l2:y6:scheme;y3:b"
  "ox;)]2}.1Nw!?{.1,'(y4:srfi),l2]2}.1,l1]2}.!0&0{%1${&0{%1n,'(l1:y5:begi"
  ...
  "y5:skint;),:1^[01},:3^[23}'(y8:c99-math),.2q?{@(y10:*features*),'(y8:c"
  "99-math)A0~}{f},.0?{.0]3}'(y8:xsi-math),.3q?{@(y10:*features*),'(y8:xs"
  "i-math)A0~}{f},.0?{.0]4}.3p~?{${.4,:0^[01},.3,${n,.8c,'(y5:skint)c,:1^"
  "[01},:3^[43}${${.6,:0^[01},.5,${${.(i11)a,:2^[01},:1^[01},:3^[03}.3d,."
  "3,:4^[42}.!0.0^_1[52},@(y10:%25for-each1)[02}",
