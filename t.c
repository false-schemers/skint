...
char *t_code[] = {
  ...
  "C", 0,
  "${'(l559:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  "ale-details;;py10:flcopysign;y8:c99-math;;py10:flsign-bit;y8:c99-math;"
  ";py10:fladjacent;y8:c99-math;;py13:flnormalized?;y8:c99-math;;py15:fld"
  "enormalized?;y8:c99-math;;py10:flexponent;y8:c99-math;;py7:flilogb;y8:"
  "c99-math;;py4:fl+*;y8:c99-math;;py9:flposdiff;y8:c99-math;;py6:flexp2;"
  "y8:c99-math;;py7:flexp-1;y8:c99-math;;py6:flcbrt;y8:c99-math;;py7:flhy"
  "pot;y8:c99-math;;py7:fllog1+;y8:c99-math;;py6:fllog2;y8:c99-math;;py7:"
  "flasinh;y8:c99-math;;py7:flacosh;y8:c99-math;;py7:flatanh;y8:c99-math;"
  ...
  "-registry*;y6:hidden;;py25:make-readonly-environment;y6:hidden;;py27:m"
  "ake-controlled-environment;y6:hidden;;py20:make-sld-environment;y6:hid"
  "den;;py21:make-repl-environment;y6:hidden;;py19:find-library-in-env;y6"
  ":hidden;;py16:root-environment;y6:hidden;;py16:repl-environment;y6:hid"
  "den;;py17:empty-environment;y6:hidden;;py32:make-historic-report-envir"
  "onment;y6:hidden;;py16:r5rs-environment;y6:hidden;;py21:r5rs-null-envi"
  "ronment;y6:hidden;;py9:*verbose*;y6:hidden;;py7:*quiet*;y6:hidden;;py2"
  "5:compile-and-run-core-expr;y6:hidden;;py17:evaluate-top-form;y6:hidde"
  "n;;py10:run-script;y6:hidden;;py11:run-program;y6:hidden;;py22:repl-ev"
  "aluate-top-form;y6:hidden;;py9:repl-read;y6:hidden;;py17:repl-exec-com"
  "mand;y6:hidden;;py14:repl-from-port;y6:hidden;;py13:run-benchmark;y6:h"
  "idden;;py4:repl;y6:hidden;;),&0{%1,,,,#0#1#2#3&0{%1.0,'(y1:w),.1v?{'(l"
  "2:y6:scheme;y5:write;)]2}'(y1:t),.1v?{'(l2:y6:scheme;y4:time;)]2}'(y1:"
  "p),.1v?{'(l2:y6:scheme;y4:repl;)]2}'(y1:r),.1v?{'(l2:y6:scheme;y4:read"
  ";)]2}'(y1:v),.1v?{'(l2:y6:scheme;y4:r5rs;)]2}'(y1:u),.1v?{'(l2:y6:sche"
  "me;y9:r5rs-null;)]2}'(y1:d),.1v?{'(l2:y6:scheme;y4:load;)]2}'(y1:z),.1"
  "v?{'(l2:y6:scheme;y4:lazy;)]2}'(y1:s),.1v?{'(l2:y6:scheme;y15:process-"
  "context;)]2}'(y1:i),.1v?{'(l2:y6:scheme;y7:inexact;)]2}'(y1:f),.1v?{'("
  "l2:y6:scheme;y4:file;)]2}'(y1:e),.1v?{'(l2:y6:scheme;y4:eval;)]2}'(y1:"
  "o),.1v?{'(l2:y6:scheme;y7:complex;)]2}'(y1:h),.1v?{'(l2:y6:scheme;y4:c"
  "har;)]2}'(y1:l),.1v?{'(l2:y6:scheme;y11:case-lambda;)]2}'(y1:a),.1v?{'"
  "(l2:y6:scheme;y3:cxr;)]2}'(y1:b),.1v?{'(l2:y6:scheme;y4:base;)]2}'(y1:"
  "x),.1v?{'(l2:y6:scheme;y3:box;)]2}.1I0?{.1,'(y4:srfi),l2]2}.1,l1]2}.!0"
