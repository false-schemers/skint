...
char *t_code[] = {
  ...
  "P", "xpand-labels",
  "%6,#0.3u.!0n,n,.5,.5,.5,,#0.0,.(i12),.8,.(i15),.(i14),&5{%5.0u?{:2^?{$"
  "{:0,@(y6:list1?)[01}}{f}?{:3,:0a,:1,@(y5:xpand)[53}${:0,:3,&1{%1:0,.1,"
  "f,@(y5:xpand)[13},@(y5:%25map1)[02},.4A8L6,${.2,@(y6:list1?)[01}?{.0a}"
  "{.0,'(y5:begin)c},.6u?{.0]7}${.8,&0{%1'(l1:y5:begin;)]1},@(y5:%25map1)"
  "[02},.1,.8A8,'(y6:lambda),l3,'(y4:call),@(y5:pair*)[73}.0a~?{.4,.4,${:"
  "3,.6a,f,@(y5:xpand)[03}c,.4d,.4d,.4d,:4^[55}.2aY0?{.4,.3ac,.4,${:3,.6a"
  ",.6a,l2,@(y10:xpand-set!)[02}c,.4d,.4d,.4d,:4^[55}@(y5:first),'(s20:im"
  "proper labels form),@(y7:x-error)[52}.!0.0^_1[75",
  ...
  ".3,:1S4,@(y21:write-serialized-char)[02}'1,.1I+,:2^[11}.!0.0^_1[21}f,."
  "1H0,.0?{.0,,#0.3H3.!0.4,.2I=0?{'(cb)}{'(ch)}W0${.6,.3^,@(y21:write-ser"
  "ialized-size)[02}.1I=0~?{${.6,.4,@(y21:write-serialized-size)[02}}'0,,"
  "#0.0,.6,.5,.9,.6,&5{%1:0^,.1I=?{]1}${:1,:2,.4,:3H4,@(y34:write-seriali"
  "zed-numvector-element)[03}'1,.1I+,:4^[11}.!0.0^_1[51}.1Y0?{.2,'(cy)W0."
  ...
  "C", 0,
  "${'(l558:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  ":fxsrl;;l1:y5:fxeqv;;l1:y6:fxaddc;;l1:y6:fxsubc;;l1:y6:fxmulc;;l1:y14:"
  "fixnum->flonum;;l1:y14:fixnum->string;;l1:y14:string->fixnum;;l1:y7:fl"
  "onum?;;l1:y7:flzero?;;l1:y11:flpositive?;;l1:y11:flnegative?;;l1:y10:f"
  "linteger?;;l1:y6:flnan?;;l1:y11:flinfinite?;;l1:y9:flfinite?;;l1:y7:fl"
  "even?;;l1:y6:flodd?;;l1:y3:fl+;;l1:y3:fl*;;l1:y3:fl-;;l1:y3:fl/;;l1:y5"
  ":flneg;;l1:y5:flabs;;l1:y5:flgcd;;l1:y6:flexpt;;l1:y6:flsqrt;;l1:y7:fl"
  "floor;;l1:y9:flceiling;;l1:y10:fltruncate;;l1:y7:flround;;l1:y5:flexp;"
  ";l1:y5:fllog;;l1:y5:flsin;;l1:y5:flcos;;l1:y5:fltan;;l1:y6:flasin;;l1:"
  "y6:flacos;;l1:y6:flatan;;l1:y4:fl<?;;l1:y5:fl<=?;;l1:y4:fl>?;;l1:y5:fl"
  ">=?;;l1:y4:fl=?;;l1:y5:fl!=?;;l1:y5:flmin;;l1:y5:flmax;;l1:y11:flremai"
  "nder;;l1:y8:flmodulo;;l1:y10:flquotient;;l1:y8:flmodquo;;l1:y14:flonum"
  "->fixnum;;l1:y14:flonum->string;;l1:y7:flldexp;;l1:y6:flmodf;;l1:y7:fl"
  "frexp;;l1:y6:flsinh;;l1:y6:flcosh;;l1:y6:fltanh;;l1:y7:fllog10;;l1:y14"
  ":string->flonum;;l1:y8:list-cat;;l1:y9:last-pair;;l1:y9:list-head;;l1:"
  "y4:meme;;l1:y4:asse;;l1:y4:memp;;l1:y4:assp;;l1:y8:reverse!;;l1:y9:cir"
  "cular?;;l1:y5:cons*;;l1:y5:list*;;l1:y8:char-cmp;;l1:y11:char-ci-cmp;;"
  "l1:y10:string-cat;;l1:y15:string-position;;l1:y10:string-cmp;;l1:y13:s"
  "tring-ci-cmp;;l1:y10:vector-cat;;l1:y12:bytevector=?;;l1:y16:bytevecto"
  "r->list;;l1:y16:list->bytevector;;l1:y13:subbytevector;;l1:y10:numvect"
  "or?;;l1:y14:make-numvector;;l1:y16:numvector-length;;l1:y13:numvector-"
  "ref;;l1:y14:numvector-set!;;l1:y15:list->numvector;;l1:y19:standard-in"
  "put-port;;l1:y20:standard-output-port;;l1:y19:standard-error-port;;l1:"
  "y9:tty-port?;;l1:y15:port-fold-case?;;l1:y19:set-port-fold-case!;;l1:y"
  "11:rename-file;;l1:y17:current-directory;;l1:y19:directory-separator;;"
  "l1:y14:path-separator;;l1:y4:void;;l1:y5:void?;;l1:y19:implementation-"
  "name;;l1:y22:implementation-version;;l1:y13:version-alist;;l1:y16:curr"
  "ent-language;;l1:y15:current-country;;l1:y22:current-locale-details;;p"
  "y10:flcopysign;y8:c99-math;;py10:flsign-bit;y8:c99-math;;py10:fladjace"
  "nt;y8:c99-math;;py13:flnormalized?;y8:c99-math;;py15:fldenormalized?;y"
  "8:c99-math;;py10:flexponent;y8:c99-math;;py7:flilogb;y8:c99-math;;py4:"
  "fl+*;y8:c99-math;;py9:flposdiff;y8:c99-math;;py6:flexp2;y8:c99-math;;p"
  "y7:flexp-1;y8:c99-math;;py6:flcbrt;y8:c99-math;;py7:flhypot;y8:c99-mat"
  "h;;py7:fllog1+;y8:c99-math;;py6:fllog2;y8:c99-math;;py7:flasinh;y8:c99"
  "-math;;py7:flacosh;y8:c99-math;;py7:flatanh;y8:c99-math;;py9:%25flremq"
  "uo;y8:c99-math;;py7:flgamma;y8:c99-math;;py8:fllgamma;y8:c99-math;;py5"
  ":flerf;y8:c99-math;;py6:flerfc;y8:c99-math;;py14:flfirst-bessel;y8:xsi"
  "-math;;py15:flsecond-bessel;y8:xsi-math;;py20:*user-name-registry*;y6:"
  "hidden;;py25:make-readonly-environment;y6:hidden;;py27:make-controlled"
  "-environment;y6:hidden;;py20:make-sld-environment;y6:hidden;;py21:make"
  "-repl-environment;y6:hidden;;py19:find-library-in-env;y6:hidden;;py16:"
  "root-environment;y6:hidden;;py16:repl-environment;y6:hidden;;py17:empt"
  "y-environment;y6:hidden;;py32:make-historic-report-environment;y6:hidd"
  "en;;py16:r5rs-environment;y6:hidden;;py21:r5rs-null-environment;y6:hid"
  "den;;py9:*verbose*;y6:hidden;;py7:*quiet*;y6:hidden;;py25:compile-and-"
  "run-core-expr;y6:hidden;;py17:evaluate-top-form;y6:hidden;;py10:run-sc"
  "ript;y6:hidden;;py11:run-program;y6:hidden;;py22:repl-evaluate-top-for"
  "m;y6:hidden;;py9:repl-read;y6:hidden;;py17:repl-exec-command;y6:hidden"
  ";;py14:repl-from-port;y6:hidden;;py13:run-benchmark;y6:hidden;;py4:rep"
  "l;y6:hidden;;),&0{%1,,,,#0#1#2#3&0{%1.0,'(y1:w),.1v?{'(l2:y6:scheme;y5"
  ":write;)]2}'(y1:t),.1v?{'(l2:y6:scheme;y4:time;)]2}'(y1:p),.1v?{'(l2:y"
  "6:scheme;y4:repl;)]2}'(y1:r),.1v?{'(l2:y6:scheme;y4:read;)]2}'(y1:v),."
  "1v?{'(l2:y6:scheme;y4:r5rs;)]2}'(y1:u),.1v?{'(l2:y6:scheme;y9:r5rs-nul"
  "l;)]2}'(y1:d),.1v?{'(l2:y6:scheme;y4:load;)]2}'(y1:z),.1v?{'(l2:y6:sch"
  "eme;y4:lazy;)]2}'(y1:s),.1v?{'(l2:y6:scheme;y15:process-context;)]2}'("
  "y1:i),.1v?{'(l2:y6:scheme;y7:inexact;)]2}'(y1:f),.1v?{'(l2:y6:scheme;y"
  "4:file;)]2}'(y1:e),.1v?{'(l2:y6:scheme;y4:eval;)]2}'(y1:o),.1v?{'(l2:y"
  "6:scheme;y7:complex;)]2}'(y1:h),.1v?{'(l2:y6:scheme;y4:char;)]2}'(y1:l"
  "),.1v?{'(l2:y6:scheme;y11:case-lambda;)]2}'(y1:a),.1v?{'(l2:y6:scheme;"
  "y3:cxr;)]2}'(y1:b),.1v?{'(l2:y6:scheme;y4:base;)]2}'(y1:x),.1v?{'(l2:y"
  "6:scheme;y3:box;)]2}.1I0?{.1,'(y4:srfi),l2]2}.1,l1]2}.!0&0{%1${&0{%1n,"
  "'(l1:y5:begin;),V12]1},.3,@(y20:*root-name-registry*),@(y11:name-looku"
  "p)[03}z]1}.!1&0{%3'1,.1V4,.0,.3A3,.0?{.4,.1sd]5}.1,.5,.5cc,'1,.4V5]5}."
  "!2&0{%1&0{%1.0,'(y5:const),l2]1},.1,@(y20:*root-name-registry*),@(y11:"
  "name-lookup)[13}.!3.4d,.5a,,#0.0,.6,.5,.7,.(i10),&5{%2.1u?{${.2,:0^[01"
  "},.1,${'(l1:y5:skint;),:1^[01},:3^[23}'(y8:c99-math),.2q?{@(y10:*featu"
  "res*),'(y8:c99-math)A0~}{f},.0?{.0]3}'(y8:xsi-math),.3q?{@(y10:*featur"
  "es*),'(y8:xsi-math)A0~}{f},.0?{.0]4}.3p~?{${.4,:0^[01},.3,${n,.8c,'(y5"
  ":skint)c,:1^[01},:3^[43}${${.6,:0^[01},.5,${${.(i11)a,:2^[01},:1^[01},"
