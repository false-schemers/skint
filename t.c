...
char *t_code[] = {
  ...
  ",.8q?{.8C0}{f},.0?{.0](i10)}'(y6:<byte>),.9q?{.9Nw!?{'(i255),.(i10),,'"
  "0>!;>!}{f}}{f},.0?{.0](i11)}.9,.(i11)v,.0?{.0](i12)}.(i10)p?{'(y3:...)"
  ",.(i11)aq?{.(i10)dp?{.(i10)ddu}{f}}{f}?{.(i10)da,.(i12)v}{.(i10)dp?{'("
  "y3:...),.(i11)daq?{.(i10)ddu}{f}}{f}?{.(i10)a,'(y1:*),.1q?{.(i12)L0}{$"
  "{.(i14),,#0.0,.5,&2{%1.0u,.0?{.0]2}.1p?{${.3a,:0,@(y11:sexp-match?)[02"
  "}?{.1d,:1^[21}f]2}f]2}.!0.0^_1[01}}_1}{.(i11)p?{${.(i13)a,.(i13)a,@(y1"
  "1:sexp-match?)[02}?{${.(i13)d,.(i13)d,@(y11:sexp-match?)[02}}{f}}{f}}}"
  "}{f},.0?{.0](i13)}.(i11)V0?{.(i12)V0?{${.(i14)X0,.(i14)X0,@(y11:sexp-m"
  "atch?)[02}}{f}}{f},.0?{.0](i14)}.(i12)Y2?{.(i13)Y2?{.(i13)z,.(i13)z,@("
  "y11:sexp-match?)[(i14)2}f](i14)}f](i14)",
  ...
  ")[11}f]1}f]1}.!0&0{%1${.2,@(y3:id?)[01},.0?{.0]2}.1Nw!]2}.!1${'(s21:in"
  "valid import syntax),'(l3:y4:<id>;y1:*;y3:...;),.6,@(y12:check-syntax)"
  "[03}.2a,${'(y4:only),.3,@(y12:id-rename-as)[02},${'(y6:except),.4,@(y1"
  "2:id-rename-as)[02},${'(y6:rename),.5,@(y12:id-rename-as)[02},${'(y6:p"
  "refix),.6,@(y12:id-rename-as)[02},${'(y7:library),.7,@(y12:id-rename-a"
  "s)[02},,#0.(i10),.9,.3,.3,.(i11),.8,.8,.(i11),.(i13),&9{%2,#0${.3,@(y7"
  ...
  "!0.0^_1[02},.1,:0[22},.2da,:5^[32}.0^?{:1,.2aq?{${.3dd,@(y3:id?),@(y6:"
  "andmap)[02}}{f}}{f}?{.1,.3,&2{%2${${:1dd,@(y7:id->sym),@(y5:%25map1)[0"
  "2},.4,,#0.0,&1{%2.0u?{.0]2}.1,.1aaA0?{.1,.1d,:0^[22}${.3,.3d,:0^[02},."
  "1ac]2}.!0.0^_1[02},.1,:0[22},.2da,:5^[32}.0^?{:2,.2aq?{${.3d,@(y6:list"
  "2?)[01}?{${.3dda,@(y3:id?)[01}}{f}}{f}}{f}?{.1,.3,&2{%2${${:1dda,@(y7:"
  "id->sym)[01},.4,,#0.0,&1{%2.0u?{.0]2}${.2aa,.4,@(y13:symbol-append)[02"
  "},${.4,.4d,:0^[02},.2ad,.2cc]3}.!0.0^_1[02},.1,:0[22},.2da,:5^[32}.0^?"
  "{:3,.2aq?{${.3dd,:4^,@(y6:andmap)[02}}{f}}{f}?{.1,.3,&2{%2${${:1dd,@(y"
  "17:xpand-sexp->datum)[01},.4,,#0.0,&1{%2.0u?{.0]2}.1,.1aaA3,.0?{.0,${."
  "5,.5d,:0^[02},.3ad,.2dacc]4}${.4,.4d,:0^[02},.2ac]3}.!0.0^_1[02},.1,:0"
  "[22},.2da,:5^[32}${.3,@(y7:list2+?)[01}?{:6,.2aq}{f}?{${:8,.4,@(y18:pr"
  "eprocess-library)[02},.0d,.1a,.5[42}${.3,@(y7:list1+?)[01}?{${.3,:7^,@"
  "(y6:andmap)[02}}{f}?{${.3,@(y17:xpand-sexp->datum)[01},${:8,.3,@(y9:xp"
  "and-ref)[02},.0V0~?{${.2,.4,'(s15:invalid library),@(y7:x-error)[03}}'"
  "1,.1V4,'0,.2V4,.6[52}.1,'(s28:invalid import set in import),@(y7:x-err"
  "or)[32}.!0n,'(l1:y5:begin;),.(i11)d,,#0.0,.5,&2{%3.0u?{.2,.2c]3}.2,.2,"
  ".2,:1,&4{%2${:3,.4,@(y11:adjoin-eals)[02},${.3,:2,@(y11:adjoin-code)[0"
  "2},:1d,:0^[23},.1a,:0^[32}.!0.0^_1[(i11)3",
  ...
  "}.0aNw!?{.1,:2^c,'(i10),.2aE8c,.1d,:3^[22}:4,'(s20:invalid library nam"
  "e),@(y7:x-error)[22}.!0.0^_1[52",

  "P", "listname-segment->string",
  "%1.0Y0?{.0,@(y21:mangle-symbol->string)[11}.0Nw!?{'(i10),.1E8]1}.0,'(s"
  "33:invalid library name name element),@(y7:c-error)[12",
  ...
  "y3:box;)]2}.1Nw!?{.1,'(y4:srfi),l2]2}.1,l1]2}.!0&0{%1${&0{%1n,'(l1:y5:"
  "begin;),V12]1},.3,@(y20:*root-name-registry*),@(y11:name-lookup)[03}z]"
  "1}.!1&0{%3'1,.1V4,.0,.3A3,.0?{.4,.1sd]5}.1,.5,.5cc,'1,.4V5]5}.!2&0{%1&"
  "0{%1.0,'(y5:const),l2]1},.1,@(y20:*root-name-registry*),@(y11:name-loo"
  "kup)[13}.!3.4d,.5a,,#0.0,.6,.5,.7,.(i10),&5{%2.1u?{${.2,:0^[01},.1,${'"
  "(l1:y5:skint;),:1^[01},:3^[23}'(y8:c99-math),.2q?{@(y10:*features*),'("
  "y8:c99-math)A0~}{f},.0?{.0]3}'(y8:xsi-math),.3q?{@(y10:*features*),'(y"
  "8:xsi-math)A0~}{f},.0?{.0]4}.3p~?{${.4,:0^[01},.3,${n,.8c,'(y5:skint)c"
  ",:1^[01},:3^[43}${${.6,:0^[01},.5,${${.(i11)a,:2^[01},:1^[01},:3^[03}."
  "3d,.3,:4^[42}.!0.0^_1[52},@(y10:%25for-each1)[02}",
  ...
  "P", "repl-import-name",
  "%1.0Nw!?{'0,.1<!}{f}?{.0,'(y4:srfi),l2]1}.0Y0?{.0,'(y5:skint),l2]1}${."
  "2,@(y9:listname?)[01}?{.0]1}f]1",
