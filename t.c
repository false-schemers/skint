...
char *t_code[] = {
  ...
  ",.8q?{.8C0}{f},.0?{.0](i10)}'(y6:<byte>),.9q?{.9Nw?{.9Ti?{'(i255),.(i1"
  "0),,'0>!;>!}{f}}{f}}{f},.0?{.0](i11)}.9,.(i11)v,.0?{.0](i12)}.(i10)p?{"
  "'(y3:...),.(i11)aq?{.(i10)dp?{.(i10)ddu}{f}}{f}?{.(i10)da,.(i12)v}{.(i"
  "10)dp?{'(y3:...),.(i11)daq?{.(i10)ddu}{f}}{f}?{.(i10)a,'(y1:*),.1q?{.("
  "i12)L0}{${.(i14),,#0.0,.5,&2{%1.0u,.0?{.0]2}.1p?{${.3a,:0,@(y11:sexp-m"
  "atch?)[02}?{.1d,:1^[21}f]2}f]2}.!0.0^_1[01}}_1}{.(i11)p?{${.(i13)a,.(i"
  "13)a,@(y11:sexp-match?)[02}?{${.(i13)d,.(i13)d,@(y11:sexp-match?)[02}}"
  "{f}}{f}}}}{f},.0?{.0](i13)}.(i11)V0?{.(i12)V0?{${.(i14)X0,.(i14)X0,@(y"
  "11:sexp-match?)[02}}{f}}{f},.0?{.0](i14)}.(i12)Y2?{.(i13)Y2?{.(i13)z,."
  "(i13)z,@(y11:sexp-match?)[(i14)2}f](i14)}f](i14)",
  ...
  "P", "lookup-global",
  "%!1U2,.0V3,.3Zi,.0,.2V4,.4A3,.0?{.0d]5}.3p?{.3a}{f}?{.4b,.2,.4V4,.1,.7"
  "cc,.3,.5V5.0]6}f]5",
  ...
  "C", 0,
  "${f,'(y5:quote)b,'(y5:quote),@(y6:new-id)[03}@!(y8:quote-id)",
  ...
  ",.1v?{'3,.3=]3}'(c4),.1v?{'4,.3=]3}'(c5),.1v?{'5,.3=]3}'(cp),.1v?{'0,."
  "3<!]3}'(cm),.1v?{'1,.3<!]3}'(cc),.1v?{'2,.3<!]3}'(cx),.1v?{'1,.3<!]3}'"
  "(cu),.1v?{'1,.3,,'0>!;>!]3}'(cb),.1v?{'2,.3,,'1>!;>!]3}'(ct),.1v?{'3,."
  "3,,'2>!;>!]3}'(c#),.1v?{'0,.3<!]3}'(c@),.1v?{f]3}f]3",
  ...
  "3}.0L0~?{.0,'(y4:body)c,'(s18:improper body form),@(y7:x-error)[32}n,."
  "2,#1,,#0#1.3,&1{%3:0^,.3,.3b,.3,l3c:!0]3}.!0.3,.3,&2{%2,#0.1p?{:1^,.2A"
  "5}{:1^,.2A3}.!0.2,'(l2:y3:ref;y4:peek;),.1A1?{.1^?{.1^da]4}.3,.3,:0[42"
  "}'(y4:set!),.1v?{.1^?{.1^dda?{.1^da]4}f]4}.3,.3,:0[42}.1^?{f]4}.3,.3,:"
  "0[42}.!1.4,n,n,n,,#0.(i11),.7,.2,.8,&4{%4.3p?{.3ap}{f}?{.3d,.4a,.0a,.1"
  "d,${:2^,.4,@(y8:prexpand)[02},.0,'(y5:begin),.1v?{.2L0?{.5,.3L6,.9,.9,"
  ".9,:1^[(i10)4}.4,'(s19:improper begin form),@(y7:x-error)[(i10)2}'(y6:"
  "define),.1v?{${.4,.6,@(y17:preprocess-define)[02},${.2,@(y6:list1?)[01"
  "}?{.0a,.7,.(i11),fc,.(i11),.3c,.(i11),fc,:1^[(i12)4}.0a,.1da,${${.5,@("
  "y7:id->sym)[01},@(y6:gensym)[01},${t,.3,'(y3:ref),l2,.6,:0^[03}.9,.(i1"
  "3),.2c,.(i13),.4c,.(i13),.6c,:1^[(i14)4}'(y13:define-syntax),.1v?{${.4"
  ",.6,@(y24:preprocess-define-syntax)[02},.0da,.1a,${f,${:2^,.7,t,@(y5:x"
  "pand)[03},.4,:0^[03}.8,.(i12),.(i12),.(i12),:1^[(i13)4}'(y14:define-li"
  "brary),.1v?{${.4,@(y7:list2+?)[01}?{${.4a,@(y9:listname?)[01}}{f}?{${f"
  ",:2^,.6,.8,@(y20:xpand-define-library)[04},.0da,.1dda,${t,.3,.5,:0^[03"
  "}.8,.(i12),.(i12),.(i12),:1^[(i13)4}.4,'(s28:improper define-library f"
  "orm),@(y7:x-error)[(i10)2}'(y6:import),.1v?{.2L0?{${f,:2^,.6,.8,@(y12:"
  "xpand-import)[04},.0da,'0,.1V4,'1,.2V4,.0,,#0.9,:0,.2,.(i14),.(i18),.("
  "i18),.(i18),:1,.(i11),&9{%1.0u?{:0,@(y15:syntax-quote-id),l2,:5,:4,fc,"
  ":3,.3c,:2,fc,:1^[24}.0ad,${.3aa,:8,@(y12:id-rename-as)[02},${f,.4,.4,:"
  "7^[03}.2d,:6^[31}.!0.0^_1[(i14)1}.4,'(s20:improper import form),@(y7:x"
  "-error)[(i10)2}.1K0?{.5,${:2^,.8,.6[02}c,.9,.9,.9,:1^[(i10)4}:3,:2^,.("
  "i11),.(i11)A8,.(i11)A8,.(i11)A8,@(y12:xpand-labels)[(i10)6}:3,:2^,.5,."
  "5A8,.5A8,.5A8,@(y12:xpand-labels)[46}.!0.0^_1[74",

  "P", "xpand-labels",
  "%6,,,#0#1#2.5u?{.8}{f}.!0.6u?{'(l1:y5:begin;)}{${.8,@(y6:list1?)[01}?{"
  "${.9,.9a,.4^,@(y5:xpand)[03}}{${f,.(i10),.(i10)d,@(y10:xpand-body)[03}"
  ",${.(i10),.(i10)a,f,@(y5:xpand)[03},.1p?{'(y5:begin),.2aq}{f}?{.1du?{."
  "0}{.1d,.1c,'(y5:begin)c}}{.1,.1,'(y5:begin),l3}_2}}.!1.1^p?{'(y5:begin"
  "),.2^aq}{f}?{.1^d}{.1^,l1}.!2n,n,.7,.7,.7,,#0.0,.(i14),.(i10),&3{%5.0u"
  "?{:0^,.4A8L6,${.2,@(y6:list1?)[01}?{.0a}{.0,'(y5:begin)c},.6u?{.0]7}${"
  ".8,&0{%1'(l1:y5:begin;)]1},@(y5:%25map1)[02},.1,.8A8,'(y6:lambda),l3,'"
  "(y4:call),@(y5:pair*)[73}.0a~?{.4,.4,${:1,.6a,f,@(y5:xpand)[03}c,.4d,."
  "4d,.4d,:2^[55}.2aY0?{.4,.3ac,.4,${:1,.6a,.6a,l2,@(y10:xpand-set!)[02}c"
  ",.4d,.4d,.4d,:2^[55}@(y5:first),'(s20:improper labels form),@(y7:x-err"
  "or)[52}.!0.0^_1[95",
  ...
  "3,.5[02}?{&0{%1.0Nw?{.0Ti]1}f]1}]2}${'(y8:boolean?),.3,.5[02}?{@(y8:bo"
  "olean?)]2}${'(y5:char?),.3,.5[02}?{@(y5:char?)@(y4:sexp)]2}${'(y7:stri"
  "ng?),.3,.5[02}?{@(y7:string?)]2}${'(y11:bytevector?),.3,.5[02}?{@(y11:"
  "bytevector?)]2}${'(y3:id?),.3,.5[02}?{@(y3:id?)]2}f]2",
  ...
  "P", "make-hide-libraries-transformer",
  "%0&0{%2${.2d,@(y17:xpand-sexp->datum)[01},.0,@(y8:quote-id),l2]3}]0",
  ...
  ")[11}f]1}f]1}.!0&0{%1${.2,@(y3:id?)[01},.0?{.0]2}.1Nw?{.1Ti]2}f]2}.!1$"
  "{'(s21:invalid import syntax),'(l3:y4:<id>;y1:*;y3:...;),.6,@(y12:chec"
  "k-syntax)[03}.2a,${'(y4:only),.3,@(y12:id-rename-as)[02},${'(y6:except"
  "),.4,@(y12:id-rename-as)[02},${'(y6:rename),.5,@(y12:id-rename-as)[02}"
  ",${'(y6:prefix),.6,@(y12:id-rename-as)[02},${'(y7:library),.7,@(y12:id"
  "-rename-as)[02},,#0.(i10),.9,.3,.3,.(i11),.8,.8,.(i11),.(i13),&9{%2,#0"
  "${.3,@(y7:list2+?)[01}?{.1dap}{f}.!0.0^?{:0,.2aq?{${.3dd,@(y3:id?),@(y"
  "6:andmap)[02}}{f}}{f}?{.1,.3,&2{%2${${:1dd,@(y7:id->sym),@(y5:%25map1)"
  "[02},.4,,#0.0,&1{%2.0u?{.0]2}.1,.1aaA0?{${.3,.3d,:0^[02},.1ac]2}.1,.1d"
  ",:0^[22}.!0.0^_1[02},.1,:0[22},.2da,:5^[32}.0^?{:1,.2aq?{${.3dd,@(y3:i"
  "d?),@(y6:andmap)[02}}{f}}{f}?{.1,.3,&2{%2${${:1dd,@(y7:id->sym),@(y5:%"
  "25map1)[02},.4,,#0.0,&1{%2.0u?{.0]2}.1,.1aaA0?{.1,.1d,:0^[22}${.3,.3d,"
  ":0^[02},.1ac]2}.!0.0^_1[02},.1,:0[22},.2da,:5^[32}.0^?{:2,.2aq?{${.3d,"
  "@(y6:list2?)[01}?{${.3dda,@(y3:id?)[01}}{f}}{f}}{f}?{.1,.3,&2{%2${${:1"
  "dda,@(y7:id->sym)[01},.4,,#0.0,&1{%2.0u?{.0]2}${.2aa,.4,@(y13:symbol-a"
  "ppend)[02},${.4,.4d,:0^[02},.2ad,.2cc]3}.!0.0^_1[02},.1,:0[22},.2da,:5"
  "^[32}.0^?{:3,.2aq?{${.3dd,:4^,@(y6:andmap)[02}}{f}}{f}?{.1,.3,&2{%2${$"
  "{:1dd,@(y17:xpand-sexp->datum)[01},.4,,#0.0,&1{%2.0u?{.0]2}.1,.1aaA3,."
  "0?{.0,${.5,.5d,:0^[02},.3ad,.2dacc]4}${.4,.4d,:0^[02},.2ac]3}.!0.0^_1["
  "02},.1,:0[22},.2da,:5^[32}${.3,@(y7:list2+?)[01}?{:6,.2aq}{f}?{${:8,.4"
  ",@(y18:preprocess-library)[02},.0d,.1a,.5[42}${.3,@(y7:list1+?)[01}?{$"
  "{.3,:7^,@(y6:andmap)[02}}{f}?{${.3,@(y17:xpand-sexp->datum)[01},${:8,."
  "3,@(y9:xpand-ref)[02},.0V0~?{${.2,.4,'(s15:invalid library),@(y7:x-err"
  "or)[03}}'1,.1V4,'0,.2V4,.6[52}.1,'(s28:invalid import set in import),@"
  "(y7:x-error)[32}.!0n,'(l1:y5:begin;),.(i11)d,,#0.0,.5,&2{%3.0u?{.2,.2c"
  "]3}.2,.2,.2,:1,&4{%2${:3,.4,@(y11:adjoin-eals)[02},${.3,:2,@(y11:adjoi"
  "n-code)[02},:1d,:0^[23},.1a,:0^[32}.!0.0^_1[(i11)3",
  ...
  "i10),.5E8,@(y12:write-string)[02}.3,'(c;)W0]4}'(l2:i14;i15;),.1A1?{${."
  "5,'(i10),.5GrE8,@(y12:write-string)[02}.3,'(c,)W0${.5,'(i10),.5GiE8,@("
  "y12:write-string)[02}.3,'(c;)W0]4}]4",

  "P", "write-serialized-sexp",
  "%2f,.1q?{.1,'(cf)W0]2}t,.1q?{.1,'(ct)W0]2}n,.1q?{.1,'(cn)W0]2}.0C0?{.1"
  ",'(cc)W0.1,.1,@(y21:write-serialized-char)[22}.0J0?{.1,'(cj)W0.1,t,.2E"
  "6,@(y12:write-string)[22}.0I0?{.1,'(ci)W0.1,'(i10),.2X6,@(y12:write-st"
  "ring)[22}.0N0?{.1,'(cx)W0.1,'(i16),.2E8,@(y12:write-string)[22}.0L0?{."
  "1,'(cl)W0${.3,.3g,@(y21:write-serialized-size)[02}.0,,#0.0,.4,&2{%1.0u"
  "?{]1}${:0,.3a,@(y24:write-serialized-element)[02}.0d,:1^[11}.!0.0^_1[2"
  "1}.0p?{.1,'(cp)W0${.3,.3a,@(y24:write-serialized-element)[02}.1,.1d,@("
  "y24:write-serialized-element)[22}.0V0?{.1,'(cv)W0${.3,.3V3,@(y21:write"
  "-serialized-size)[02}'0,,#0.0,.3,.5,&3{%1:1V3,.1I=?{]1}${:0,.3,:1V4,@("
  "y24:write-serialized-element)[02}'1,.1I+,:2^[11}.!0.0^_1[21}.0S0?{.1,'"
  "(cs)W0${.3,.3S3,@(y21:write-serialized-size)[02}'0,,#0.0,.3,.5,&3{%1:1"
  "S3,.1I=?{]1}${:0,.3,:1S4,@(y21:write-serialized-char)[02}'1,.1I+,:2^[1"
  "1}.!0.0^_1[21}f,.1H0,.0?{.0,,,#0#1'(i39),.3,,'(i32)>!;>!?{.4B3}{.4H3}."
  "!0'(i39),.3,,'(i32)>!;>!?{@(y17:bytevector-u8-ref)}{@(y13:numvector-re"
  "f)}.!1.5,.3I=0?{'(cb)}{'(ch)}W0${.7,.3^,@(y21:write-serialized-size)[0"
  "2}.2I=0~?{${.7,.5,@(y21:write-serialized-size)[02}}'0,,#0.0,.7,.5,.7,."
  "(i11),.7,&6{%1:0^,.1I=?{]1}${:1,:2,${.6,:4,:3^[02},@(y34:write-seriali"
  "zed-numvector-element)[03}'1,.1I+,:5^[11}.!0.0^_1[61}.1Y0?{.2,'(cy)W0."
  "1X4,${.5,.3S3,@(y21:write-serialized-size)[02}'0,,#0.0,.3,.7,&3{%1:1S3"
  ",.1I=?{]1}${:0,.3,:1S4,@(y21:write-serialized-char)[02}'1,.1I+,:2^[11}"
  ".!0.0^_1[41}.1Y2?{.2,'(cz)W0.2,.2z,@(y24:write-serialized-element)[32}"
  ".1,'(s21:cannot encode literal),@(y7:c-error)[32",

  "P", "write-serialized-arg",
  "%2.0N0?{.0I0?{.0,'0I>!?{'9,.1I>!}{f}}{f}}{f}?{.1,.1,'(s10:0123456789)S"
  "4W0]2}.1,'(c()W0${.3,.3,@(y21:write-serialized-sexp)[02}.1,'(c))W0]2",
  ...
  "),.1aq?{.0d,.6,.8,.5,.7,.9,.7,&6{%!1'0,.2U8,.2U6,.0,'(l6:c0;c1;c2;c3;c"
  "4;c5;),.1A1?{${:0,.6A8,,#0.0,:4,:3,:2,:1,&5{%2.0u?{]2}${:3,f,:0,:1,:2,"
  ".8,.8a,@(y7:codegen)[07}.0du~?{:3,'(c,)W0}.1,fc,.1d,:4^[22}.!0.0^_1[02"
  "}${:4,.5,@(y12:write-string)[02}}{'(cp),.1v?{.3u?{'1,.5U8,${:4,.3,@(y1"
  "2:write-string)[02}_1}{'1,.4gI-,${:0,.7A8,,#0.0,:4,:3,:2,:1,&5{%2.0u?{"
  "]2}${:3,f,:0,:1,:2,.8,.8a,@(y7:codegen)[07}.0du~?{:3,'(c,)W0}.1,fc,.1d"
  ",:4^[22}.!0.0^_1[02}${'0,,#0.0,.8,:4,.7,&4{%1:0,.1I<!?{]1}${:1,:2,@(y1"
  "2:write-string)[02}'1,.1I+,:3^[11}.!0.0^_1[01}_1}}{'(cm),.1v?{.3du?{'1"
  ",.5U8,${:4,f,:1,:2,:3,:0,.(i12)a,@(y7:codegen)[07}${:4,.3,@(y12:write-"
  "string)[02}_1}{'1,.4gI-,${:0,.7A8,,#0.0,:4,:3,:2,:1,&5{%2.0u?{]2}${:3,"
  "f,:0,:1,:2,.8,.8a,@(y7:codegen)[07}.0du~?{:3,'(c,)W0}.1,fc,.1d,:4^[22}"
  ".!0.0^_1[02}${'0,,#0.0,.8,:4,.7,&4{%1:0,.1I<!?{]1}${:1,:2,@(y12:write-"
  "string)[02}'1,.1I+,:3^[11}.!0.0^_1[01}_1}}{'(cc),.1v?{.3A8,'1,.5gI-,${"
  ":4,f,:1,:2,:3,:0,.9a,@(y7:codegen)[07}:4,'(c,)W0${:0,fc,.4d,,#0.0,:4,:"
  "3,:2,:1,&5{%2.0u?{]2}${:3,f,:0,:1,:2,.8,.8a,@(y7:codegen)[07}.0du~?{:3"
  ",'(c,)W0:3,'(c,)W0}.1,fc,fc,.1d,:4^[22}.!0.0^_1[02}${'0,,#0.0,.9,:4,.7"
  ",&4{%1:0,.1I<!?{]1}.0I=0~?{:1,'(c;)W0}${:1,:2,@(y12:write-string)[02}'"
  "1,.1I+,:3^[11}.!0.0^_1[01}_2}{'(cx),.1v?{'1,.4gI-,${:0,.7A8,,#0.0,:4,:"
  "3,:2,:1,&5{%2.0u?{]2}${:3,f,:0,:1,:2,.8,.8a,@(y7:codegen)[07}.0du~?{:3"
  ",'(c,)W0}.1,fc,.1d,:4^[22}.!0.0^_1[02}${'0,,#0.0,.8,:4,.7,&4{%1:0,.1I<"
  "!?{]1}${:1,:2,@(y12:write-string)[02}'1,.1I+,:3^[11}.!0.0^_1[01}_1}{'("
  "cu),.1v?{.3u?{${:4,'1,.8U8,@(y12:write-string)[02}}{${:4,f,:1,:2,:3,:0"
  ",.(i11)a,@(y7:codegen)[07}}${:4,.5,@(y12:write-string)[02}}{'(cb),.1v?"
  "{.3du?{${:4,'1,.8U8,@(y12:write-string)[02}}{${:4,f,:1,:2,:3,:0,.(i11)"
  "da,@(y7:codegen)[07}}:4,'(c,)W0${:4,f,:1,:2,:3,:0,fc,.(i11)a,@(y7:code"
  "gen)[07}${:4,.5,@(y12:write-string)[02}}{'(ct),.1v?{.3ddu?{${:4,'1,.8U"
  "8,@(y12:write-string)[02}}{${:4,f,:1,:2,:3,:0,.(i11)dda,@(y7:codegen)["
  "07}}:4,'(c,)W0${:4,f,:1,:2,:3,:0,fc,.(i11)da,@(y7:codegen)[07}:4,'(c,)"
  "W0${:4,f,:1,:2,:3,:0,fc,fc,.(i11)a,@(y7:codegen)[07}${:4,.5,@(y12:writ"
  "e-string)[02}}{'(c#),.1v?{${:0,.6A8,,#0.0,:4,:3,:2,:1,&5{%2.0u?{]2}${:"
  "3,f,:0,:1,:2,.8,.8a,@(y7:codegen)[07}:3,'(c,)W0.1,fc,.1d,:4^[22}.!0.0^"
  "_1[02}${:4,.5,@(y12:write-string)[02}${:4,.6g,@(y20:write-serialized-a"
  "rg)[02}}{${.3,'(s27:unsupported integrable type),@(y7:c-error)[02}}}}}"
  "}}}}}_1_2:5?{:4,'(c])W0:4,:5,@(y20:write-serialized-arg)[22}]2},@(y13:"
  "apply-to-list)[72}'(y4:call),.1aq?{.0d,.7,.4,.6,.8,.6,.(i11),&6{%!1'(y"
  "6:lambda),.2aq?{.1daL0?{.1dag,.1gI=}{f}}{f}?{${:1,.3A8,,#0.0,:5,:4,:3,"
  ":2,&5{%2.0u?{]2}${:3,f,:0,:1,:2,.8,.8a,@(y7:codegen)[07}:3,'(c,)W0.1,f"
  "c,.1d,:4^[22}.!0.0^_1[02}.1da,.2dda,${.3,.3,@(y9:find-sets)[02},${.2,$"
  ...
  "6g,:0I+,:2,.4,:4,.5,.9,@(y7:codegen)[77}${:5,f,:2,.6,:4,.7,.(i11),@(y7"
  ":codegen)[07}:5,'(c_)W0:5,.6g,@(y20:write-serialized-arg)[72}:0?{${:1,"
  ".3A8,,#0.0,:5,:4,:3,:2,.(i11),&6{%2.0u?{:4,f,:1,:2,:3,.6,:0,@(y7:codeg"
  "en)[27}${:4,f,:1,:2,:3,.8,.8a,@(y7:codegen)[07}:4,'(c,)W0.1,fc,.1d,:5^"
  "[22}.!0.0^_1[02}:5,'(c[)W0${:5,:0,@(y20:write-serialized-arg)[02}:5,.1"
  "g,@(y20:write-serialized-arg)[22}:5,'(c$)W0:5,'(c{)W0${:1,fc,fc,.3A8,,"
  ...
  "y20:write-serialized-arg)[02}:5,'(c})W0]2},@(y13:apply-to-list)[72}'(y"
  "3:asm),.1aq?{.0d,.6,.8,&2{%1${:0,.3,@(y12:write-string)[02}:1?{:0,'(c]"
  ")W0:0,:1,@(y20:write-serialized-arg)[12}]1},@(y13:apply-to-list)[72}'("
  "y4:once),.1aq?{.0d,.7,.7,.7,.7,.7,.7,&6{%2:5,:4,:3,:2,:1,:0,n,n,.9c,'("
  "l1:l2:y5:quote;t;;),.9c,'(y5:gset!)cc,'(y5:begin)cc,'(l1:y5:begin;)c,'"
  "(l1:l2:y5:quote;t;;),n,.9c,'(y4:gref)cc,'(y3:eq?)U5c,'(y10:integrable)"
  "cc,'(y2:if)c,@(y7:codegen)[27},@(y13:apply-to-list)[72}'(l4:y6:define;"
  "y13:define-syntax;y14:define-library;y6:import;),.1aA0?{.0d,.1,&1{%!0:"
  "0,'(s25:misplaced definition form),@(y7:c-error)[12},@(y13:apply-to-li"
  "st)[72}.0,'(s22:unexpected <core> form),@(y7:c-error)[72",
  ...
  "{.0,.2,Sa2]2}'(s0:),.2S=?{.0]2}.0,${@(y19:directory-separator)[00},S11"
  ",.3,Sa3]2}.0]2",
  ...
  "P", "lnpart?",
  "%1${.2,@(y3:id?)[01},.0?{.0]2}.1Nw?{.1Ti]2}f]2",
  ...
  "}.0aNw?{.0aTi}{f}?{.1,:2^c,'(i10),.2aE8c,.1d,:3^[22}:4,'(s20:invalid l"
  "ibrary name),@(y7:x-error)[22}.!0.0^_1[52",

  "P", "listname-segment->string",
  "%1.0Y0?{.0,@(y21:mangle-symbol->string)[11}.0Nw?{.0Ti}{f}?{'(i10),.1E8"
  "]1}.0,'(s33:invalid library name name element),@(y7:c-error)[12",
  ...
  "sk-directories*),.1c@!(y25:*loaded-mask-directories*):0^S0?{:0^F0}{f}?"
  ...
  "brary-masked-in-libdir?)[02}~?{${'(s4:.sld),.3a,:1,@(y14:listname->pat"
  "h)[03},.0?{.0F0}{f}?{.0]2}.1d,:0^[21}f]1}f]1}.!0.0^_1[11",
  ...
  "P", "library-available?",
  "%2${.2,@(y9:listname?)[01}~?{f]2}${'(y4:peek),.3,.5[02}Y2?{t]2}.0,@(y1"
  "7:find-library-path)[21",
  ...
  "P", "name-lookup",
  "%3'1,.1V3-,.2p?{.0}{.0,.3Zi},.0,.3V4,.4p?{.0,.5A5}{.0,.5A3},.0?{.0d]7}"
  ...
  "P", "name-install!",
  "%3'1,.1V3-,.2p?{.0}{.0,.3Zi},.0,.3V4,.4p?{.0,.5A5}{.0,.5A3},.0?{.6,.1d"
  "q}{f}?{'(y4:same)]7}.0?{.6,.1sd'(y8:modified)]7}.1,.7,.7cc,.3,.6V5'(y5"
  ":added)]7",

  "P", "name-remove!",
  "%2'1,.1V3-,.2p?{.0}{.0,.3Zi},${&0{%2.0,.2ae]2},.3,.6V4,.7,@(y7:remove!"
  ")[03},.1,.4V5]4",
  ...
  "C", 0,
  "${&0{%1&0{%2.0,'(s14:invalid syntax),@(y7:x-error)[22}]1},'(y10:string"
  "->id),@(y20:*root-name-registry*),@(y11:name-lookup)[03}",

  "C", 0,
  "${&0{%1&0{%2.0,'(s14:invalid syntax),@(y7:x-error)[22}]1},'(y10:id->st"
  "ring),@(y20:*root-name-registry*),@(y11:name-lookup)[03}",
  ...
  ";;l3:y7:reverse;y1:v;y1:b;;l3:y5:round;y1:v;y1:b;;l4:y4:set!;y1:v;y1:u"
  ";y1:b;;l3:y8:set-car!;y1:v;y1:b;;l3:y8:set-cdr!;y1:v;y1:b;;l2:y6:squar"
  "e;y1:b;;l3:y6:string;y1:v;y1:b;;l3:y12:string->list;y1:v;y1:b;;l3:y14:"
  "string->number;y1:v;y1:b;;l3:y14:string->symbol;y1:v;y1:b;;l2:y12:stri"
  "ng->utf8;y1:b;;l2:y14:string->vector;y1:b;;l3:y13:string-append;y1:v;y"
  "1:b;;l3:y11:string-copy;y1:v;y1:b;;l2:y12:string-copy!;y1:b;;l3:y12:st"
  "ring-fill!;y1:v;y1:b;;l2:y15:string-for-each;y1:b;;l3:y13:string-lengt"
  "h;y1:v;y1:b;;l2:y10:string-map;y1:b;;l3:y10:string-ref;y1:v;y1:b;;l3:y"
  "11:string-set!;y1:v;y1:b;;l3:y9:string<=?;y1:v;y1:b;;l3:y8:string<?;y1"
  ":v;y1:b;;l3:y8:string=?;y1:v;y1:b;;l3:y9:string>=?;y1:v;y1:b;;l3:y8:st"
  "ring>?;y1:v;y1:b;;l3:y7:string?;y1:v;y1:b;;l3:y9:substring;y1:v;y1:b;;"
  "l3:y14:symbol->string;y1:v;y1:b;;l2:y8:symbol=?;y1:b;;l3:y7:symbol?;y1"
  ":v;y1:b;;l2:y12:syntax-error;y1:b;;l4:y12:syntax-rules;y1:v;y1:u;y1:b;"
  ";l2:y13:textual-port?;y1:b;;l3:y8:truncate;y1:v;y1:b;;l2:y17:truncate-"
  "quotient;y1:b;;l2:y18:truncate-remainder;y1:b;;l2:y9:truncate/;y1:b;;l"
  "2:y9:u8-ready?;y1:b;;l2:y6:unless;y1:b;;l4:y7:unquote;y1:v;y1:u;y1:b;;"
  "l4:y16:unquote-splicing;y1:v;y1:u;y1:b;;l2:y12:utf8->string;y1:b;;l3:y"
  "6:values;y1:v;y1:b;;l3:y6:vector;y1:v;y1:b;;l3:y12:vector->list;y1:v;y"
  "1:b;;l2:y14:vector->string;y1:b;;l2:y13:vector-append;y1:b;;l2:y11:vec"
  "tor-copy;y1:b;;l2:y12:vector-copy!;y1:b;;l3:y12:vector-fill!;y1:v;y1:b"
  ";;l2:y15:vector-for-each;y1:b;;l3:y13:vector-length;y1:v;y1:b;;l2:y10:"
  "vector-map;y1:b;;l3:y10:vector-ref;y1:v;y1:b;;l3:y11:vector-set!;y1:v;"
  "y1:b;;l3:y7:vector?;y1:v;y1:b;;l2:y4:when;y1:b;;l2:y22:with-exception-"
  "handler;y1:b;;l2:y16:write-bytevector;y1:b;;l3:y10:write-char;y1:v;y1:"
  "b;;l2:y12:write-string;y1:b;;l2:y8:write-u8;y1:b;;l3:y5:zero?;y1:v;y1:"
  "b;;l2:y11:case-lambda;y1:l;;l3:y16:char-alphabetic?;y1:v;y1:h;;l3:y10:"
  "char-ci<=?;y1:v;y1:h;;l3:y9:char-ci<?;y1:v;y1:h;;l3:y9:char-ci=?;y1:v;"
  "y1:h;;l3:y10:char-ci>=?;y1:v;y1:h;;l3:y9:char-ci>?;y1:v;y1:h;;l3:y13:c"
  "har-downcase;y1:v;y1:h;;l2:y13:char-foldcase;y1:h;;l3:y16:char-lower-c"
  "ase?;y1:v;y1:h;;l3:y13:char-numeric?;y1:v;y1:h;;l3:y11:char-upcase;y1:"
  "v;y1:h;;l3:y16:char-upper-case?;y1:v;y1:h;;l3:y16:char-whitespace?;y1:"
  "v;y1:h;;l2:y11:digit-value;y1:h;;l3:y12:string-ci<=?;y1:v;y1:h;;l3:y11"
  ":string-ci<?;y1:v;y1:h;;l3:y11:string-ci=?;y1:v;y1:h;;l3:y12:string-ci"
  ">=?;y1:v;y1:h;;l3:y11:string-ci>?;y1:v;y1:h;;l2:y15:string-downcase;y1"
  ":h;;l2:y15:string-foldcase;y1:h;;l2:y13:string-upcase;y1:h;;l3:y5:angl"
  "e;y1:v;y1:o;;l3:y9:imag-part;y1:v;y1:o;;l3:y9:magnitude;y1:v;y1:o;;l3:"
  "y10:make-polar;y1:v;y1:o;;l3:y16:make-rectangular;y1:v;y1:o;;l3:y9:rea"
  "l-part;y1:v;y1:o;;l3:y5:caaar;y1:v;y1:a;;l3:y5:caadr;y1:v;y1:a;;l3:y5:"
  "cadar;y1:v;y1:a;;l3:y5:caddr;y1:v;y1:a;;l3:y5:cdaar;y1:v;y1:a;;l3:y5:c"
  "dadr;y1:v;y1:a;;l3:y5:cddar;y1:v;y1:a;;l3:y5:cdddr;y1:v;y1:a;;l3:y6:ca"
  "aaar;y1:v;y1:a;;l3:y6:caaadr;y1:v;y1:a;;l3:y6:caadar;y1:v;y1:a;;l3:y6:"
  "caaddr;y1:v;y1:a;;l3:y6:cadaar;y1:v;y1:a;;l3:y6:cadadr;y1:v;y1:a;;l3:y"
  "6:caddar;y1:v;y1:a;;l3:y6:cadddr;y1:v;y1:a;;l3:y6:cdaaar;y1:v;y1:a;;l3"
  ":y6:cdaadr;y1:v;y1:a;;l3:y6:cdadar;y1:v;y1:a;;l3:y6:cdaddr;y1:v;y1:a;;"
  "l3:y6:cddaar;y1:v;y1:a;;l3:y6:cddadr;y1:v;y1:a;;l3:y6:cdddar;y1:v;y1:a"
  ";;l3:y6:cddddr;y1:v;y1:a;;l2:y11:environment;y1:e;;l3:y4:eval;y1:v;y1:"
  "e;;l3:y20:call-with-input-file;y1:v;y1:f;;l3:y21:call-with-output-file"
  ";y1:v;y1:f;;l2:y11:delete-file;y1:f;;l2:y12:file-exists?;y1:f;;l2:y22:"
  "open-binary-input-file;y1:f;;l2:y23:open-binary-output-file;y1:f;;l3:y"
  "15:open-input-file;y1:v;y1:f;;l3:y16:open-output-file;y1:v;y1:f;;l3:y2"
  "0:with-input-from-file;y1:v;y1:f;;l3:y19:with-output-to-file;y1:v;y1:f"
  ";;l3:y4:acos;y1:v;y1:i;;l3:y4:asin;y1:v;y1:i;;l3:y4:atan;y1:v;y1:i;;l3"
  ":y3:cos;y1:v;y1:i;;l3:y3:exp;y1:v;y1:i;;l2:y7:finite?;y1:i;;l2:y9:infi"
  "nite?;y1:i;;l3:y3:log;y1:v;y1:i;;l2:y4:nan?;y1:i;;l3:y3:sin;y1:v;y1:i;"
  ";l3:y4:sqrt;y1:v;y1:i;;l3:y3:tan;y1:v;y1:i;;l4:y5:delay;y1:v;y1:u;y1:z"
  ";;l2:y11:delay-force;y1:z;;l3:y5:force;y1:v;y1:z;;l2:y12:make-promise;"
  "y1:z;;l2:y8:promise?;y1:z;;l3:y4:load;y1:v;y1:d;;l2:y12:command-line;y"
  "1:s;;l2:y14:emergency-exit;y1:s;;l2:y4:exit;y1:s;;l2:y24:get-environme"
  "nt-variable;y1:s;;l2:y25:get-environment-variables;y1:s;;l3:y7:display"
  ";y1:w;y1:v;;l2:y14:exact->inexact;y1:v;;l2:y14:inexact->exact;y1:v;;l3"
  ":y23:interaction-environment;y1:p;y1:v;;l2:y16:null-environment;y1:v;;"
  "l3:y4:read;y1:r;y1:v;;l2:y25:scheme-report-environment;y1:v;;l3:y5:wri"
  "te;y1:w;y1:v;;l2:y13:current-jiffy;y1:t;;l2:y14:current-second;y1:t;;l"
  "2:y18:jiffies-per-second;y1:t;;l2:y12:write-shared;y1:w;;l2:y12:write-"
  "simple;y1:w;;l1:y14:define-library;;l1:y6:import;;l3:y4:box?;y1:x;i111"
  ";;l3:y3:box;y1:x;i111;;l3:y5:unbox;y1:x;i111;;l3:y8:set-box!;y1:x;i111"
  ";;l1:y6:format;;l1:y6:printf;;l1:y7:fprintf;;l1:y19:format-pretty-prin"
  "t;;l1:y24:format-exponential-print;;l1:y18:format-fixed-print;;l1:y20:"
  "format-general-print;;l1:y17:format-fresh-line;;l1:y18:format-help-str"
  "ing;;l1:y16:clear-input-port;;l1:y4:set&;;l1:y7:lambda*;;l1:y4:body;;l"
  "1:y5:letcc;;l1:y6:withcc;;l1:y13:syntax-lambda;;l1:y13:syntax-length;;"
  "l1:y6:expand;;l1:y7:record?;;l1:y11:make-record;;l1:y13:record-length;"
  ";l1:y10:record-ref;;l1:y11:record-set!;;l1:y22:record-type-descriptor;"
  ";l1:y7:fixnum?;;l1:y11:fxpositive?;;l1:y11:fxnegative?;;l1:y7:fxeven?;"
  ";l1:y6:fxodd?;;l1:y7:fxzero?;;l1:y3:fx+;;l1:y3:fx*;;l1:y3:fx-;;l1:y3:f"
  ...
  ":y5:fxmin;;l1:y5:fxmax;;l1:y5:fxgcd;;l1:y6:fxexpt;;l1:y7:%25fxsqrt;;l1"
  ":y5:fxnot;;l1:y5:fxand;;l1:y5:fxior;;l1:y5:fxxor;;l1:y5:fxsll;;l1:y5:f"
  "xsra;;l1:y5:fxsrl;;l1:y5:fxeqv;;l1:y8:fxlength;;l1:y11:fxbit-count;;l1"
  ":y6:fxaddc;;l1:y6:fxsubc;;l1:y6:fxmulc;;l1:y6:fxfmar;;l1:y14:fixnum->f"
  ...
  "flonum;;l1:y11:bitwise-not;;l1:y11:bitwise-and;;l1:y11:bitwise-ior;;l1"
  ":y11:bitwise-xor;;l1:y16:arithmetic-shift;;l1:y14:integer-length;;l1:y"
  "9:bit-count;;l1:y7:bignum?;;l1:y7:ratnum?;;l1:y8:compnum?;;l1:y8:rectn"
  "um?;;l1:y15:inexact->string;;l1:y8:list-cat;;l1:y9:last-pair;;l1:y9:li"
  "st-head;;l1:y4:meme;;l1:y4:asse;;l1:y4:memp;;l1:y4:assp;;l1:y8:reverse"
  "!;;l1:y9:circular?;;l1:y5:cons*;;l1:y5:list*;;l1:y8:char-cmp;;l1:y11:c"
  "har-ci-cmp;;l1:y10:string-cat;;l1:y15:string-position;;l1:y10:string-c"
  "mp;;l1:y13:string-ci-cmp;;l1:y10:vector-cat;;l1:y12:bytevector=?;;l1:y"
  "16:bytevector->list;;l1:y16:list->bytevector;;l1:y13:subbytevector;;l1"
  ":y10:numvector?;;l1:y14:make-numvector;;l1:y16:numvector-length;;l1:y1"
  "3:numvector-ref;;l1:y14:numvector-set!;;l1:y15:list->numvector;;l1:y19"
  ":standard-input-port;;l1:y20:standard-output-port;;l1:y19:standard-err"
  "or-port;;l1:y9:tty-port?;;l1:y15:port-fold-case?;;l1:y19:set-port-fold"
  "-case!;;l1:y11:rename-file;;l1:y17:current-directory;;l1:y19:directory"
  "-separator;;l1:y14:path-separator;;l1:y4:void;;l1:y5:void?;;l1:y19:imp"
  "lementation-name;;l1:y22:implementation-version;;l1:y13:version-alist;"
  ";l1:y16:current-language;;l1:y15:current-country;;l1:y22:current-local"
  "e-details;;l1:y3:id?;;l1:y10:string->id;;l1:y10:id->string;;l1:y16:cur"
  "rent-debugger;;l1:y15:failure-object?;;l1:y22:failure-object-message;;"
  "l1:y24:failure-object-irritants;;py10:flcopysign;y8:c99-math;;py10:fls"
  "ign-bit;y8:c99-math;;py10:fladjacent;y8:c99-math;;py13:flnormalized?;y"
  "8:c99-math;;py15:fldenormalized?;y8:c99-math;;py10:flexponent;y8:c99-m"
  "ath;;py7:flilogb;y8:c99-math;;py4:fl+*;y8:c99-math;;py9:flposdiff;y8:c"
  "99-math;;py6:flexp2;y8:c99-math;;py7:flexp-1;y8:c99-math;;py6:flcbrt;y"
  "8:c99-math;;py7:flhypot;y8:c99-math;;py7:fllog1+;y8:c99-math;;py6:fllo"
  "g2;y8:c99-math;;py7:flasinh;y8:c99-math;;py7:flacosh;y8:c99-math;;py7:"
  "flatanh;y8:c99-math;;py9:%25flremquo;y8:c99-math;;py7:flgamma;y8:c99-m"
  "ath;;py8:fllgamma;y8:c99-math;;py5:flerf;y8:c99-math;;py6:flerfc;y8:c9"
  "9-math;;py14:flfirst-bessel;y8:xsi-math;;py15:flsecond-bessel;y8:xsi-m"
  "ath;;py20:*user-name-registry*;y6:hidden;;py25:make-readonly-environme"
  ...
  "me;y4:base;)]2}'(y1:x),.1v?{'(l2:y6:scheme;y3:box;)]2}.1Nw?{.1Ti}{f}?{"
  ".1,'(y4:srfi),l2]2}.1,l1]2}.!0&0{%1${&0{%1n,'(l1:y5:begin;),V12]1},.3,"
  "@(y20:*root-name-registry*),@(y11:name-lookup)[03}z]1}.!1&0{%3'1,.1V4,"
  ".0,.3A3,.0?{.4,.1sd]5}.1,.5,.5cc,'1,.4V5]5}.!2&0{%1&0{%1.0,'(y5:const)"
  ",l2]1},.1,@(y20:*root-name-registry*),@(y11:name-lookup)[13}.!3.4d,.5a"
  ",,#0.0,.6,.5,.7,.(i10),&5{%2.1u?{${.2,:0^[01},.1,${'(l1:y5:skint;),:1^"
  "[01},:3^[23}'(y8:c99-math),.2q?{@(y10:*features*),'(y8:c99-math)A0~}{f"
  "},.0?{.0]3}'(y8:xsi-math),.3q?{@(y10:*features*),'(y8:xsi-math)A0~}{f}"
  ",.0?{.0]4}.3p~?{${.4,:0^[01},.3,${n,.8c,'(y5:skint)c,:1^[01},:3^[43}${"
  "${.6,:0^[01},.5,${${.(i11)a,:2^[01},:1^[01},:3^[03}.3d,.3,:4^[42}.!0.0"
  ...
  "-id-lookup)[22}'(y4:peek),.2q?{${f,.3,:0,@(y11:name-lookup)[03},.0?{.0"
  "]3}:0]3}'(y14:define-library),.1q?{'(y14:define-library)b]2}${.2,@(y9:"
  "listname?)[01}~?{f]2}:1,.1,&2{%1:1^,:0,@(y13:fetch-library)[12},.1,:0,"
  ...
  "%2${'(y3:ref),.3,.5[02},.0Y2?{.0z,.0V0?{.0]4}f]4}f]3",
  ...
  "},.0V0?{.0}{f},.0?{'1,.1V4}{f},.5,&1{%1.0,:0,@(y37:fully-qualified-lib"
  "rary-prefixed-name)[12},.1L0?{@(y17:empty-environment),.1,.3,@(y27:mak"
  "e-controlled-environment)[73}f]7",
  ...
  ",&2{%1:0^?{t,.1P79}@(y12:command-line),${f,${@(y12:command-line)[00},."
  "4[02},${.3[00},.0,.3,&2{%0t,:1,:0[02},.4,:1,&2{%0${:1,@(y14:read-code-"
  "sexp)[01},,#0:0,:1,.2,&3{%1.0R8~?{${:2^,.3,@(y4:eval)[02}${:1,@(y14:re"
  "ad-code-sexp)[01},:0^[11}]1}.!0.0^_1[01},.3,.5,&2{%0t,:1,:0[02},@(y12:"
  "dynamic-wind)[43},.6,@(y28:call-with-current-input-file)[02}Y9]4",
  ...
  "P", "repl-read",
  "%3.1?{.2W6.1,.1P81,.0?{.0}{${.4,'(s4:~a~!),.7,@(y6:format)[03}}_1}.0,@"
  "(y14:read-code-sexp)[31",

  "P", "repl-import-name",
  "%1.0Nw?{.0Ti?{'0,.1<!}{f}}{f}?{.0,'(y4:srfi),l2]1}.0Y0?{.0,'(y5:skint)"
  ",l2]1}${.2,@(y9:listname?)[01}?{.0]1}f]1",

  "P", "repl-import",
  "%2.0u?{.1,'(s23:no libraries to import%0a)W4]2}n,.1,,#0.0,.5,&2{%2.0u?"
  "{:0,@(y16:repl-environment),.3A9,'(y6:import)c,@(y22:repl-evaluate-top"
  ...
  "%1P51,.0,.2W5@(y24:*library-directory-list*),'(s49: is absent or maske"
  "d; the library search path is:),.2P90,'(s8:library ),Sa3c,@(y5:error),"
  "@(y13:apply-to-list)[22",
  ...
  "/),'1,.2+,:1S4C=?{'(c/),'2,.2+,:1S4C=}{f}}{f},.0?{.0]2}'1,.2+,:2^[21}f"
  "]1}.!0.0^_1[31}f]1",
  ...
  ":2,'(s6:done!%0a)W4]1}:2,'(s16:name not found: )W4:2,:0^aW5:2W6]1}${.2"
  ",'(l1:y3:unr;),@(y11:sexp-match?)[02}?{:2,@(y20:*user-name-registry*)W"
  "5:2W6]1}${.2,'(l2:y4:uref;y1:*;),@(y11:sexp-match?)[02}?{:2,${f,:0^a,@"
  "(y20:*user-name-registry*),@(y11:name-lookup)[03}W5:2W6]1}${.2,'(l2:y5"
  ":urem!;y1:*;),@(y11:sexp-match?)[02}?{${f,:0^a,@(y20:*user-name-regist"
  "ry*),@(y11:name-lookup)[03}?{${:0^a,@(y20:*user-name-registry*),@(y12:"
  "name-remove!)[02}:2,'(s6:done!%0a)W4]1}:2,'(s16:name not found: )W4:2,"
  ":0^aW5:2W6]1}${.2,'(l1:y2:gs;),@(y11:sexp-match?)[02}?{:2,U2W5:2W6]1}$"
  "{.2,'(l2:y2:gs;y8:<symbol>;),@(y11:sexp-match?)[02}?{:0^a,U2,.0V3,.2Zi"
  ",:2,.1,.3V4,.4A3,.0?{.0d}{f}_1W5:2W6]4}${.2,'(l2:y4:load;y8:<string>;)"
  ",@(y11:sexp-match?)[02}?{:0^a,@(y4:load)[11}${.2,'(l2:y2:ld;y8:<string"
  ">;),@(y11:sexp-match?)[02}?{:0^a,@(y4:load)[11}${.2,'(l3:y2:im;y1:*;y3"
  ":...;),@(y11:sexp-match?)[02}?{:2,:0^,@(y11:repl-import)[12}${.2,'(l3:"
  "y2:tr;y1:*;y3:...;),@(y11:sexp-match?)[02}?{:0^,'(s2:tr),t,:2,@(y10:re"
  "pl-trace)[14}${.2,'(l3:y4:untr;y1:*;y3:...;),@(y11:sexp-match?)[02}?{:"
  "0^,'(s4:untr),f,:2,@(y10:repl-trace)[14}${.2,'(l1:y2:ap;),@(y11:sexp-m"
  "atch?)[02}?{:0^,:2,@(y12:repl-apropos)[12}${.2,'(l2:y2:ap;y1:*;),@(y11"
  ":sexp-match?)[02}?{:0^,:2,@(y12:repl-apropos)[12}${.2,'(l1:y2:pp;),@(y"
  "11:sexp-match?)[02}?{:0^,:2,@(y17:repl-pretty-print)[12}${.2,'(l2:y2:p"
  "p;y1:*;),@(y11:sexp-match?)[02}?{:0^,:2,@(y17:repl-pretty-print)[12}${"
  ".2,'(l1:y2:da;),@(y11:sexp-match?)[02}?{:0^,:2,@(y11:repl-disasm)[12}$"
  "{.2,'(l2:y2:da;y1:*;),@(y11:sexp-match?)[02}?{:0^,:2,@(y11:repl-disasm"
  ")[12}${.2,'(l1:y2:db;),@(y11:sexp-match?)[02}?{@(y5:debug)[10}${.2,'(l"
  "1:y1:v;),@(y11:sexp-match?)[02}?{t@!(y9:*verbose*)'(s17:verbosity is o"
  "n~%25),t,@(y6:format)[12}${.2,'(l1:y2:v-;),@(y11:sexp-match?)[02}?{f@!"
  "(y9:*verbose*)'(s18:verbosity is off~%25),t,@(y6:format)[12}${.2,'(l1:"
  "y1:q;),@(y11:sexp-match?)[02}?{t@!(y7:*quiet*)'(s13:quiet is on~%25),t"
  ",@(y6:format)[12}${.2,'(l1:y2:q-;),@(y11:sexp-match?)[02}?{f@!(y7:*qui"
  "et*)'(s14:quiet is off~%25),t,@(y6:format)[12}${.2,'(l2:y4:time;y1:*;)"
  ",@(y11:sexp-match?)[02}?{Z3,${:2,@(y16:repl-environment),:0^a,@(y22:re"
  "pl-evaluate-top-form)[03}Z4,.1,Z3-/,'(i1000)*,'(s24:; elapsed time: ~s"
  " ms.~%25),t,@(y6:format)[23}${.2,'(l1:y3:pwd;),@(y11:sexp-match?)[02}?"
  "{:2,${@(y17:current-directory)[00}W4:2W6]1}${.2,'(l2:y2:cd;y8:<string>"
  ";),@(y11:sexp-match?)[02}?{:0^a,@(y17:current-directory)[11}${.2,'(l2:"
  "y2:sh;y8:<string>;),@(y11:sexp-match?)[02}?{:0^aZ6]1}${.2,'(l1:y2:si;)"
  ",@(y11:sexp-match?)[02}?{${@(y14:print-version!)[00}@(y22:*loaded-mask"
  "-patterns*)p?{${@(y22:*loaded-mask-patterns*),'(s19:library masks: ~w~"
  "%25),t,@(y6:format)[03}}@(y20:enhanced-tty-library)?{${@(y20:enhanced-"
  "tty-library),'(s26:enhanced-tty library: ~a~%25),t,@(y6:format)[03}}Zh"
  ",Zb,Zc,'(s49:~d collections, ~d reallocs, heap size ~d words~%25),t,@("
  "y6:format)[15}${.2,'(l1:y2:gc;),@(y11:sexp-match?)[02}?{Zg'(l1:y2:si;)"
  ",:1^[11}${.2,'(l1:y4:help;),@(y11:sexp-match?)[02}?{:2,'(s55:%0aREPL c"
  "ommands (,ld ,cd ,sh arguments need no quotes):%0a)W4:2,'(s61: ,ld <fn"
  "ame>         load <fname> into REPL (aliases: ,load)%0a)W4:2,'(s71: ,i"
  "m <lib> ...       import libraries: 1 is (srfi 1), fx is (skint fx)%0a"
  ")W4:2,'(s68: ,tr <name> ...      trace named procedures, fetching (ski"
  "nt trace)%0a)W4:2,'(s41: ,tr                 show what is traced%0a)W4"
  ":2,'(s39: ,untr <name> ...    stop tracing them%0a)W4:2,'(s45: ,untr  "
  "             stop tracing everything%0a)W4:2,'(s76: ,ap <name>        "
  "  list names containing <name>, fetching (skint apropos)%0a)W4:2,'(s65"
  ": ,pp <expr>          pretty-print <expr>, fetching (skint print)%0a)W"
  "4:2,'(s65: ,da <proc>          disassemble <proc>, fetching (skint dis"
  "asm)%0a)W4:2,'(s66: ,db                 debug the last error, fetching"
  " (skint debug)%0a)W4:2,'(s59: ,q                  quiet: disable infor"
  "mational messages%0a)W4:2,'(s51: ,q-                 enable informatio"
  "nal messages%0a)W4:2,'(s39: ,v                  turn verbosity on%0a)W"
  "4:2,'(s40: ,v-                 turn verbosity off%0a)W4:2,'(s48: ,ref "
  "<name>         show denotation for <name>%0a)W4:2,'(s45: ,rnr         "
  "       show root name registry%0a)W4:2,'(s50: ,rref <name>        look"
  "up name in root registry%0a)W4:2,'(s52: ,rrem! <name>       remove nam"
  "e from root registry%0a)W4:2,'(s45: ,unr                show user name"
  " registry%0a)W4:2,'(s50: ,uref <name>        lookup name in user regis"
  "try%0a)W4:2,'(s52: ,urem! <name>       remove name from user registry%"
  "0a)W4:2,'(s46: ,gs                 show global store (big!)%0a)W4:2,'("
  "s55: ,gs <name>          lookup global location for <name>%0a)W4:2,'(s"
  "56: ,time <expr>        time single-line expression <expr>%0a)W4:2,'(s"
  "60: ,pwd                show skint's current working directory%0a)W4:2"
  ",'(s62: ,cd <dir>           change skint's current working directory%0"
  "a)W4:2,'(s51: ,sh <cmdline>       send <cmdline> to local shell%0a)W4:"
  "2,'(s41: ,si                 display system info%0a)W4:2,'(s55: ,gc   "
  "              force gc to finalize lost objects%0a)W4:2,'(s48: ,help  "
  "             this help (aliases: ,h ,?)%0a)W4]1}${.2,'(l1:y1:h;),@(y11"
  ":sexp-match?)[02}?{'(l1:y4:help;),:1^[11}${.2,'(l1:y1:?;),@(y11:sexp-m"
  ...
  "(i12),&5{%0:4,&1{%!0.0,&1{%0:0,@(y6:values),@(y13:apply-to-list)[02},:"
  ...
  "1${k0,.0,${.6,:1,:2,:3,:4,:5,&6{%0:5,${.2,@(y13:error-object?)[01}?{Pe"
  ",.0,${.4,@(y20:error-object-message)[01}W4.0W6${${.5,@(y22:error-objec"
  "t-irritants)[01},.3,&1{%1${:0,.3,@(y14:write-irritant)[02}:0W6]1},@(y1"
  "0:%25for-each1)[02}${.2,@(y19:print-debugger-hint)[01}_1${.2,@(y11:rea"
  "d-error?)[01}?{:3P70}${:4^,@(y23:set-current-file-stack!)[01}Zg:1?{:0,"
  ":1,:2,:3,@(y14:repl-from-port)[14}]1}.0Uf?{Pe,${.2,.4,@(y13:print-fail"
  "ure)[02}${.2,@(y19:print-debugger-hint)[01}_1${:4^,@(y23:set-current-f"
  "ile-stack!)[01}Zg:1?{:0,:1,:2,:3,@(y14:repl-from-port)[14}]1}Pe,.0,'(s"
  "14:Unknown error:)W4.0W6.0,.2W5.0W6${.2,@(y19:print-debugger-hint)[01}"
  "_1${:4^,@(y23:set-current-file-stack!)[01}Zg:1?{:0,:1,:2,:3,@(y14:repl"
  "-from-port)[14}]1},:0[01}_1_3}[10},@(y22:with-exception-handler)[02}_1"
  "_3}[50",
  ...
  "s;;l5:y13:undef-feature;s2:-U;s15:--undef-feature;s4:NAME;s37:Remove n"
  "ame from the list of features;;l5:y4:eval;s2:-e;s6:--eval;s4:SEXP;s32:"
  "Evaluate and print an expression;;l5:y4:load;s2:-l;s6:--load;s4:FILE;s"
  "33:Load file and continue processing;;l5:y6:script;s2:-s;s8:--script;s"
  "4:FILE;s27:Run file as a Scheme script;;l5:y7:program;s2:-p;s9:--progr"
  "am;s4:FILE;s28:Run file as a Scheme program;;l5:y7:version;s2:-V;s9:--"
  "version;f;s20:Display version info;;l5:y4:help;s2:-h;s6:--help;f;s17:D"
  "isplay this help;;)@!(y15:*skint-options*)",

  "C", 0,
  "'(s5:0.8.5)@!(y15:*skint-version*)",
  ...
  "C", 0,
  "@(y10:*features*),@(y15:*skint-version*),'(s6:skint-),Sa2X5c@!(y10:*fe"
  "atures*)",
  ...
  ",@(y8:set-cons)[02},@(y8:features)[11}.!1&0{%1${.2X5,l1,${@(y8:feature"
  "s)[00},@(y9:set-minus)[02},@(y8:features)[11}.!2&0{%0${@(y15:*skint-ve"
  "rsion*),'(s28:SKINT Scheme Interpreter v~a),t,@(y6:format)[03}@(y9:opt"
  "-tower)?{${'(s1:t),t,@(y6:format)[02}}@(y11:opt-unicode)?{${'(s1:u),t,"
  "@(y6:format)[02}}@(y10:opt-enhtty)?{${'(s1:e),t,@(y6:format)[02}}${'(s"
  "2:~%25),t,@(y6:format)[02}${'(s42:usage: skint [OPTION]... [FILE] [ARG"
  "]...~%25),t,@(y6:format)[02}${'(s2:~%25),t,@(y6:format)[02}${'(s10:Opt"
  "ions:~%25),t,@(y6:format)[02}${Po,@(y15:*skint-options*),@(y26:print-c"
  "ommand-line-options)[02}${'(s2:~%25),t,@(y6:format)[02}${'(s80:'--' en"
  "ds options processing. Standalone FILE argument is treated as a script"
  ".~%25),t,@(y6:format)[02}${'(s82:If no FILE is given, skint enters Rea"
  "d-Eval-Print loop (stdin>eval-print>stdout)~%25),t,@(y6:format)[02}'(s"
  "2:~%25),t,@(y6:format)[02}.!3${@(y12:command-line)[00}.!4${t,.7^d,,#0."
  "8,.1,.7,.(i10),.(i10),&5{%2:0,:1,:2,:3,:4,.6,&6{%3.1?{.1,.1,l2}{.0,l1}"
  ",${.2,'(l1:y7:verbose;),@(y11:sexp-match?)[02}?{t@!(y9:*verbose*)t,.4,"
  ":2^[42}${.2,'(l1:y5:quiet;),@(y11:sexp-match?)[02}?{t@!(y7:*quiet*)t,."
  "4,:2^[42}${.2,'(l2:y13:append-libdir;y1:*;),@(y11:sexp-match?)[02}?{${"
  ".4,@(y20:append-library-path!)[01}t,.4,:2^[42}${.2,'(l2:y14:prepend-li"
  "bdir;y1:*;),@(y11:sexp-match?)[02}?{${.4,@(y21:prepend-library-path!)["
  "01}t,.4,:2^[42}${.2,'(l2:y14:define-feature;y1:*;),@(y11:sexp-match?)["
  "02}?{${.4,:5^[01}t,.4,:2^[42}${.2,'(l2:y13:undef-feature;y1:*;),@(y11:"
  "sexp-match?)[02}?{${.4,:4^[01}t,.4,:2^[42}${.2,'(l2:y4:load;y1:*;),@(y"
  "11:sexp-match?)[02}?{${.4,@(y4:load)[01}t,.4,:2^[42}${.2,'(l2:y4:eval;"
  "y1:*;),@(y11:sexp-match?)[02}?{${t,.5,:3^[02}f,.4,:2^[42}${.2,'(l2:y6:"
  ...
  "2}?{${@(y14:print-version!)[00}f,n,:2^[42}${.2,'(l1:y4:help;),@(y11:se"
  "xp-match?)[02}?{${:1^[00}f,n,:2^[42}${.2,'(l1:f;),@(y11:sexp-match?)[0"
  "2}?{.3p?{t@!(y7:*quiet*)${.5d,.6a,@(y10:run-script)[02},@(y4:exit)[41}"
  ":0~?{t,@(y4:exit)[41}f]4}]4},@(y15:*skint-options*),.2,@(y28:get-next-"
  "command-line-option)[23}.!0.0^_1[02}PiP09?{PoP09}{f}?{${@(y15:*skint-v"
  "ersion*),'(s28:SKINT Scheme Interpreter v~a),t,@(y6:format)[03}@(y9:op"
  "t-tower)?{${'(s1:t),t,@(y6:format)[02}}@(y11:opt-unicode)?{${'(s1:u),t"
  ",@(y6:format)[02}}@(y10:opt-enhtty)?{${'(s1:e),t,@(y6:format)[02}}${'("
  "s2:~%25),t,@(y6:format)[02}${'(s40:Copyright (c) 2024-2026 False Schem"
  "ers~%25),t,@(y6:format)[02}}t]5",
