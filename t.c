...
char *t_code[] = {
  ...
  "%2.0N0?{.0Ti?{.0,'0I>!?{'9,.1I>!}{f}}{f}}{f}?{.1,.1,'(s10:0123456789)S"
  ...
  "C", 0,
  "${'(l572:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  "l1:y5:fxsll;;l1:y5:fxsra;;l1:y5:fxsrl;;l1:y5:fxeqv;;l1:y6:fxaddc;;l1:y"
  "6:fxsubc;;l1:y6:fxmulc;;l1:y6:fxfmar;;l1:y14:fixnum->flonum;;l1:y14:fi"
  "xnum->string;;l1:y14:string->fixnum;;l1:y7:flonum?;;l1:y7:flzero?;;l1:"
  "y11:flpositive?;;l1:y11:flnegative?;;l1:y10:flinteger?;;l1:y6:flnan?;;"
  "l1:y11:flinfinite?;;l1:y9:flfinite?;;l1:y7:fleven?;;l1:y6:flodd?;;l1:y"
  "3:fl+;;l1:y3:fl*;;l1:y3:fl-;;l1:y3:fl/;;l1:y5:flneg;;l1:y5:flabs;;l1:y"
  "5:flgcd;;l1:y6:flexpt;;l1:y6:flsqrt;;l1:y7:flfloor;;l1:y9:flceiling;;l"
  "1:y10:fltruncate;;l1:y7:flround;;l1:y5:flexp;;l1:y5:fllog;;l1:y5:flsin"
  ";;l1:y5:flcos;;l1:y5:fltan;;l1:y6:flasin;;l1:y6:flacos;;l1:y6:flatan;;"
  "l1:y4:fl<?;;l1:y5:fl<=?;;l1:y4:fl>?;;l1:y5:fl>=?;;l1:y4:fl=?;;l1:y5:fl"
  "!=?;;l1:y5:flmin;;l1:y5:flmax;;l1:y11:flremainder;;l1:y8:flmodulo;;l1:"
  "y10:flquotient;;l1:y8:flmodquo;;l1:y14:flonum->fixnum;;l1:y14:flonum->"
  "string;;l1:y7:flldexp;;l1:y6:flmodf;;l1:y7:flfrexp;;l1:y6:flsinh;;l1:y"
  "6:flcosh;;l1:y6:fltanh;;l1:y7:fllog10;;l1:y14:string->flonum;;l1:y6:lo"
  "gnot;;l1:y6:logand;;l1:y6:logior;;l1:y6:logxor;;l1:y3:ash;;l1:y7:bignu"
  "m?;;l1:y7:ratnum?;;l1:y8:compnum?;;l1:y8:rectnum?;;l1:y8:list-cat;;l1:"
  "y9:last-pair;;l1:y9:list-head;;l1:y4:meme;;l1:y4:asse;;l1:y4:memp;;l1:"
  "y4:assp;;l1:y8:reverse!;;l1:y9:circular?;;l1:y5:cons*;;l1:y5:list*;;l1"
  ":y8:char-cmp;;l1:y11:char-ci-cmp;;l1:y10:string-cat;;l1:y15:string-pos"
  "ition;;l1:y10:string-cmp;;l1:y13:string-ci-cmp;;l1:y10:vector-cat;;l1:"
  "y12:bytevector=?;;l1:y16:bytevector->list;;l1:y16:list->bytevector;;l1"
  ":y13:subbytevector;;l1:y10:numvector?;;l1:y14:make-numvector;;l1:y16:n"
  "umvector-length;;l1:y13:numvector-ref;;l1:y14:numvector-set!;;l1:y15:l"
  "ist->numvector;;l1:y19:standard-input-port;;l1:y20:standard-output-por"
  "t;;l1:y19:standard-error-port;;l1:y9:tty-port?;;l1:y15:port-fold-case?"
  ";;l1:y19:set-port-fold-case!;;l1:y11:rename-file;;l1:y17:current-direc"
  "tory;;l1:y19:directory-separator;;l1:y14:path-separator;;l1:y4:void;;l"
  "1:y5:void?;;l1:y19:implementation-name;;l1:y22:implementation-version;"
  ";l1:y13:version-alist;;l1:y16:current-language;;l1:y15:current-country"
  ";;l1:y22:current-locale-details;;l1:y3:id?;;l1:y10:string->id;;l1:y10:"
  "id->string;;py10:flcopysign;y8:c99-math;;py10:flsign-bit;y8:c99-math;;"
  "py10:fladjacent;y8:c99-math;;py13:flnormalized?;y8:c99-math;;py15:flde"
  "normalized?;y8:c99-math;;py10:flexponent;y8:c99-math;;py7:flilogb;y8:c"
  "99-math;;py4:fl+*;y8:c99-math;;py9:flposdiff;y8:c99-math;;py6:flexp2;y"
  "8:c99-math;;py7:flexp-1;y8:c99-math;;py6:flcbrt;y8:c99-math;;py7:flhyp"
  "ot;y8:c99-math;;py7:fllog1+;y8:c99-math;;py6:fllog2;y8:c99-math;;py7:f"
  "lasinh;y8:c99-math;;py7:flacosh;y8:c99-math;;py7:flatanh;y8:c99-math;;"
  "py9:%25flremquo;y8:c99-math;;py7:flgamma;y8:c99-math;;py8:fllgamma;y8:"
  "c99-math;;py5:flerf;y8:c99-math;;py6:flerfc;y8:c99-math;;py14:flfirst-"
  "bessel;y8:xsi-math;;py15:flsecond-bessel;y8:xsi-math;;py20:*user-name-"
  "registry*;y6:hidden;;py25:make-readonly-environment;y6:hidden;;py27:ma"
  "ke-controlled-environment;y6:hidden;;py20:make-sld-environment;y6:hidd"
  "en;;py21:make-repl-environment;y6:hidden;;py19:find-library-in-env;y6:"
  "hidden;;py16:root-environment;y6:hidden;;py16:repl-environment;y6:hidd"
  "en;;py17:empty-environment;y6:hidden;;py32:make-historic-report-enviro"
  "nment;y6:hidden;;py16:r5rs-environment;y6:hidden;;py21:r5rs-null-envir"
  "onment;y6:hidden;;py9:*verbose*;y6:hidden;;py7:*quiet*;y6:hidden;;py25"
  ":compile-and-run-core-expr;y6:hidden;;py17:evaluate-top-form;y6:hidden"
  ";;py10:run-script;y6:hidden;;py11:run-program;y6:hidden;;py22:repl-eva"
  "luate-top-form;y6:hidden;;py9:repl-read;y6:hidden;;py17:repl-exec-comm"
  "and;y6:hidden;;py14:repl-from-port;y6:hidden;;py13:run-benchmark;y6:hi"
  "dden;;py4:repl;y6:hidden;;),&0{%1,,,,#0#1#2#3&0{%1.0,'(y1:w),.1v?{'(l2"
  ":y6:scheme;y5:write;)]2}'(y1:t),.1v?{'(l2:y6:scheme;y4:time;)]2}'(y1:p"
  "),.1v?{'(l2:y6:scheme;y4:repl;)]2}'(y1:r),.1v?{'(l2:y6:scheme;y4:read;"
  ")]2}'(y1:v),.1v?{'(l2:y6:scheme;y4:r5rs;)]2}'(y1:u),.1v?{'(l2:y6:schem"
  "e;y9:r5rs-null;)]2}'(y1:d),.1v?{'(l2:y6:scheme;y4:load;)]2}'(y1:z),.1v"
  "?{'(l2:y6:scheme;y4:lazy;)]2}'(y1:s),.1v?{'(l2:y6:scheme;y15:process-c"
  "ontext;)]2}'(y1:i),.1v?{'(l2:y6:scheme;y7:inexact;)]2}'(y1:f),.1v?{'(l"
  "2:y6:scheme;y4:file;)]2}'(y1:e),.1v?{'(l2:y6:scheme;y4:eval;)]2}'(y1:o"
  "),.1v?{'(l2:y6:scheme;y7:complex;)]2}'(y1:h),.1v?{'(l2:y6:scheme;y4:ch"
  "ar;)]2}'(y1:l),.1v?{'(l2:y6:scheme;y11:case-lambda;)]2}'(y1:a),.1v?{'("
  "l2:y6:scheme;y3:cxr;)]2}'(y1:b),.1v?{'(l2:y6:scheme;y4:base;)]2}'(y1:x"
  "),.1v?{'(l2:y6:scheme;y3:box;)]2}.1Nw!?{.1,'(y4:srfi),l2]2}.1,l1]2}.!0"
  "&0{%1${&0{%1n,'(l1:y5:begin;),V12]1},.3,@(y20:*root-name-registry*),@("
  "y11:name-lookup)[03}z]1}.!1&0{%3'1,.1V4,.0,.3A3,.0?{.4,.1sd]5}.1,.5,.5"
  "cc,'1,.4V5]5}.!2&0{%1&0{%1.0,'(y5:const),l2]1},.1,@(y20:*root-name-reg"
  "istry*),@(y11:name-lookup)[13}.!3.4d,.5a,,#0.0,.6,.5,.7,.(i10),&5{%2.1"
  "u?{${.2,:0^[01},.1,${'(l1:y5:skint;),:1^[01},:3^[23}'(y8:c99-math),.2q"
  "?{@(y10:*features*),'(y8:c99-math)A0~}{f},.0?{.0]3}'(y8:xsi-math),.3q?"
  "{@(y10:*features*),'(y8:xsi-math)A0~}{f},.0?{.0]4}.3p~?{${.4,:0^[01},."
  "3,${n,.8c,'(y5:skint)c,:1^[01},:3^[43}${${.6,:0^[01},.5,${${.(i11)a,:2"
