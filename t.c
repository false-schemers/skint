...
char *t_code[] = {
  ...
  "C", 0,
  "${'(l581:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  ";l3:y8:set-box!;y1:x;i111;;l1:y6:format;;l1:y6:printf;;l1:y7:fprintf;;"
  "l1:y19:format-pretty-print;;l1:y24:format-exponential-print;;l1:y18:fo"
  "rmat-fixed-print;;l1:y20:format-general-print;;l1:y17:format-fresh-lin"
  "e;;l1:y18:format-help-string;;l1:y16:clear-input-port;;l1:y4:set&;;l1:"
  "y7:lambda*;;l1:y4:body;;l1:y5:letcc;;l1:y6:withcc;;l1:y13:syntax-lambd"
  "a;;l1:y13:syntax-length;;l1:y6:expand;;l1:y7:record?;;l1:y11:make-reco"
  "rd;;l1:y13:record-length;;l1:y10:record-ref;;l1:y11:record-set!;;l1:y2"
  "2:record-type-descriptor;;l1:y7:fixnum?;;l1:y11:fxpositive?;;l1:y11:fx"
  "negative?;;l1:y7:fxeven?;;l1:y6:fxodd?;;l1:y7:fxzero?;;l1:y3:fx+;;l1:y"
  "3:fx*;;l1:y3:fx-;;l1:y3:fx/;;l1:y10:fxquotient;;l1:y11:fxremainder;;l1"
  ":y8:fxmodquo;;l1:y8:fxmodulo;;l1:y8:fxeucquo;;l1:y8:fxeucrem;;l1:y5:fx"
  "neg;;l1:y5:fxabs;;l1:y4:fx<?;;l1:y5:fx<=?;;l1:y4:fx>?;;l1:y5:fx>=?;;l1"
  ":y4:fx=?;;l1:y5:fx!=?;;l1:y5:fxmin;;l1:y5:fxmax;;l1:y5:fxneg;;l1:y5:fx"
  "abs;;l1:y5:fxgcd;;l1:y6:fxexpt;;l1:y7:%25fxsqrt;;l1:y5:fxnot;;l1:y5:fx"
  "and;;l1:y5:fxior;;l1:y5:fxxor;;l1:y5:fxsll;;l1:y5:fxsra;;l1:y5:fxsrl;;"
  "l1:y5:fxeqv;;l1:y8:fxlength;;l1:y11:fxbit-count;;l1:y6:fxaddc;;l1:y6:f"
  "xsubc;;l1:y6:fxmulc;;l1:y6:fxfmar;;l1:y14:fixnum->flonum;;l1:y14:fixnu"
  "m->string;;l1:y14:string->fixnum;;l1:y7:flonum?;;l1:y7:flzero?;;l1:y11"
  ":flpositive?;;l1:y11:flnegative?;;l1:y10:flinteger?;;l1:y6:flnan?;;l1:"
  "y11:flinfinite?;;l1:y9:flfinite?;;l1:y7:fleven?;;l1:y6:flodd?;;l1:y3:f"
  "l+;;l1:y3:fl*;;l1:y3:fl-;;l1:y3:fl/;;l1:y5:flneg;;l1:y5:flabs;;l1:y5:f"
  "lgcd;;l1:y6:flexpt;;l1:y6:flsqrt;;l1:y7:flfloor;;l1:y9:flceiling;;l1:y"
  "10:fltruncate;;l1:y7:flround;;l1:y5:flexp;;l1:y5:fllog;;l1:y5:flsin;;l"
  "1:y5:flcos;;l1:y5:fltan;;l1:y6:flasin;;l1:y6:flacos;;l1:y6:flatan;;l1:"
  "y4:fl<?;;l1:y5:fl<=?;;l1:y4:fl>?;;l1:y5:fl>=?;;l1:y4:fl=?;;l1:y5:fl!=?"
  ";;l1:y5:flmin;;l1:y5:flmax;;l1:y11:flremainder;;l1:y8:flmodulo;;l1:y10"
  ":flquotient;;l1:y8:flmodquo;;l1:y14:flonum->fixnum;;l1:y14:flonum->str"
  "ing;;l1:y7:flldexp;;l1:y6:flmodf;;l1:y7:flfrexp;;l1:y6:flsinh;;l1:y6:f"
  "lcosh;;l1:y6:fltanh;;l1:y7:fllog10;;l1:y14:string->flonum;;l1:y11:bitw"
  "ise-not;;l1:y11:bitwise-and;;l1:y11:bitwise-ior;;l1:y11:bitwise-xor;;l"
  "1:y16:arithmetic-shift;;l1:y14:integer-length;;l1:y9:bit-count;;l1:y7:"
  "bignum?;;l1:y7:ratnum?;;l1:y8:compnum?;;l1:y8:rectnum?;;l1:y15:inexact"
  "->string;;l1:y8:list-cat;;l1:y9:last-pair;;l1:y9:list-head;;l1:y4:meme"
  ";;l1:y4:asse;;l1:y4:memp;;l1:y4:assp;;l1:y8:reverse!;;l1:y9:circular?;"
  ";l1:y5:cons*;;l1:y5:list*;;l1:y8:char-cmp;;l1:y11:char-ci-cmp;;l1:y10:"
  "string-cat;;l1:y15:string-position;;l1:y10:string-cmp;;l1:y13:string-c"
  "i-cmp;;l1:y10:vector-cat;;l1:y12:bytevector=?;;l1:y16:bytevector->list"
  ";;l1:y16:list->bytevector;;l1:y13:subbytevector;;l1:y10:numvector?;;l1"
  ":y14:make-numvector;;l1:y16:numvector-length;;l1:y13:numvector-ref;;l1"
  ":y14:numvector-set!;;l1:y15:list->numvector;;l1:y19:standard-input-por"
  "t;;l1:y20:standard-output-port;;l1:y19:standard-error-port;;l1:y9:tty-"
  "port?;;l1:y15:port-fold-case?;;l1:y19:set-port-fold-case!;;l1:y11:rena"
  "me-file;;l1:y17:current-directory;;l1:y19:directory-separator;;l1:y14:"
  "path-separator;;l1:y4:void;;l1:y5:void?;;l1:y19:implementation-name;;l"
  "1:y22:implementation-version;;l1:y13:version-alist;;l1:y16:current-lan"
  "guage;;l1:y15:current-country;;l1:y22:current-locale-details;;l1:y3:id"
  "?;;l1:y10:string->id;;l1:y10:id->string;;py10:flcopysign;y8:c99-math;;"
  "py10:flsign-bit;y8:c99-math;;py10:fladjacent;y8:c99-math;;py13:flnorma"
  "lized?;y8:c99-math;;py15:fldenormalized?;y8:c99-math;;py10:flexponent;"
  "y8:c99-math;;py7:flilogb;y8:c99-math;;py4:fl+*;y8:c99-math;;py9:flposd"
  "iff;y8:c99-math;;py6:flexp2;y8:c99-math;;py7:flexp-1;y8:c99-math;;py6:"
  "flcbrt;y8:c99-math;;py7:flhypot;y8:c99-math;;py7:fllog1+;y8:c99-math;;"
  "py6:fllog2;y8:c99-math;;py7:flasinh;y8:c99-math;;py7:flacosh;y8:c99-ma"
  "th;;py7:flatanh;y8:c99-math;;py9:%25flremquo;y8:c99-math;;py7:flgamma;"
  "y8:c99-math;;py8:fllgamma;y8:c99-math;;py5:flerf;y8:c99-math;;py6:fler"
  "fc;y8:c99-math;;py14:flfirst-bessel;y8:xsi-math;;py15:flsecond-bessel;"
  "y8:xsi-math;;py20:*user-name-registry*;y6:hidden;;py25:make-readonly-e"
  "nvironment;y6:hidden;;py27:make-controlled-environment;y6:hidden;;py20"
  ":make-sld-environment;y6:hidden;;py21:make-repl-environment;y6:hidden;"
  ";py19:find-library-in-env;y6:hidden;;py16:root-environment;y6:hidden;;"
  "py16:repl-environment;y6:hidden;;py17:empty-environment;y6:hidden;;py3"
  "2:make-historic-report-environment;y6:hidden;;py16:r5rs-environment;y6"
  ":hidden;;py21:r5rs-null-environment;y6:hidden;;py9:*verbose*;y6:hidden"
  ";;py7:*quiet*;y6:hidden;;py25:compile-and-run-core-expr;y6:hidden;;py1"
  "7:evaluate-top-form;y6:hidden;;py10:run-script;y6:hidden;;py11:run-pro"
  "gram;y6:hidden;;py22:repl-evaluate-top-form;y6:hidden;;py9:repl-read;y"
  "6:hidden;;py17:repl-exec-command;y6:hidden;;py14:repl-from-port;y6:hid"
  "den;;py13:run-benchmark;y6:hidden;;py4:repl;y6:hidden;;),&0{%1,,,,#0#1"
  ...
  "]2}'(y1:u),.1v?{'(l2:y6:scheme;y9:r5rs-null;)]2}'(y1:d),.1v?{'(l2:y6:s"
  "cheme;y4:load;)]2}'(y1:z),.1v?{'(l2:y6:scheme;y4:lazy;)]2}'(y1:s),.1v?"
  ...
  ":h),.1v?{'(l2:y6:scheme;y4:char;)]2}'(y1:l),.1v?{'(l2:y6:scheme;y11:ca"
  "se-lambda;)]2}'(y1:a),.1v?{'(l2:y6:scheme;y3:cxr;)]2}'(y1:b),.1v?{'(l2"
  ":y6:scheme;y4:base;)]2}'(y1:x),.1v?{'(l2:y6:scheme;y3:box;)]2}.1Nw!?{."
