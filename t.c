...
char *t_code[] = {
  ...
  ":y11:bitwise-ior;;l1:y11:bitwise-xor;;l1:y16:arithmetic-shift;;l1:y11:"
  "bitwise-eqv;;l1:y14:integer-length;;l1:y9:bit-count;;l1:y7:bignum?;;l1"
  ":y7:ratnum?;;l1:y8:compnum?;;l1:y8:rectnum?;;l1:y8:list-cat;;l1:y9:las"
  "t-pair;;l1:y9:list-head;;l1:y4:meme;;l1:y4:asse;;l1:y4:memp;;l1:y4:ass"
  "p;;l1:y8:reverse!;;l1:y9:circular?;;l1:y5:cons*;;l1:y5:list*;;l1:y8:ch"
  "ar-cmp;;l1:y11:char-ci-cmp;;l1:y10:string-cat;;l1:y15:string-position;"
  ";l1:y10:string-cmp;;l1:y13:string-ci-cmp;;l1:y10:vector-cat;;l1:y12:by"
  "tevector=?;;l1:y16:bytevector->list;;l1:y16:list->bytevector;;l1:y13:s"
  "ubbytevector;;l1:y10:numvector?;;l1:y14:make-numvector;;l1:y16:numvect"
  "or-length;;l1:y13:numvector-ref;;l1:y14:numvector-set!;;l1:y15:list->n"
  "umvector;;l1:y19:standard-input-port;;l1:y20:standard-output-port;;l1:"
  ...
  "l1:y19:directory-separator;;l1:y14:path-separator;;l1:y4:void;;l1:y5:v"
  "oid?;;l1:y19:implementation-name;;l1:y22:implementation-version;;l1:y1"
  "3:version-alist;;l1:y16:current-language;;l1:y15:current-country;;l1:y"
  "22:current-locale-details;;l1:y3:id?;;l1:y10:string->id;;l1:y10:id->st"
  "ring;;py10:flcopysign;y8:c99-math;;py10:flsign-bit;y8:c99-math;;py10:f"
  "ladjacent;y8:c99-math;;py13:flnormalized?;y8:c99-math;;py15:fldenormal"
  "ized?;y8:c99-math;;py10:flexponent;y8:c99-math;;py7:flilogb;y8:c99-mat"
  "h;;py4:fl+*;y8:c99-math;;py9:flposdiff;y8:c99-math;;py6:flexp2;y8:c99-"
  "math;;py7:flexp-1;y8:c99-math;;py6:flcbrt;y8:c99-math;;py7:flhypot;y8:"
  "c99-math;;py7:fllog1+;y8:c99-math;;py6:fllog2;y8:c99-math;;py7:flasinh"
  ";y8:c99-math;;py7:flacosh;y8:c99-math;;py7:flatanh;y8:c99-math;;py9:%2"
  "5flremquo;y8:c99-math;;py7:flgamma;y8:c99-math;;py8:fllgamma;y8:c99-ma"
  "th;;py5:flerf;y8:c99-math;;py6:flerfc;y8:c99-math;;py14:flfirst-bessel"
  ";y8:xsi-math;;py15:flsecond-bessel;y8:xsi-math;;py20:*user-name-regist"
  "ry*;y6:hidden;;py25:make-readonly-environment;y6:hidden;;py27:make-con"
  "trolled-environment;y6:hidden;;py20:make-sld-environment;y6:hidden;;py"
  "21:make-repl-environment;y6:hidden;;py19:find-library-in-env;y6:hidden"
  ";;py16:root-environment;y6:hidden;;py16:repl-environment;y6:hidden;;py"
  "17:empty-environment;y6:hidden;;py32:make-historic-report-environment;"
  "y6:hidden;;py16:r5rs-environment;y6:hidden;;py21:r5rs-null-environment"
  ";y6:hidden;;py9:*verbose*;y6:hidden;;py7:*quiet*;y6:hidden;;py25:compi"
  "le-and-run-core-expr;y6:hidden;;py17:evaluate-top-form;y6:hidden;;py10"
  ":run-script;y6:hidden;;py11:run-program;y6:hidden;;py22:repl-evaluate-"
  "top-form;y6:hidden;;py9:repl-read;y6:hidden;;py17:repl-exec-command;y6"
  ":hidden;;py14:repl-from-port;y6:hidden;;py13:run-benchmark;y6:hidden;;"
  "py4:repl;y6:hidden;;),&0{%1,,,,#0#1#2#3&0{%1.0,'(y1:w),.1v?{'(l2:y6:sc"
  "heme;y5:write;)]2}'(y1:t),.1v?{'(l2:y6:scheme;y4:time;)]2}'(y1:p),.1v?"
  "{'(l2:y6:scheme;y4:repl;)]2}'(y1:r),.1v?{'(l2:y6:scheme;y4:read;)]2}'("
  "y1:v),.1v?{'(l2:y6:scheme;y4:r5rs;)]2}'(y1:u),.1v?{'(l2:y6:scheme;y9:r"
  "5rs-null;)]2}'(y1:d),.1v?{'(l2:y6:scheme;y4:load;)]2}'(y1:z),.1v?{'(l2"
  ":y6:scheme;y4:lazy;)]2}'(y1:s),.1v?{'(l2:y6:scheme;y15:process-context"
  ";)]2}'(y1:i),.1v?{'(l2:y6:scheme;y7:inexact;)]2}'(y1:f),.1v?{'(l2:y6:s"
  "cheme;y4:file;)]2}'(y1:e),.1v?{'(l2:y6:scheme;y4:eval;)]2}'(y1:o),.1v?"
  "{'(l2:y6:scheme;y7:complex;)]2}'(y1:h),.1v?{'(l2:y6:scheme;y4:char;)]2"
  "}'(y1:l),.1v?{'(l2:y6:scheme;y11:case-lambda;)]2}'(y1:a),.1v?{'(l2:y6:"
  "scheme;y3:cxr;)]2}'(y1:b),.1v?{'(l2:y6:scheme;y4:base;)]2}'(y1:x),.1v?"
  "{'(l2:y6:scheme;y3:box;)]2}.1Nw!?{.1,'(y4:srfi),l2]2}.1,l1]2}.!0&0{%1$"
  "{&0{%1n,'(l1:y5:begin;),V12]1},.3,@(y20:*root-name-registry*),@(y11:na"
  "me-lookup)[03}z]1}.!1&0{%3'1,.1V4,.0,.3A3,.0?{.4,.1sd]5}.1,.5,.5cc,'1,"
  ".4V5]5}.!2&0{%1&0{%1.0,'(y5:const),l2]1},.1,@(y20:*root-name-registry*"
  "),@(y11:name-lookup)[13}.!3.4d,.5a,,#0.0,.6,.5,.7,.(i10),&5{%2.1u?{${."
  "2,:0^[01},.1,${'(l1:y5:skint;),:1^[01},:3^[23}'(y8:c99-math),.2q?{@(y1"
  "0:*features*),'(y8:c99-math)A0~}{f},.0?{.0]3}'(y8:xsi-math),.3q?{@(y10"
  ":*features*),'(y8:xsi-math)A0~}{f},.0?{.0]4}.3p~?{${.4,:0^[01},.3,${n,"
  ".8c,'(y5:skint)c,:1^[01},:3^[43}${${.6,:0^[01},.5,${${.(i11)a,:2^[01},"
  ":1^[01},:3^[03}.3d,.3,:4^[42}.!0.0^_1[52},@(y10:%25for-each1)[02}",
