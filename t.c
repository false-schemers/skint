...
char *t_code[] = {
  ...
  "ring)[22}.0L0?{.1,'(cl)W0${.3,.3g,@(y21:write-serialized-size)[02}.0,,"
  "#0.0,.4,&2{%1.0u?{]1}${:0,.3a,@(y24:write-serialized-element)[02}.0d,:"
  "1^[11}.!0.0^_1[21}.0p?{.1,'(cp)W0${.3,.3a,@(y24:write-serialized-eleme"
  "nt)[02}.1,.1d,@(y24:write-serialized-element)[22}.0V0?{.1,'(cv)W0${.3,"
  ".3V3,@(y21:write-serialized-size)[02}'0,,#0.0,.3,.5,&3{%1:1V3,.1I=?{]1"
  ...
  "C", 0,
  "${'(l564:l3:y1:*;y1:v;y1:b;;l3:y1:+;y1:v;y1:b;;l3:y1:-;y1:v;y1:b;;l4:y"
  ...
  "l1:y23:procedure-minimum-arity;;l4:y10:quasiquote;y1:v;y1:u;y1:b;;l4:y"
  "5:quote;y1:v;y1:u;y1:b;;l3:y8:quotient;y1:v;y1:b;;l2:y5:raise;y1:b;;l2"
  ":y17:raise-continuable;y1:b;;l3:y9:rational?;y1:v;y1:b;;l3:y11:rationa"
  "lize;y1:v;y1:b;;l2:y15:read-bytevector;y1:b;;l2:y16:read-bytevector!;y"
  "1:b;;l3:y9:read-char;y1:v;y1:b;;l2:y11:read-error?;y1:b;;l2:y9:read-li"
  "ne;y1:b;;l2:y11:read-string;y1:b;;l2:y7:read-u8;y1:b;;l3:y5:real?;y1:v"
  ";y1:b;;l3:y9:remainder;y1:v;y1:b;;l3:y7:reverse;y1:v;y1:b;;l3:y5:round"
  ";y1:v;y1:b;;l3:y4:set!;y1:v;y1:b;;l3:y8:set-car!;y1:v;y1:b;;l3:y8:set-"
  "cdr!;y1:v;y1:b;;l2:y6:square;y1:b;;l3:y6:string;y1:v;y1:b;;l3:y12:stri"
  "ng->list;y1:v;y1:b;;l3:y14:string->number;y1:v;y1:b;;l3:y14:string->sy"
  "mbol;y1:v;y1:b;;l2:y12:string->utf8;y1:b;;l2:y14:string->vector;y1:b;;"
  "l3:y13:string-append;y1:v;y1:b;;l3:y11:string-copy;y1:v;y1:b;;l2:y12:s"
  "tring-copy!;y1:b;;l3:y12:string-fill!;y1:v;y1:b;;l2:y15:string-for-eac"
  "h;y1:b;;l3:y13:string-length;y1:v;y1:b;;l2:y10:string-map;y1:b;;l3:y10"
  ":string-ref;y1:v;y1:b;;l3:y11:string-set!;y1:v;y1:b;;l3:y9:string<=?;y"
  "1:v;y1:b;;l3:y8:string<?;y1:v;y1:b;;l3:y8:string=?;y1:v;y1:b;;l3:y9:st"
  "ring>=?;y1:v;y1:b;;l3:y8:string>?;y1:v;y1:b;;l3:y7:string?;y1:v;y1:b;;"
  "l3:y9:substring;y1:v;y1:b;;l3:y14:symbol->string;y1:v;y1:b;;l2:y8:symb"
  "ol=?;y1:b;;l3:y7:symbol?;y1:v;y1:b;;l2:y12:syntax-error;y1:b;;l4:y12:s"
  "yntax-rules;y1:v;y1:u;y1:b;;l2:y13:textual-port?;y1:b;;l3:y8:truncate;"
  "y1:v;y1:b;;l2:y17:truncate-quotient;y1:b;;l2:y18:truncate-remainder;y1"
  ":b;;l2:y9:truncate/;y1:b;;l2:y9:u8-ready?;y1:b;;l2:y6:unless;y1:b;;l4:"
  "y7:unquote;y1:v;y1:u;y1:b;;l4:y16:unquote-splicing;y1:v;y1:u;y1:b;;l2:"
  "y12:utf8->string;y1:b;;l3:y6:values;y1:v;y1:b;;l3:y6:vector;y1:v;y1:b;"
  ";l3:y12:vector->list;y1:v;y1:b;;l2:y14:vector->string;y1:b;;l2:y13:vec"
  "tor-append;y1:b;;l2:y11:vector-copy;y1:b;;l2:y12:vector-copy!;y1:b;;l3"
  ":y12:vector-fill!;y1:v;y1:b;;l2:y15:vector-for-each;y1:b;;l3:y13:vecto"
  "r-length;y1:v;y1:b;;l2:y10:vector-map;y1:b;;l3:y10:vector-ref;y1:v;y1:"
  "b;;l3:y11:vector-set!;y1:v;y1:b;;l3:y7:vector?;y1:v;y1:b;;l2:y4:when;y"
  "1:b;;l2:y22:with-exception-handler;y1:b;;l2:y16:write-bytevector;y1:b;"
  ";l3:y10:write-char;y1:v;y1:b;;l2:y12:write-string;y1:b;;l2:y8:write-u8"
  ";y1:b;;l3:y5:zero?;y1:v;y1:b;;l2:y11:case-lambda;y1:l;;l3:y16:char-alp"
  "habetic?;y1:v;y1:h;;l3:y10:char-ci<=?;y1:v;y1:h;;l3:y9:char-ci<?;y1:v;"
  "y1:h;;l3:y9:char-ci=?;y1:v;y1:h;;l3:y10:char-ci>=?;y1:v;y1:h;;l3:y9:ch"
  "ar-ci>?;y1:v;y1:h;;l3:y13:char-downcase;y1:v;y1:h;;l2:y13:char-foldcas"
  "e;y1:h;;l3:y16:char-lower-case?;y1:v;y1:h;;l3:y13:char-numeric?;y1:v;y"
  "1:h;;l3:y11:char-upcase;y1:v;y1:h;;l3:y16:char-upper-case?;y1:v;y1:h;;"
  "l3:y16:char-whitespace?;y1:v;y1:h;;l2:y11:digit-value;y1:h;;l3:y12:str"
  "ing-ci<=?;y1:v;y1:h;;l3:y11:string-ci<?;y1:v;y1:h;;l3:y11:string-ci=?;"
  "y1:v;y1:h;;l3:y12:string-ci>=?;y1:v;y1:h;;l3:y11:string-ci>?;y1:v;y1:h"
  ";;l2:y15:string-downcase;y1:h;;l2:y15:string-foldcase;y1:h;;l2:y13:str"
  "ing-upcase;y1:h;;l3:y5:angle;y1:v;y1:o;;l3:y9:imag-part;y1:v;y1:o;;l3:"
  "y9:magnitude;y1:v;y1:o;;l3:y10:make-polar;y1:v;y1:o;;l3:y16:make-recta"
  "ngular;y1:v;y1:o;;l3:y9:real-part;y1:v;y1:o;;l3:y5:caaar;y1:v;y1:a;;l3"
  ":y5:caadr;y1:v;y1:a;;l3:y5:cadar;y1:v;y1:a;;l3:y5:caddr;y1:v;y1:a;;l3:"
  "y5:cdaar;y1:v;y1:a;;l3:y5:cdadr;y1:v;y1:a;;l3:y5:cddar;y1:v;y1:a;;l3:y"
  "5:cdddr;y1:v;y1:a;;l3:y6:caaaar;y1:v;y1:a;;l3:y6:caaadr;y1:v;y1:a;;l3:"
  "y6:caadar;y1:v;y1:a;;l3:y6:caaddr;y1:v;y1:a;;l3:y6:cadaar;y1:v;y1:a;;l"
  "3:y6:cadadr;y1:v;y1:a;;l3:y6:caddar;y1:v;y1:a;;l3:y6:cadddr;y1:v;y1:a;"
  ";l3:y6:cdaaar;y1:v;y1:a;;l3:y6:cdaadr;y1:v;y1:a;;l3:y6:cdadar;y1:v;y1:"
  "a;;l3:y6:cdaddr;y1:v;y1:a;;l3:y6:cddaar;y1:v;y1:a;;l3:y6:cddadr;y1:v;y"
  "1:a;;l3:y6:cdddar;y1:v;y1:a;;l3:y6:cddddr;y1:v;y1:a;;l2:y11:environmen"
  "t;y1:e;;l3:y4:eval;y1:v;y1:e;;l3:y20:call-with-input-file;y1:v;y1:f;;l"
  "3:y21:call-with-output-file;y1:v;y1:f;;l2:y11:delete-file;y1:f;;l2:y12"
  ":file-exists?;y1:f;;l2:y22:open-binary-input-file;y1:f;;l2:y23:open-bi"
  "nary-output-file;y1:f;;l3:y15:open-input-file;y1:v;y1:f;;l3:y16:open-o"
  "utput-file;y1:v;y1:f;;l3:y20:with-input-from-file;y1:v;y1:f;;l3:y19:wi"
  "th-output-to-file;y1:v;y1:f;;l4:y4:acos;y1:v;y1:z;y1:i;;l4:y4:asin;y1:"
  "v;y1:z;y1:i;;l4:y4:atan;y1:v;y1:z;y1:i;;l4:y3:cos;y1:v;y1:z;y1:i;;l4:y"
  "3:exp;y1:v;y1:z;y1:i;;l3:y7:finite?;y1:z;y1:i;;l2:y9:infinite?;y1:i;;l"
  "3:y3:log;y1:v;y1:i;;l2:y4:nan?;y1:i;;l3:y3:sin;y1:v;y1:i;;l3:y4:sqrt;y"
  "1:v;y1:i;;l3:y3:tan;y1:v;y1:i;;l4:y5:delay;y1:v;y1:u;y1:z;;l2:y11:dela"
  "y-force;y1:z;;l3:y5:force;y1:v;y1:z;;l2:y12:make-promise;y1:z;;l2:y8:p"
  "romise?;y1:z;;l3:y4:load;y1:v;y1:d;;l2:y12:command-line;y1:s;;l2:y14:e"
  "mergency-exit;y1:s;;l2:y4:exit;y1:s;;l2:y24:get-environment-variable;y"
  "1:s;;l2:y25:get-environment-variables;y1:s;;l3:y7:display;y1:w;y1:v;;l"
  "2:y14:exact->inexact;y1:v;;l2:y14:inexact->exact;y1:v;;l3:y23:interact"
  "ion-environment;y1:p;y1:v;;l2:y16:null-environment;y1:v;;l3:y4:read;y1"
  ":r;y1:v;;l2:y25:scheme-report-environment;y1:v;;l3:y5:write;y1:w;y1:v;"
  ";l2:y13:current-jiffy;y1:t;;l2:y14:current-second;y1:t;;l2:y18:jiffies"
  "-per-second;y1:t;;l2:y12:write-shared;y1:w;;l2:y12:write-simple;y1:w;;"
  "l1:y14:define-library;;l1:y6:import;;l3:y4:box?;y1:x;i111;;l3:y3:box;y"
  "1:x;i111;;l3:y5:unbox;y1:x;i111;;l3:y8:set-box!;y1:x;i111;;l1:y6:forma"
  "t;;l1:y7:fprintf;;l1:y19:format-pretty-print;;l1:y18:format-fixed-prin"
  "t;;l1:y17:format-fresh-line;;l1:y18:format-help-string;;l1:y4:set&;;l1"
  ":y7:lambda*;;l1:y4:body;;l1:y5:letcc;;l1:y6:withcc;;l1:y13:syntax-lamb"
  "da;;l1:y13:syntax-length;;l1:y6:expand;;l1:y7:record?;;l1:y11:make-rec"
  "ord;;l1:y13:record-length;;l1:y10:record-ref;;l1:y11:record-set!;;l1:y"
  "22:record-type-descriptor;;l1:y7:fixnum?;;l1:y11:fxpositive?;;l1:y11:f"
  "xnegative?;;l1:y7:fxeven?;;l1:y6:fxodd?;;l1:y7:fxzero?;;l1:y3:fx+;;l1:"
  "y3:fx*;;l1:y3:fx-;;l1:y3:fx/;;l1:y10:fxquotient;;l1:y11:fxremainder;;l"
  "1:y8:fxmodquo;;l1:y8:fxmodulo;;l1:y8:fxeucquo;;l1:y8:fxeucrem;;l1:y5:f"
  "xneg;;l1:y5:fxabs;;l1:y4:fx<?;;l1:y5:fx<=?;;l1:y4:fx>?;;l1:y5:fx>=?;;l"
  "1:y4:fx=?;;l1:y5:fx!=?;;l1:y5:fxmin;;l1:y5:fxmax;;l1:y5:fxneg;;l1:y5:f"
  "xabs;;l1:y5:fxgcd;;l1:y6:fxexpt;;l1:y7:%25fxsqrt;;l1:y5:fxnot;;l1:y5:f"
  "xand;;l1:y5:fxior;;l1:y5:fxxor;;l1:y5:fxsll;;l1:y5:fxsra;;l1:y5:fxsrl;"
  ";l1:y5:fxeqv;;l1:y6:fxaddc;;l1:y6:fxsubc;;l1:y6:fxmulc;;l1:y6:fxfmar;;"
  ...
  ":flonum->fixnum;;l1:y14:flonum->string;;l1:y7:flldexp;;l1:y6:flmodf;;l"
  "1:y7:flfrexp;;l1:y6:flsinh;;l1:y6:flcosh;;l1:y6:fltanh;;l1:y7:fllog10;"
  ";l1:y14:string->flonum;;l1:y8:list-cat;;l1:y9:last-pair;;l1:y9:list-he"
  "ad;;l1:y4:meme;;l1:y4:asse;;l1:y4:memp;;l1:y4:assp;;l1:y8:reverse!;;l1"
  ":y9:circular?;;l1:y5:cons*;;l1:y5:list*;;l1:y8:char-cmp;;l1:y11:char-c"
  "i-cmp;;l1:y10:string-cat;;l1:y15:string-position;;l1:y10:string-cmp;;l"
  "1:y13:string-ci-cmp;;l1:y10:vector-cat;;l1:y12:bytevector=?;;l1:y16:by"
  "tevector->list;;l1:y16:list->bytevector;;l1:y13:subbytevector;;l1:y10:"
  "numvector?;;l1:y14:make-numvector;;l1:y16:numvector-length;;l1:y13:num"
  "vector-ref;;l1:y14:numvector-set!;;l1:y15:list->numvector;;l1:y19:stan"
  "dard-input-port;;l1:y20:standard-output-port;;l1:y19:standard-error-po"
  "rt;;l1:y9:tty-port?;;l1:y15:port-fold-case?;;l1:y19:set-port-fold-case"
  "!;;l1:y11:rename-file;;l1:y17:current-directory;;l1:y19:directory-sepa"
  "rator;;l1:y14:path-separator;;l1:y4:void;;l1:y5:void?;;l1:y19:implemen"
  "tation-name;;l1:y22:implementation-version;;l1:y13:version-alist;;l1:y"
  "16:current-language;;l1:y15:current-country;;l1:y22:current-locale-det"
  "ails;;l1:y3:id?;;l1:y10:string->id;;l1:y10:id->string;;py10:flcopysign"
  ";y8:c99-math;;py10:flsign-bit;y8:c99-math;;py10:fladjacent;y8:c99-math"
  ";;py13:flnormalized?;y8:c99-math;;py15:fldenormalized?;y8:c99-math;;py"
  "10:flexponent;y8:c99-math;;py7:flilogb;y8:c99-math;;py4:fl+*;y8:c99-ma"
  "th;;py9:flposdiff;y8:c99-math;;py6:flexp2;y8:c99-math;;py7:flexp-1;y8:"
  "c99-math;;py6:flcbrt;y8:c99-math;;py7:flhypot;y8:c99-math;;py7:fllog1+"
  ";y8:c99-math;;py6:fllog2;y8:c99-math;;py7:flasinh;y8:c99-math;;py7:fla"
  "cosh;y8:c99-math;;py7:flatanh;y8:c99-math;;py9:%25flremquo;y8:c99-math"
  ";;py7:flgamma;y8:c99-math;;py8:fllgamma;y8:c99-math;;py5:flerf;y8:c99-"
  "math;;py6:flerfc;y8:c99-math;;py14:flfirst-bessel;y8:xsi-math;;py15:fl"
  "second-bessel;y8:xsi-math;;py20:*user-name-registry*;y6:hidden;;py25:m"
  "ake-readonly-environment;y6:hidden;;py27:make-controlled-environment;y"
  "6:hidden;;py20:make-sld-environment;y6:hidden;;py21:make-repl-environm"
  "ent;y6:hidden;;py19:find-library-in-env;y6:hidden;;py16:root-environme"
  "nt;y6:hidden;;py16:repl-environment;y6:hidden;;py17:empty-environment;"
  "y6:hidden;;py32:make-historic-report-environment;y6:hidden;;py16:r5rs-"
  "environment;y6:hidden;;py21:r5rs-null-environment;y6:hidden;;py9:*verb"
  "ose*;y6:hidden;;py7:*quiet*;y6:hidden;;py25:compile-and-run-core-expr;"
  "y6:hidden;;py17:evaluate-top-form;y6:hidden;;py10:run-script;y6:hidden"
  ";;py11:run-program;y6:hidden;;py22:repl-evaluate-top-form;y6:hidden;;p"
  "y9:repl-read;y6:hidden;;py17:repl-exec-command;y6:hidden;;py14:repl-fr"
  "om-port;y6:hidden;;py13:run-benchmark;y6:hidden;;py4:repl;y6:hidden;;)"
  ...
  ":scheme;y11:case-lambda;)]2}'(y1:a),.1v?{'(l2:y6:scheme;y3:cxr;)]2}'(y"
  "1:b),.1v?{'(l2:y6:scheme;y4:base;)]2}'(y1:x),.1v?{'(l2:y6:scheme;y3:bo"
  "x;)]2}.1I0?{.1,'(y4:srfi),l2]2}.1,l1]2}.!0&0{%1${&0{%1n,'(l1:y5:begin;"
  "),V12]1},.3,@(y20:*root-name-registry*),@(y11:name-lookup)[03}z]1}.!1&"
  "0{%3'1,.1V4,.0,.3A3,.0?{.4,.1sd]5}.1,.5,.5cc,'1,.4V5]5}.!2&0{%1&0{%1.0"
  ",'(y5:const),l2]1},.1,@(y20:*root-name-registry*),@(y11:name-lookup)[1"
  "3}.!3.4d,.5a,,#0.0,.6,.5,.7,.(i10),&5{%2.1u?{${.2,:0^[01},.1,${'(l1:y5"
  ":skint;),:1^[01},:3^[23}'(y8:c99-math),.2q?{@(y10:*features*),'(y8:c99"
  "-math)A0~}{f},.0?{.0]3}'(y8:xsi-math),.3q?{@(y10:*features*),'(y8:xsi-"
  "math)A0~}{f},.0?{.0]4}.3p~?{${.4,:0^[01},.3,${n,.8c,'(y5:skint)c,:1^[0"
  "1},:3^[43}${${.6,:0^[01},.5,${${.(i11)a,:2^[01},:1^[01},:3^[03}.3d,.3,"
  ...
  "P", "procedure-minimum-arity",
  "%1.0U5?{.0U5U6,'(l2:c0;cu;),.1A1?{'0]2}'(l4:c1;cm;cx;cb;),.1A1?{'1]2}'"
  "(l2:c2;ct;),.1A1?{'2]2}'(c3),.1v?{'3]2}'(c4),.1v?{'4]2}'(c5),.1v?{'5]2"
  "}'(l3:cc;c#;c@;),.1A1?{'0]2}f]2}'0,${${@(y23:interaction-environment)["
  "00},.4,@(y4:eval)[02}Ug,.0V0?{'1,.1V3>?{'1,.1V4Nw}{f}}{f}?{'1,.1V4]2}f"
  "]2",
  ...
  "rsion*),'(s30:SKINT Scheme Interpreter v~a~%25),t,@(y6:format)[03}${'("
  "s42:usage: skint [OPTION]... [FILE] [ARG]...~%25),t,@(y6:format)[02}${"
  "'(s2:~%25),t,@(y6:format)[02}${'(s10:Options:~%25),t,@(y6:format)[02}$"
  "{Po,@(y15:*skint-options*),@(y26:print-command-line-options)[02}${'(s2"
  ":~%25),t,@(y6:format)[02}${'(s80:'--' ends options processing. Standal"
  "one FILE argument is treated as a script.~%25),t,@(y6:format)[02}${'(s"
  "82:If no FILE is given, skint enters Read-Eval-Print loop (stdin>eval-"
  "print>stdout)~%25),t,@(y6:format)[02}'(s2:~%25),t,@(y6:format)[02}.!3$"
  "{@(y12:command-line)[00}.!4${t,.7^d,,#0.8,.1,.7,.(i10),.(i10),&5{%2:0,"
  ":1,:2,:3,:4,.6,&6{%3.1?{.1,.1,l2}{.0,l1},${.2,'(l1:y7:verbose;),@(y11:"
  "sexp-match?)[02}?{t@!(y9:*verbose*)t,.4,:2^[42}${.2,'(l1:y5:quiet;),@("
  "y11:sexp-match?)[02}?{t@!(y7:*quiet*)t,.4,:2^[42}${.2,'(l2:y13:append-"
  "libdir;y1:*;),@(y11:sexp-match?)[02}?{${.4,@(y20:append-library-path!)"
  "[01}t,.4,:2^[42}${.2,'(l2:y14:prepend-libdir;y1:*;),@(y11:sexp-match?)"
  "[02}?{${.4,@(y21:prepend-library-path!)[01}t,.4,:2^[42}${.2,'(l2:y14:d"
  "efine-feature;y1:*;),@(y11:sexp-match?)[02}?{${.4,:5^[01}t,.4,:2^[42}$"
  "{.2,'(l2:y13:undef-feature;y1:*;),@(y11:sexp-match?)[02}?{${.4,:4^[01}"
  "t,.4,:2^[42}${.2,'(l2:y4:load;y1:*;),@(y11:sexp-match?)[02}?{${.4,@(y4"
  ":load)[01}t,.4,:2^[42}${.2,'(l2:y4:eval;y1:*;),@(y11:sexp-match?)[02}?"
  "{${t,.5,:3^[02}f,.4,:2^[42}${.2,'(l2:y6:script;y1:*;),@(y11:sexp-match"
  ...
  "2,'(l1:y7:version;),@(y11:sexp-match?)[02}?{${@(y14:print-version!)[00"
  "}f,n,:2^[42}${.2,'(l1:y4:help;),@(y11:sexp-match?)[02}?{${:1^[00}f,n,:"
  "2^[42}${.2,'(l1:f;),@(y11:sexp-match?)[02}?{.3p?{t@!(y7:*quiet*)${.5d,"
