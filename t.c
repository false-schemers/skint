...
char *t_code[] = {
  ...
  "iet;y3:off;),@(y11:sexp-match?)[02}?{f@!(y7:*quiet*)]5}${.3^,'(l2:y4:t"
  "ime;y1:*;),@(y11:sexp-match?)[02}?{Z3,${@(y16:repl-environment),.4^a,@"
  "(y18:repl-eval-top-form)[02}Z4,.1,Z3-/,'(i1000)*,'(s22:Elapsed time: ~"
  "s ms.~%25),t,@(y6:format)[63}${.3^,'(l1:y4:help;),@(y11:sexp-match?)[0"
  "2}?{.4,'(s20:Available commands:%0a)W4.4,'(s42: ,say hello     -- disp"
  "lays nice greeting%0a)W4.4,'(s40: ,peek <fname>  -- check if file exis"
  "ts%0a)W4.4,'(s50: ,q             -- disable informational messages%0a)"
  "W4.4,'(s50: ,quiet on      -- disable informational messages%0a)W4.4,'"
  "(s49: ,quiet off     -- enable informational messages%0a)W4.4,'(s37: ,"
  "v             -- turn verbosity on%0a)W4.4,'(s37: ,verbose on    -- tu"
  "rn verbosity on%0a)W4.4,'(s38: ,verbose off   -- turn verbosity off%0a"
  ")W4.4,'(s38: ,verbose off   -- turn verbosity off%0a)W4.4,'(s54: ,ref "
  "<name>    -- show current denotation for <name>%0a)W4.4,'(s43: ,rnr   "
  "        -- show root name registry%0a)W4.4,'(s48: ,rref <name>   -- lo"
  "okup name in root registry%0a)W4.4,'(s50: ,rrem! <name>  -- remove nam"
  "e from root registry%0a)W4.4,'(s43: ,unr           -- show user name r"
  "egistry%0a)W4.4,'(s48: ,uref <name>   -- lookup name in user registry%"
  "0a)W4.4,'(s50: ,urem! <name>  -- remove name from user registry%0a)W4."
