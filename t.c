...
char *t_code[] = {
  ...
  "2,'(l1:y2:si;),@(y11:sexp-match?)[02}?{Zh,Zg,'(s36:~d collections, hea"
  "p size ~d words~%25),t,@(y6:format)[14}${.2,'(l1:y4:help;),@(y11:sexp-"
  "match?)[02}?{:2,'(s21:%0aAvailable commands:%0a)W4:2,'(s52: ,load <fna"
  "me>  -- loads <fname> (no quotes needed)%0a)W4:2,'(s50: ,q            "
  " -- disable informational messages%0a)W4:2,'(s50: ,quiet on      -- di"
  "sable informational messages%0a)W4:2,'(s49: ,quiet off     -- enable i"
  "nformational messages%0a)W4:2,'(s37: ,v             -- turn verbosity "
  "on%0a)W4:2,'(s37: ,verbose on    -- turn verbosity on%0a)W4:2,'(s38: ,"
  "verbose off   -- turn verbosity off%0a)W4:2,'(s58: ,ref <name>    -- s"
  "how denotation for <name> (may alloc)%0a)W4:2,'(s43: ,rnr           --"
  " show root name registry%0a)W4:2,'(s48: ,rref <name>   -- lookup name "
  "in root registry%0a)W4:2,'(s50: ,rrem! <name>  -- remove name from roo"
  "t registry%0a)W4:2,'(s43: ,unr           -- show user name registry%0a"
  ")W4:2,'(s48: ,uref <name>   -- lookup name in user registry%0a)W4:2,'("
  "s50: ,urem! <name>  -- remove name from user registry%0a)W4:2,'(s44: ,"
  "gs            -- show global store (big!)%0a)W4:2,'(s53: ,gs <name>   "
  "  -- lookup global location for <name>%0a)W4:2,'(s48: ,time <expr>   -"
  "- time short expression <expr>%0a)W4:2,'(s49: ,sh <cmdline>  -- send <"
  "cmdline> to local shell%0a)W4:2,'(s39: ,si            -- display syste"
  "m info%0a)W4:2,'(s29: ,help          -- this help%0a)W4]1}${.2,'(l1:y1"
  ":h;),@(y11:sexp-match?)[02}?{'(l1:y4:help;),:1^[11}:2,'(s29:syntax err"
  "or in repl command%0a)W4:2,'(s37:type ,help to see available commands%"
  "0a)W4]1}.!0.0^_1[41",
