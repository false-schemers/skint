...
char *t_code[] = {
  ...
  ";)]2}'(y1:x),.1v?{'(l2:y6:scheme;y3:box;)]2}.1I0?{.1,'(y4:srfi),l2]2}."
  "1,l1]2}.!0&0{%1${&0{%1n,'(l1:y5:begin;),V12]1},.3,@(y20:*root-name-reg"
  "istry*),@(y11:name-lookup)[03}z]1}.!1&0{%3'1,.1V4,.0,.3A3,.0?{.4,.1sd]"
  "5}.1,.5,.5cc,'1,.4V5]5}.!2&0{%1&0{%1.0,'(y5:const),l2]1},.1,@(y20:*roo"
  "t-name-registry*),@(y11:name-lookup)[13}.!3.4d,.5a,,#0.0,.6,.5,.7,.(i1"
  "0),&5{%2.1u?{${.2,:0^[01},.1,${'(l1:y5:skint;),:1^[01},:3^[23}'(y8:c99"
  "-math),.2q?{@(y10:*features*),'(y8:c99-math)A0~}{f},.0?{.0]3}'(y8:xsi-"
  "math),.3q?{@(y10:*features*),'(y8:xsi-math)A0~}{f},.0?{.0]4}.3p~?{${.4"
  ",:0^[01},.3,${n,.8c,'(y5:skint)c,:1^[01},:3^[43}${${.6,:0^[01},.5,${${"
  ".(i11)a,:2^[01},:1^[01},:3^[03}.3d,.3,:4^[42}.!0.0^_1[52},@(y10:%25for"
  "-each1)[02}",
