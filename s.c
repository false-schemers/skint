...
char *s_code[] = {
  ...
  "fxzero?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y7:%25izerop;l2:y4:%25cki;y1"
  ":x;;;;l2:py1:_;y12:syntax-rules;;py17:%25residual-fxzero?;y12:syntax-r"
  "ules;;;l2:y1:_;y17:%25residual-fxzero?;;",

  0,
  "&0{%1.0%iI=0]1}@!(y17:%25residual-fxzero?)",

  "fxpositive?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25iposp;l2:y4:%25cki;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py21:%25residual-fxpositive?;y12:synta"
  "x-rules;;;l2:y1:_;y21:%25residual-fxpositive?;;",

  0,
  "&0{%1.0%iI>0]1}@!(y21:%25residual-fxpositive?)",

  "fxnegative?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25inegp;l2:y4:%25cki;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py21:%25residual-fxnegative?;y12:synta"
  "x-rules;;;l2:y1:_;y21:%25residual-fxnegative?;;",

  0,
  "&0{%1.0%iI<0]1}@!(y21:%25residual-fxnegative?)",

  "fx+",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25iadd;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py13:%25residua"
  "l-fx+;y12:syntax-rules;;;l2:y1:_;y13:%25residual-fx+;;",

  0,
  "&0{%2.1%i,.1%iI+]2}@!(y13:%25residual-fx+)",

  "fx*",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25imul;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py13:%25residua"
  "l-fx*;y12:syntax-rules;;;l2:y1:_;y13:%25residual-fx*;;",
  ...
  "fx-",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25isub;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py13:%25residua"
  "l-fx-;y12:syntax-rules;;;l2:y1:_;y13:%25residual-fx-;;",
  ...
  "fx/",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25idiv;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py13:%25residua"
  "l-fx/;y12:syntax-rules;;;l2:y1:_;y13:%25residual-fx/;;",
  ...
  "fxquotient",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25iquo;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py20:%25residua"
  "l-fxquotient;y12:syntax-rules;;;l2:y1:_;y20:%25residual-fxquotient;;",

  0,
  "&0{%2.1%i,.1%iIq]2}@!(y20:%25residual-fxquotient)",

  "fxremainder",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25irem;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py21:%25residua"
  "l-fxremainder;y12:syntax-rules;;;l2:y1:_;y21:%25residual-fxremainder;;",

  0,
  "&0{%2.1%i,.1%iIr]2}@!(y21:%25residual-fxremainder)",

  "fxmodquo",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25imqu;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-fxmodquo;y12:syntax-rules;;;l2:y1:_;y18:%25residual-fxmodquo;;",

  0,
  "&0{%2.1%i,.1%iI3]2}@!(y18:%25residual-fxmodquo)",

  "fxmodulo",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25imlo;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-fxmodulo;y12:syntax-rules;;;l2:y1:_;y18:%25residual-fxmodulo;;",

  0,
  "&0{%2.1%i,.1%iI4]2}@!(y18:%25residual-fxmodulo)",

  "fxeucquo",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25ieuq;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-fxeucquo;y12:syntax-rules;;;l2:y1:_;y18:%25residual-fxeucquo;;",

  0,
  "&0{%2.1%i,.1%iI5]2}@!(y18:%25residual-fxeucquo)",

  "fxeucrem",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25ieur;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-fxeucrem;y12:syntax-rules;;;l2:y1:_;y18:%25residual-fxeucrem;;",

  0,
  "&0{%2.1%i,.1%iI6]2}@!(y18:%25residual-fxeucrem)",

  "fxneg",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25ineg;l2:y4:%25cki;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py15:%25residual-fxneg;y12:syntax-rules"
  ...
  "fxabs",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25iabs;l2:y4:%25cki;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py15:%25residual-fxabs;y12:syntax-rules"
  ...
  "fx<?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25ilt;l2:y4:%25cki;"
  "y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py14:%25residual"
  "-fx<?;y12:syntax-rules;;;l2:y1:_;y14:%25residual-fx<?;;",

  0,
  "&0{%2.1%i,.1%iI<]2}@!(y14:%25residual-fx<?)",

  "fx<=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25ile;l2:y4:%25cki;"
  "y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py15:%25residual"
  "-fx<=?;y12:syntax-rules;;;l2:y1:_;y15:%25residual-fx<=?;;",

  0,
  "&0{%2.1%i,.1%iI>!]2}@!(y15:%25residual-fx<=?)",

  "fx>?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25igt;l2:y4:%25cki;"
  "y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py14:%25residual"
  "-fx>?;y12:syntax-rules;;;l2:y1:_;y14:%25residual-fx>?;;",
  ...
  "fx>=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25ige;l2:y4:%25cki;"
  "y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py15:%25residual"
  "-fx>=?;y12:syntax-rules;;;l2:y1:_;y15:%25residual-fx>=?;;",
  ...
  "fx=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25ieq;l2:y4:%25cki;"
  "y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py14:%25residual"
  "-fx=?;y12:syntax-rules;;;l2:y1:_;y14:%25residual-fx=?;;",
  ...
  "fxmin",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25imin;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py15:%25residua"
  "l-fxmin;y12:syntax-rules;;;l2:y1:_;y15:%25residual-fxmin;;",

  0,
  "&0{%2.1%i,.1%iIn]2}@!(y15:%25residual-fxmin)",

  "fxmax",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25imax;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:y;;;;l2:py1:_;y12:syntax-rules;;py15:%25residua"
  "l-fxmax;y12:syntax-rules;;;l2:y1:_;y15:%25residual-fxmax;;",

  0,
  "&0{%2.1%i,.1%iIx]2}@!(y15:%25residual-fxmax)",

  "fixnum->flonum",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25itoj;l2:y4:%25cki;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py24:%25residual-fixnum->flonum;y12:syn"
  "tax-rules;;;l2:y1:_;y24:%25residual-fixnum->flonum;;",
  ...
  "flzero?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y7:%25jzerop;l2:y4:%25ckj;y1"
  ":x;;;;l2:py1:_;y12:syntax-rules;;py17:%25residual-flzero?;y12:syntax-r"
  "ules;;;l2:y1:_;y17:%25residual-flzero?;;",

  0,
  "&0{%1.0%jJ=0]1}@!(y17:%25residual-flzero?)",

  "flpositive?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25jposp;l2:y4:%25ckj;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py21:%25residual-flpositive?;y12:synta"
  "x-rules;;;l2:y1:_;y21:%25residual-flpositive?;;",

  0,
  "&0{%1.0%jJ>0]1}@!(y21:%25residual-flpositive?)",

  "flnegative?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25jnegp;l2:y4:%25ckj;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py21:%25residual-flnegative?;y12:synta"
  "x-rules;;;l2:y1:_;y21:%25residual-flnegative?;;",

  0,
  "&0{%1.0%jJ<0]1}@!(y21:%25residual-flnegative?)",

  "flinteger?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25jintp;l2:y4:%25ckj;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py20:%25residual-flinteger?;y12:syntax"
  "-rules;;;l2:y1:_;y20:%25residual-flinteger?;;",

  0,
  "&0{%1.0%jJw]1}@!(y20:%25residual-flinteger?)",

  "flnan?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25jnanp;l2:y4:%25ckj;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py16:%25residual-flnan?;y12:syntax-rul"
  "es;;;l2:y1:_;y16:%25residual-flnan?;;",

  0,
  "&0{%1.0%jJu]1}@!(y16:%25residual-flnan?)",

  "flinfinite?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25jinfp;l2:y4:%25ckj;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py21:%25residual-flinfinite?;y12:synta"
  "x-rules;;;l2:y1:_;y21:%25residual-flinfinite?;;",

  0,
  "&0{%1.0%jJh]1}@!(y21:%25residual-flinfinite?)",

  "flfinite?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25jfinp;l2:y4:%25ckj;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py19:%25residual-flfinite?;y12:syntax-"
  "rules;;;l2:y1:_;y19:%25residual-flfinite?;;",

  0,
  "&0{%1.0%jJf]1}@!(y19:%25residual-flfinite?)",

  "fleven?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25jevnp;l2:y4:%25ckj;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py17:%25residual-fleven?;y12:syntax-ru"
  "les;;;l2:y1:_;y17:%25residual-fleven?;;",

  0,
  "&0{%1.0%jJe]1}@!(y17:%25residual-fleven?)",

  "flodd?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25joddp;l2:y4:%25ckj;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py16:%25residual-flodd?;y12:syntax-rul"
  "es;;;l2:y1:_;y16:%25residual-flodd?;;",

  0,
  "&0{%1.0%jJo]1}@!(y16:%25residual-flodd?)",

  "fl+",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25jadd;l2:y4:%25ckj"
  ";y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py13:%25residua"
  "l-fl+;y12:syntax-rules;;;l2:y1:_;y13:%25residual-fl+;;",

  0,
  "&0{%2.1%j,.1%jJ+]2}@!(y13:%25residual-fl+)",

  "fl-",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25jsub;l2:y4:%25ckj"
  ";y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py13:%25residua"
  "l-fl-;y12:syntax-rules;;;l2:y1:_;y13:%25residual-fl-;;",
  ...
  "fl*",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25jmul;l2:y4:%25ckj"
  ";y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py13:%25residua"
  "l-fl*;y12:syntax-rules;;;l2:y1:_;y13:%25residual-fl*;;",
  ...
  "fl/",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25jdiv;l2:y4:%25ckj"
  ";y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py13:%25residua"
  "l-fl/;y12:syntax-rules;;;l2:y1:_;y13:%25residual-fl/;;",
  ...
  "flneg",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25jneg;l2:y4:%25ckj;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py15:%25residual-flneg;y12:syntax-rules"
  ...
  "flabs",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25jabs;l2:y4:%25ckj;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py15:%25residual-flabs;y12:syntax-rules"
  ...
  "fl<?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25jlt;l2:y4:%25ckj;"
  "y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py14:%25residual"
  "-fl<?;y12:syntax-rules;;;l2:y1:_;y14:%25residual-fl<?;;",

  0,
  "&0{%2.1%j,.1%jJ<]2}@!(y14:%25residual-fl<?)",

  "fl<=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25jle;l2:y4:%25ckj;"
  "y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py15:%25residual"
  "-fl<=?;y12:syntax-rules;;;l2:y1:_;y15:%25residual-fl<=?;;",

  0,
  "&0{%2.1%j,.1%jJ>!]2}@!(y15:%25residual-fl<=?)",

  "fl>?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25jgt;l2:y4:%25ckj;"
  "y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py14:%25residual"
  "-fl>?;y12:syntax-rules;;;l2:y1:_;y14:%25residual-fl>?;;",
  ...
  "fl>=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25jge;l2:y4:%25ckj;"
  "y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py15:%25residual"
  "-fl>=?;y12:syntax-rules;;;l2:y1:_;y15:%25residual-fl>=?;;",
  ...
  "fl=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25jeq;l2:y4:%25ckj;"
  "y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py14:%25residual"
  "-fl=?;y12:syntax-rules;;;l2:y1:_;y14:%25residual-fl=?;;",
  ...
  "flmin",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25jmin;l2:y4:%25ckj"
  ";y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py15:%25residua"
  "l-flmin;y12:syntax-rules;;;l2:y1:_;y15:%25residual-flmin;;",

  0,
  "&0{%2.1%j,.1%jJn]2}@!(y15:%25residual-flmin)",

  "flmax",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25jmax;l2:y4:%25ckj"
  ";y1:x;;l2:y4:%25ckj;y1:y;;;;l2:py1:_;y12:syntax-rules;;py15:%25residua"
  "l-flmax;y12:syntax-rules;;;l2:y1:_;y15:%25residual-flmax;;",

  0,
  "&0{%2.1%j,.1%jJx]2}@!(y15:%25residual-flmax)",

  "flonum->fixnum",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25jtoi;l2:y4:%25ckj;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py24:%25residual-flonum->fixnum;y12:syn"
  "tax-rules;;;l2:y1:_;y24:%25residual-flonum->fixnum;;",
  ...
  "finite?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25finp;l2:y4:%25ckn;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py17:%25residual-finite?;y12:syntax-rul"
  "es;;;l2:y1:_;y17:%25residual-finite?;;",

  0,
  "&0{%1.0%nN6]1}@!(y17:%25residual-finite?)",

  "infinite?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25infp;l2:y4:%25ckn;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py19:%25residual-infinite?;y12:syntax-r"
  "ules;;;l2:y1:_;y19:%25residual-infinite?;;",

  0,
  "&0{%1.0%nN7]1}@!(y19:%25residual-infinite?)",

  "nan?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25nanp;l2:y4:%25ckn;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py14:%25residual-nan?;y12:syntax-rules;"
  ...
  "zero?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25zerop;l2:y4:%25ckn;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py15:%25residual-zero?;y12:syntax-rule"
  "s;;;l2:y1:_;y15:%25residual-zero?;;",

  0,
  "&0{%1.0%n=0]1}@!(y15:%25residual-zero?)",

  "positive?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25posp;l2:y4:%25ckn;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py19:%25residual-positive?;y12:syntax-r"
  "ules;;;l2:y1:_;y19:%25residual-positive?;;",

  0,
  "&0{%1.0%n>0]1}@!(y19:%25residual-positive?)",

  "negative?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25negp;l2:y4:%25ckn;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py19:%25residual-negative?;y12:syntax-r"
  "ules;;;l2:y1:_;y19:%25residual-negative?;;",

  0,
  "&0{%1.0%n<0]1}@!(y19:%25residual-negative?)",

  "even?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25evnp;l2:y4:%25ckn;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py15:%25residual-even?;y12:syntax-rules"
  ...
  "odd?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25oddp;l2:y4:%25ckn;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py14:%25residual-odd?;y12:syntax-rules;"
  ...
  ";;;l2:py1:_;y12:syntax-rules;;py13:%25residual-abs;y12:syntax-rules;;;"
  ...
  "quotient",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l2:y4:%25quo;l2:y4:%25ckn;"
  "y1:x;;;;l2:py1:_;y12:syntax-rules;;py18:%25residual-quotient;y12:synta"
  "x-rules;;;l2:y1:_;y18:%25residual-quotient;;",

  0,
  "&0{%2.0%nG5]2}@!(y18:%25residual-quotient)",

  "remainder",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l2:y4:%25rem;l2:y4:%25ckn;"
  "y1:x;;;;l2:py1:_;y12:syntax-rules;;py19:%25residual-remainder;y12:synt"
  "ax-rules;;;l2:y1:_;y19:%25residual-remainder;;",
  ...
  "modquo",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l2:y4:%25mqu;l2:y4:%25ckn;"
  "y1:x;;;;l2:py1:_;y12:syntax-rules;;py16:%25residual-modquo;y12:syntax-"
  "rules;;;l2:y1:_;y16:%25residual-modquo;;",

  0,
  "&0{%2.0%nG3]2}@!(y16:%25residual-modquo)",

  "modulo",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l2:y4:%25mlo;l2:y4:%25ckn;"
  "y1:x;;;;l2:py1:_;y12:syntax-rules;;py16:%25residual-modulo;y12:syntax-"
  "rules;;;l2:y1:_;y16:%25residual-modulo;;",
  ...
  "char-cmp",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25ccmp;l2:y4:%25ckc"
  ";y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-char-cmp;y12:syntax-rules;;;l2:y1:_;y18:%25residual-char-cmp;;",

  0,
  "&0{%2.1%c,.1%cO0]2}@!(y18:%25residual-char-cmp)",

  "char=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25ceq;l2:y4:%25ckc;"
  "y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py16:%25residual"
  "-char=?;y12:syntax-rules;;;l2:y1:_;y16:%25residual-char=?;;",

  0,
  "&0{%2.1%c,.1%cC=]2}@!(y16:%25residual-char=?)",

  "char<?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25clt;l2:y4:%25ckc;"
  "y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py16:%25residual"
  "-char<?;y12:syntax-rules;;;l2:y1:_;y16:%25residual-char<?;;",
  ...
  "char<=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25cle;l2:y4:%25ckc;"
  "y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py17:%25residual"
  "-char<=?;y12:syntax-rules;;;l2:y1:_;y17:%25residual-char<=?;;",

  0,
  "&0{%2.1%c,.1%cC>!]2}@!(y17:%25residual-char<=?)",

  "char>?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25cgt;l2:y4:%25ckc;"
  "y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py16:%25residual"
  "-char>?;y12:syntax-rules;;;l2:y1:_;y16:%25residual-char>?;;",
  ...
  "char>=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25cge;l2:y4:%25ckc;"
  "y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py17:%25residual"
  "-char>=?;y12:syntax-rules;;;l2:y1:_;y17:%25residual-char>=?;;",
  ...
  "char-ci-cmp",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y6:%25cicmp;l2:y4:%25ck"
  "c;y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residu"
  "al-char-cmp;y12:syntax-rules;;;l2:y1:_;y18:%25residual-char-cmp;;",

  0,
  "&0{%2.1%c,.1%cO1]2}@!(y18:%25residual-char-cmp)",

  "char-ci=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25cieq;l2:y4:%25ckc"
  ";y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py19:%25residua"
  "l-char-ci=?;y12:syntax-rules;;;l2:y1:_;y19:%25residual-char-ci=?;;",

  0,
  "&0{%2.1%c,.1%cCi=]2}@!(y19:%25residual-char-ci=?)",

  "char-ci<?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25cilt;l2:y4:%25ckc"
  ";y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py19:%25residua"
  "l-char-ci<?;y12:syntax-rules;;;l2:y1:_;y19:%25residual-char-ci<?;;",
  ...
  "char-ci<=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25cile;l2:y4:%25ckc"
  ";y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py20:%25residua"
  "l-char-ci<=?;y12:syntax-rules;;;l2:y1:_;y20:%25residual-char-ci<=?;;",

  0,
  "&0{%2.1%c,.1%cCi>!]2}@!(y20:%25residual-char-ci<=?)",

  "char-ci>?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25cigt;l2:y4:%25ckc"
  ";y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py19:%25residua"
  "l-char-ci>?;y12:syntax-rules;;;l2:y1:_;y19:%25residual-char-ci>?;;",
  ...
  "char-ci>=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25cige;l2:y4:%25ckc"
  ";y1:x;;l2:y4:%25ckc;y1:y;;;;l2:py1:_;y12:syntax-rules;;py20:%25residua"
  "l-char-ci>=?;y12:syntax-rules;;;l2:y1:_;y20:%25residual-char-ci>=?;;",
  ...
  "char-alphabetic?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25calp;l2:y4:%25ckc;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py26:%25residual-char-alphabetic?;y12:s"
  "yntax-rules;;;l2:y1:_;y26:%25residual-char-alphabetic?;;",

  0,
  "&0{%1.0%cC4]1}@!(y26:%25residual-char-alphabetic?)",

  "char-numeric?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25cnup;l2:y4:%25ckc;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py23:%25residual-char-numeric?;y12:synt"
  "ax-rules;;;l2:y1:_;y23:%25residual-char-numeric?;;",

  0,
  "&0{%1.0%cC5]1}@!(y23:%25residual-char-numeric?)",

  "char-whitespace?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25cwsp;l2:y4:%25ckc;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py26:%25residual-char-whitespace?;y12:s"
  "yntax-rules;;;l2:y1:_;y26:%25residual-char-whitespace?;;",

  0,
  "&0{%1.0%cC1]1}@!(y26:%25residual-char-whitespace?)",

  "char-upper-case?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25cucp;l2:y4:%25ckc;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py26:%25residual-char-upper-case?;y12:s"
  "yntax-rules;;;l2:y1:_;y26:%25residual-char-upper-case?;;",

  0,
  "&0{%1.0%cC3]1}@!(y26:%25residual-char-upper-case?)",

  "char-lower-case?",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25clcp;l2:y4:%25ckc;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py26:%25residual-char-lower-case?;y12:s"
  "yntax-rules;;;l2:y1:_;y26:%25residual-char-lower-case?;;",

  0,
  "&0{%1.0%cC2]1}@!(y26:%25residual-char-lower-case?)",

  "char-upcase",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25cupc;l2:y4:%25ckc;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py21:%25residual-char-upcase;y12:syntax"
  "-rules;;;l2:y1:_;y21:%25residual-char-upcase;;",

  0,
  "&0{%1.0%cC6]1}@!(y21:%25residual-char-upcase)",

  "char-downcase",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25cdnc;l2:y4:%25ckc;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py23:%25residual-char-downcase;y12:synt"
  "ax-rules;;;l2:y1:_;y23:%25residual-char-downcase;;",

  0,
  "&0{%1.0%cC7]1}@!(y23:%25residual-char-downcase)",

  "char->integer",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25ctoi;l2:y4:%25ckc;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py23:%25residual-char->integer;y12:synt"
  "ax-rules;;;l2:y1:_;y23:%25residual-char->integer;;",

  0,
  "&0{%1.0%cX8]1}@!(y23:%25residual-char->integer)",

  "integer->char",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25itoc;l2:y4:%25cki;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py23:%25residual-integer->char;y12:synt"
  "ax-rules;;;l2:y1:_;y23:%25residual-integer->char;;",
  ...
  "symbol->string",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25ytos;l2:y4:%25cky;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py24:%25residual-symbol->string;y12:syn"
  "tax-rules;;;l2:y1:_;y24:%25residual-symbol->string;;",

  0,
  "&0{%1.0%yX4]1}@!(y24:%25residual-symbol->string)",

  "string->symbol",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25stoy;l2:y4:%25cks;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py24:%25residual-string->symbol;y12:syn"
  "tax-rules;;;l2:y1:_;y24:%25residual-string->symbol;;",
  ...
  "car",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y4:%25car;l2:y4:%25ckp;y1:x;"
  ";;;l2:py1:_;y12:syntax-rules;;py13:%25residual-car;y12:syntax-rules;;;"
  ...
  "set-car!",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:v;;l3:y7:%25setcar;l2:y4:%25c"
  "kp;y1:x;;y1:v;;;l2:py1:_;y12:syntax-rules;;py18:%25residual-set-car!;y"
  "12:syntax-rules;;;l2:y1:_;y18:%25residual-set-car!;;",

  0,
  "&0{%2.1,.1%pa!]2}@!(y18:%25residual-set-car!)",

  "cdr",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y4:%25cdr;l2:y4:%25ckp;y1:x;"
  ";;;l2:py1:_;y12:syntax-rules;;py13:%25residual-cdr;y12:syntax-rules;;;"
  ...
  "set-cdr!",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:v;;l3:y7:%25setcdr;l2:y4:%25c"
  "kp;y1:x;;y1:v;;;l2:py1:_;y12:syntax-rules;;py18:%25residual-set-cdr!;y"
  "12:syntax-rules;;;l2:y1:_;y18:%25residual-set-cdr!;;",
  ...
  "length",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25llen;l2:y4:%25ckl;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py16:%25residual-length;y12:syntax-rule"
  "s;;;l2:y1:_;y16:%25residual-length;;",

  0,
  "&0{%1.0%lg]1}@!(y16:%25residual-length)",

  "list-ref",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:i;;l3:y5:%25lget;l2:y4:%25ckl"
  ";y1:x;;l2:y4:%25cki;y1:i;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-list-ref;y12:syntax-rules;;;l2:y1:_;y18:%25residual-list-ref;;",

  0,
  "&0{%2.1%i,.1%lL4]2}@!(y18:%25residual-list-ref)",

  "list-set!",
  "l5:y12:syntax-rules;n;l2:l4:y1:_;y1:x;y1:i;y1:v;;l4:y5:%25lput;l2:y4:%"
  "25ckl;y1:x;;l2:y4:%25cki;y1:i;;y1:v;;;l2:py1:_;y12:syntax-rules;;py19:"
  "%25residual-list-set!;y12:syntax-rules;;;l2:y1:_;y19:%25residual-list-"
  "set!;;",
  ...
  "memq",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:v;y1:y;;l3:y5:%25memq;y1:v;l2:y4:%"
  "25ckl;y1:y;;;;l2:py1:_;y12:syntax-rules;;py14:%25residual-memq;y12:syn"
  "tax-rules;;;l2:y1:_;y14:%25residual-memq;;",
  ...
  "25ckl;y1:y;;;;l2:py1:_;y12:syntax-rules;;py14:%25residual-assq;y12:syn"
  "tax-rules;;;l2:y1:_;y14:%25residual-assq;;",
  ...
  ";;l2:y5:quote;n;;;;l2:py1:_;y12:syntax-rules;;py19:%25residual-list-co"
  "py;y12:syntax-rules;;;l2:y1:_;y19:%25residual-list-copy;;",

  0,
  "&0{%1n,.1%lL6]1}@!(y19:%25residual-list-copy)",

  "list-tail",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:i;;l3:y6:%25ltail;l2:y4:%25ck"
  "l;y1:x;;l2:y4:%25cki;y1:i;;;;l2:py1:_;y12:syntax-rules;;py19:%25residu"
  "al-list-tail;y12:syntax-rules;;;l2:y1:_;y19:%25residual-list-tail;;",

  0,
  "&0{%2.1%i,.1%lA6]2}@!(y19:%25residual-list-tail)",

  "last-pair",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25lpair;l2:y4:%25ckp;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py19:%25residual-last-pair;y12:syntax-"
  "rules;;;l2:y1:_;y19:%25residual-last-pair;;",

  0,
  "&0{%1.0%pA7]1}@!(y19:%25residual-last-pair)",

  "reverse",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25lrev;l2:y4:%25ckl;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py17:%25residual-reverse;y12:syntax-rul"
  "es;;;l2:y1:_;y17:%25residual-reverse;;",

  0,
  "&0{%1.0%lA8]1}@!(y17:%25residual-reverse)",

  "reverse!",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y6:%25lrevi;l2:y4:%25ckl;y1:"
  "x;;;;l2:py1:_;y12:syntax-rules;;py18:%25residual-reverse!;y12:syntax-r"
  "ules;;;l2:y1:_;y18:%25residual-reverse!;;",
  ...
  ";;;;l2:py1:_;y12:syntax-rules;;py23:%25residual-vector-length;y12:synt"
  "ax-rules;;;l2:y1:_;y23:%25residual-vector-length;;",

  0,
  "&0{%1.0%vV3]1}@!(y23:%25residual-vector-length)",

  "vector-ref",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:i;;l3:y5:%25vget;l2:y4:%25ckv"
  ";y1:x;;l2:y4:%25cki;y1:i;;;;l2:py1:_;y12:syntax-rules;;py20:%25residua"
  "l-vector-ref;y12:syntax-rules;;;l2:y1:_;y20:%25residual-vector-ref;;",

  0,
  "&0{%2.1%i,.1%vV4]2}@!(y20:%25residual-vector-ref)",

  "vector-set!",
  "l5:y12:syntax-rules;n;l2:l4:y1:_;y1:x;y1:i;y1:v;;l4:y5:%25vput;l2:y4:%"
  "25ckv;y1:x;;l2:y4:%25cki;y1:i;;y1:v;;;l2:py1:_;y12:syntax-rules;;py21:"
  "%25residual-vector-set!;y12:syntax-rules;;;l2:y1:_;y21:%25residual-vec"
  "tor-set!;;",
  ...
  "vector->list",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25vtol;l2:y4:%25ckv;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py22:%25residual-vector->list;y12:synta"
  "x-rules;;;l2:y1:_;y22:%25residual-vector->list;;",

  0,
  "&0{%1.0%vX0]1}@!(y22:%25residual-vector->list)",

  "list->vector",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25ltov;l2:y4:%25ckl;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py22:%25residual-list->vector;y12:synta"
  "x-rules;;;l2:y1:_;y22:%25residual-list->vector;;",
  ...
  ";;;;l2:py1:_;y12:syntax-rules;;py23:%25residual-string-length;y12:synt"
  "ax-rules;;;l2:y1:_;y23:%25residual-string-length;;",

  0,
  "&0{%1.0%sS3]1}@!(y23:%25residual-string-length)",

  "string-ref",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:i;;l3:y5:%25sget;l2:y4:%25cks"
  ";y1:x;;l2:y4:%25cki;y1:i;;;;l2:py1:_;y12:syntax-rules;;py20:%25residua"
  "l-string-ref;y12:syntax-rules;;;l2:y1:_;y20:%25residual-string-ref;;",

  0,
  "&0{%2.1%i,.1%sS4]2}@!(y20:%25residual-string-ref)",

  "string-set!",
  "l5:y12:syntax-rules;n;l2:l4:y1:_;y1:x;y1:i;y1:v;;l4:y5:%25sput;l2:y4:%"
  "25cks;y1:x;;l2:y4:%25cki;y1:i;;l2:y4:%25ckc;y1:v;;;;l2:py1:_;y12:synta"
  "x-rules;;py21:%25residual-string-set!;y12:syntax-rules;;;l2:y1:_;y21:%"
  ...
  "substring",
  "l5:y12:syntax-rules;n;l2:l4:y1:_;y1:x;y1:s;y1:e;;l4:y5:%25ssub;l2:y4:%"
  "25cks;y1:x;;l2:y4:%25cki;y1:s;;l2:y4:%25cki;y1:e;;;;l2:py1:_;y12:synta"
  "x-rules;;py19:%25residual-substring;y12:syntax-rules;;;l2:y1:_;y19:%25"
  "residual-substring;;",
  ...
  "string-cmp",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25scmp;l2:y4:%25cks"
  ";y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py20:%25residua"
  "l-string-cmp;y12:syntax-rules;;;l2:y1:_;y20:%25residual-string-cmp;;",

  0,
  "&0{%2.1%s,.1%sO2]2}@!(y20:%25residual-string-cmp)",

  "string=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25seq;l2:y4:%25cks;"
  "y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residual"
  "-string<?;y12:syntax-rules;;;l2:y1:_;y18:%25residual-string<?;;",

  0,
  "&0{%2.1%s,.1%sS=]2}@!(y18:%25residual-string<?)",

  "string<?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25slt;l2:y4:%25cks;"
  "y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residual"
  "-string<?;y12:syntax-rules;;;l2:y1:_;y18:%25residual-string<?;;",
  ...
  "string<=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25sle;l2:y4:%25cks;"
  "y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py19:%25residual"
  "-string<=?;y12:syntax-rules;;;l2:y1:_;y19:%25residual-string<=?;;",

  0,
  "&0{%2.1%s,.1%sS>!]2}@!(y19:%25residual-string<=?)",

  "string>?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25sgt;l2:y4:%25cks;"
  "y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residual"
  "-string>?;y12:syntax-rules;;;l2:y1:_;y18:%25residual-string>?;;",
  ...
  "string>=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y4:%25sge;l2:y4:%25cks;"
  "y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py19:%25residual"
  "-string>=?;y12:syntax-rules;;;l2:y1:_;y19:%25residual-string>=?;;",
  ...
  "string-ci-cmp",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y6:%25sicmp;l2:y4:%25ck"
  "s;y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py20:%25residu"
  "al-string-cmp;y12:syntax-rules;;;l2:y1:_;y20:%25residual-string-cmp;;",

  0,
  "&0{%2.1%s,.1%sO3]2}@!(y20:%25residual-string-cmp)",

  "string-ci=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25sieq;l2:y4:%25cks"
  ";y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-string<?;y12:syntax-rules;;;l2:y1:_;y18:%25residual-string<?;;",

  0,
  "&0{%2.1%s,.1%sSi=]2}@!(y18:%25residual-string<?)",

  "string-ci<?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25silt;l2:y4:%25cks"
  ";y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-string<?;y12:syntax-rules;;;l2:y1:_;y18:%25residual-string<?;;",
  ...
  "string-ci<=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25sile;l2:y4:%25cks"
  ";y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py19:%25residua"
  "l-string<=?;y12:syntax-rules;;;l2:y1:_;y19:%25residual-string<=?;;",

  0,
  "&0{%2.1%s,.1%sSi>!]2}@!(y19:%25residual-string<=?)",

  "string-ci>?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25sigt;l2:y4:%25cks"
  ";y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py18:%25residua"
  "l-string>?;y12:syntax-rules;;;l2:y1:_;y18:%25residual-string>?;;",
  ...
  "string-ci>=?",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:y;;l3:y5:%25sige;l2:y4:%25cks"
  ";y1:x;;l2:y4:%25cks;y1:y;;;;l2:py1:_;y12:syntax-rules;;py19:%25residua"
  "l-string>=?;y12:syntax-rules;;;l2:y1:_;y19:%25residual-string>=?;;",
  ...
  "string->list",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25stol;l2:y4:%25cks;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py22:%25residual-string->list;y12:synta"
  "x-rules;;;l2:y1:_;y22:%25residual-string->list;;",

  0,
  "&0{%1.0%sX2]1}@!(y22:%25residual-string->list)",

  "list->string",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25ltos;l2:y4:%25ckl;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py22:%25residual-list->string;y12:synta"
  "x-rules;;;l2:y1:_;y22:%25residual-list->string;;",

  0,
  "&0{%1.0%lX3]1}@!(y22:%25residual-list->string)",

  "fixnum->string",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:r;;l3:y5:%25itos;l2:y4:%25cki"
  ";y1:x;;l2:y4:%25cki;y1:r;;;;l2:py1:_;y12:syntax-rules;;py24:%25residua"
  "l-fixnum->string;y12:syntax-rules;;;l2:y1:_;y24:%25residual-fixnum->st"
  "ring;;",
  ...
  "string->fixnum",
  "l5:y12:syntax-rules;n;l2:l3:y1:_;y1:x;y1:r;;l3:y5:%25stoi;l2:y4:%25cks"
  ";y1:x;;l2:y4:%25cki;y1:r;;;;l2:py1:_;y12:syntax-rules;;py24:%25residua"
  "l-string->fixnum;y12:syntax-rules;;;l2:y1:_;y24:%25residual-string->fi"
  "xnum;;",
  ...
  "flonum->string",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25jtos;l2:y4:%25ckj;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py24:%25residual-flonum->string;y12:syn"
  "tax-rules;;;l2:y1:_;y24:%25residual-flonum->string;;",

  0,
  "&0{%1.0%jE6]1}@!(y24:%25residual-flonum->string)",

  "string->flonum",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25stoj;l2:y4:%25cks;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py24:%25residual-string->flonum;y12:syn"
  "tax-rules;;;l2:y1:_;y24:%25residual-string->flonum;;",
  ...
  "open-input-file",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25otip;l2:y4:%25cks;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py25:%25residual-open-input-file;y12:sy"
  "ntax-rules;;;l2:y1:_;y25:%25residual-open-input-file;;",

  0,
  "&0{%1.0%sP40]1}@!(y25:%25residual-open-input-file)",

  "open-output-file",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y5:%25otop;l2:y4:%25cks;y1:x"
  ";;;;l2:py1:_;y12:syntax-rules;;py26:%25residual-open-output-file;y12:s"
  "yntax-rules;;;l2:y1:_;y26:%25residual-open-output-file;;",

  0,
  "&0{%1.0%sP41]1}@!(y26:%25residual-open-output-file)",

  "open-input-string",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y4:%25ois;l2:y4:%25cks;y1:x;"
  ";;;l2:py1:_;y12:syntax-rules;;py27:%25residual-open-input-string;y12:s"
  "yntax-rules;;;l2:y1:_;y27:%25residual-open-input-string;;",

  0,
  "&0{%1.0%sP50]1}@!(y27:%25residual-open-input-string)",

  "close-input-port",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y4:%25cip;l2:y4:%25ckr;y1:x;"
  ";;;l2:py1:_;y12:syntax-rules;;py26:%25residual-close-input-port;y12:sy"
  "ntax-rules;;;l2:y1:_;y26:%25residual-close-input-port;;",

  0,
  "&0{%1.0%rP60]1}@!(y26:%25residual-close-input-port)",

  "close-output-port",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y4:%25cop;l2:y4:%25ckw;y1:x;"
  ";;;l2:py1:_;y12:syntax-rules;;py27:%25residual-close-output-port;y12:s"
  "yntax-rules;;;l2:y1:_;y27:%25residual-close-output-port;;",

  0,
  "&0{%1.0%wP61]1}@!(y27:%25residual-close-output-port)",

  "get-output-string",
  "l5:y12:syntax-rules;n;l2:l2:y1:_;y1:x;;l2:y4:%25gos;l2:y4:%25ckw;y1:x;"
  ";;;l2:py1:_;y12:syntax-rules;;py27:%25residual-get-output-string;y12:s"
  "yntax-rules;;;l2:y1:_;y27:%25residual-get-output-string;;",
