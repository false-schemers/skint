...
char *s_code[] = {
  ...
  "%1,#0&0{%3.2?{.2,.2,'(i10),.3Nj,@(y15:inexact->string)[34}'(i10),.1E8]"
  "3}.!0.1,.1,&2{%4,,,,#0#1#2#3'0,.7<!?{:1}{f}.!0'0,.7<!?{'(i100),.7>!?{."
  "6}{f}}{f}.!1.4N0?{${.3^,.3^,.8,:0^[03}}{.4}.!2.2^S0?{.2^S3}{f}.!3.3^?{"
  ".3^,.6>}{f}?{.7,'(c ),.5^,.8-S2W4}.7,.3^W4]8}]2",
