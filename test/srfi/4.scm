...
(cond-expand
  (full-numeric-tower
   (let ((read-str (lambda (s) (read (open-input-string s)))))

     (let ((max-u32 (read-str "4294967295")))
       ...
       (test 1024 (u32vector-length (make-u32vector 1024 max-u32)))
       (test 3 (u32vector-length (u32vector 0 1 2)))
       (test 0 (u32vector-ref (u32vector 0 1 2) 0))
       (test 1 (u32vector-ref (u32vector 0 1 2) 1))
       (test 2 (u32vector-ref (u32vector 0 1 2) 2))
       (test (list 0 max-u32 2) (let ((bv (u32vector 0 1 2))) (u32vector-set! bv 1 max-u32) (u32vector->list bv)))
       ...
       (test '(1 2) (u32vector->list (u32vector 0 1 2) 1))
       (test '(1) (u32vector->list (u32vector 0 1 2) 1 2))
       (test '() (u32vector->list (u32vector 0 1 2) 2 2))
       (test '() (u32vector->list (list->u32vector '())))
       (test '(24 42) (u32vector->list (list->u32vector '(24 42)))))

     (let ((min-s32 (read-str "-2147483648"))
           (max-s32 (read-str "2147483647")))
       ...
       (test 1024 (s32vector-length (make-s32vector 1024 min-s32)))
       ...
       (test (list -1 max-s32 1) (let ((bv (s32vector -1 0 1))) (s32vector-set! bv 1 max-s32) (s32vector->list bv)))
       (test '() (s32vector->list (s32vector)))
       (test '(-1 0 1) (s32vector->list (s32vector -1 0 1)))
       (test '(-1 0 1) (s32vector->list (s32vector -1 0 1) 0))
       (test '(-1 0 1) (s32vector->list (s32vector -1 0 1) 0 3))
       (test '(0 1) (s32vector->list (s32vector -1 0 1) 1))
       (test '(0) (s32vector->list (s32vector -1 0 1) 1 2))
       (test '() (s32vector->list (s32vector -1 0 1) 2 2))
       (test '() (s32vector->list (list->s32vector '())))
       (test (list min-s32 max-s32) (s32vector->list (list->s32vector (list min-s32 max-s32)))))

     (let ((max-u64 (read-str "18446744073709551615")))
       ...
       (test 1024 (u64vector-length (make-u64vector 1024 max-u64)))
       ...
       (test (list 0 max-u64 2) (let ((bv (u64vector 0 1 2))) (u64vector-set! bv 1 max-u64) (u64vector->list bv)))
       ...
       (test '(1 2) (u64vector->list (u64vector 0 1 2) 1))
       (test '(1) (u64vector->list (u64vector 0 1 2) 1 2))
       (test '() (u64vector->list (u64vector 0 1 2) 2 2))
       (test '() (u64vector->list (list->u64vector '())))
       (test (list max-u64 42) (u64vector->list (list->u64vector (list max-u64 42)))))

     (let ((min-s64 (read-str "-9223372036854775808"))
           (max-s64 (read-str "9223372036854775807")))
       ...
       (test 1024 (s64vector-length (make-s64vector 1024 min-s64)))
       ...
       (test (list -1 max-s64 1) (let ((bv (s64vector -1 0 1))) (s64vector-set! bv 1 max-s64) (s64vector->list bv)))
       ...
       (test '(0 1) (s64vector->list (s64vector -1 0 1) 1))
       (test '(0) (s64vector->list (s64vector -1 0 1) 1 2))
       (test '() (s64vector->list (s64vector -1 0 1) 2 2))
       (test '() (s64vector->list (list->s64vector '())))
       (test (list min-s64 max-s64) (s64vector->list (list->s64vector (list min-s64 max-s64))))))))
