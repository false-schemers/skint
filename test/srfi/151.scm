...
(define-syntax test-out-of-range
  (syntax-rules ()
    ((test-out-of-range name expr) 
     (test-out-of-range expr))
    ((test-out-of-range expr)
     (cond-expand 
        (full-numeric-tower 
          (test #t (bignum? expr)))
...
(test-out-of-range (bit-field-replace -42 0 1000000 1000100)) 
(test-out-of-range (bit-field-replace 42 -1 1000000 1000100))
(test -42 (bit-field-replace-same -42 -1 1000000 1000100))
(test 42 (bit-field-replace-same 42 1 1000000 1000100))
(test-out-of-range (bit-field-replace-same -42 0 1000000 1000100)) 
(test-out-of-range (bit-field-replace-same 42 -1 1000000 1000100))
(test -42 (bit-field-set -42 1000000 1000100))
(test 42 (bit-field-clear 42 1000000 1000100))
(test-out-of-range (bit-field-set 42 1000000 1000100)) 
(test-out-of-range (bit-field-clear -42 1000000 1000100))
(test -42 (bit-swap 1000000 1000100 -42))
(test 42 (bit-swap 1000000 1000100 42))
(test -1 (bit-swap 1000000 0 -1))
(test 0 (bit-swap 1000000 0 0))
(test-out-of-range (bit-swap 1000000 0 1))
...
(test 1267650600228229401496703205375 (bit-field -42 1000000 1000100))

;; more Chibi tests for full tower
