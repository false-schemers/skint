...
(define-s19-test! "TAI-UTC Conversions"
  (lambda ()
    (and
     (test-one-utc-tai-edge 915148800.0  32 31)
     (test-one-utc-tai-edge 867715200.0  31 30)
     (test-one-utc-tai-edge 820454400.0  30 29)
     (test-one-utc-tai-edge 773020800.0  29 28)
     (test-one-utc-tai-edge 741484800.0  28 27)
     (test-one-utc-tai-edge 709948800.0  27 26)
     (test-one-utc-tai-edge 662688000.0  26 25)
     (test-one-utc-tai-edge 631152000.0  25 24)
     (test-one-utc-tai-edge 567993600.0  24 23)
     (test-one-utc-tai-edge 489024000.0  23 22)
     (test-one-utc-tai-edge 425865600.0  22 21)
     (test-one-utc-tai-edge 394329600.0  21 20)
     (test-one-utc-tai-edge 362793600.0  20 19)
     (test-one-utc-tai-edge 315532800.0  19 18)
     (test-one-utc-tai-edge 283996800.0  18 17)
     (test-one-utc-tai-edge 252460800.0  17 16)
     (test-one-utc-tai-edge 220924800.0  16 15)
     (test-one-utc-tai-edge 189302400.0  15 14)
     (test-one-utc-tai-edge 157766400.0  14 13)
     (test-one-utc-tai-edge 126230400.0  13 12)
     (test-one-utc-tai-edge 94694400.0   12 11)
     (test-one-utc-tai-edge 78796800.0   11 10)
     (test-one-utc-tai-edge 63072000.0   10 0)
     (test-one-utc-tai-edge 0.0   0 0) ;; at the epoch
     (test-one-utc-tai-edge 10.0   0 0) ;; close to it ...
     (test-one-utc-tai-edge 1045789645.0 32 32) ;; about now ...
     )))
