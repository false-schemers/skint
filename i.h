...
declare_instruction(isqrt,      "It\0f",        0,  "%fxsqrt",                  'b', AUTOGL)
...
declare_instruction(ilen,       "D8",           0,  "fxlength",                 '1', AUTOGL)
declare_instruction(ibtc,       "D8!",          0,  "fxbit-count",              '1', AUTOGL)
...
declare_instruction(ifmar,      "Dr",           0,  "fxfmar",                   '4', AUTOGL)
...
declare_instruction(jldexp,     "M00",          0,  "flldexp",                  '2', AUTOGL)
declare_instruction(jmodf,      "M01",          0,  "flmodf",                   '2', AUTOGL)
declare_instruction(jfrexp,     "M02",          0,  "flfrexp",                  '2', AUTOGL)
declare_instruction(jsinh,      "M03",          0,  "flsinh",                   '1', AUTOGL)
declare_instruction(jcosh,      "M04",          0,  "flcosh",                   '1', AUTOGL)
declare_instruction(jtanh,      "M05",          0,  "fltanh",                   '1', AUTOGL)
declare_instruction(jlog10,     "M06",          0,  "fllog10",                  '1', AUTOGL)
#ifdef C99_MATH_LIB
declare_instruction(jcopysign,  "M10",          0,  "flcopysign",               '2', AUTOGL)
declare_instruction(jsignbit,   "M11",          0,  "flsign-bit",               '1', AUTOGL)
declare_instruction(jnextafter, "M12",          0,  "fladjacent",               '2', AUTOGL)
declare_instruction(jnormalp,   "M13",          0,  "flnormalized?",            '1', AUTOGL)
declare_instruction(jsubnormp,  "M14",          0,  "fldenormalized?",          '1', AUTOGL)
declare_instruction(jlogb,      "M15",          0,  "flexponent",               '1', AUTOGL)
declare_instruction(jilogb,     "M16",          0,  "flilogb",                  '1', AUTOGL)
declare_instruction(jfma,       "M17",          0,  "fl+*",                     '3', AUTOGL)
declare_instruction(jfdim,      "M18",          0,  "flposdiff",                '2', AUTOGL)
declare_instruction(jexp2,      "M19",          0,  "flexp2",                   '1', AUTOGL)
declare_instruction(jexpm1,     "M20",          0,  "flexp-1",                  '1', AUTOGL)
declare_instruction(jcbrt,      "M21",          0,  "flcbrt",                   '1', AUTOGL)
declare_instruction(jhypot,     "M22",          0,  "flhypot",                  '2', AUTOGL)
declare_instruction(jlog1p,     "M23",          0,  "fllog1+",                  '1', AUTOGL)
declare_instruction(jlog2,      "M24",          0,  "fllog2",                   '1', AUTOGL)
declare_instruction(jasinh,     "M25",          0,  "flasinh",                  '1', AUTOGL)
declare_instruction(jacosh,     "M26",          0,  "flacosh",                  '1', AUTOGL)
...
declare_instruction(realp,      "Ns",           0,  "real?",                    '1', AUTOGL)
declare_instruction(ratp,       "Nv",           0,  "rational?",                '1', AUTOGL)
declare_instruction(intp,       "Nw",           0,  "integer?",                 '1', AUTOGL)
declare_instruction(exip,       "Nw!",          0,  "exact-integer?",           '1', AUTOGL)
...
declare_instruction(ntoex,      "Ni",           0,  "exact",                    '1', AUTOGL)
declare_instruction(ntoin,      "Nj",           0,  "inexact",                  '1', AUTOGL)
declare_instruction(exnp,       "Ti",           0,  "exact?",                   '1', AUTOGL)
declare_instruction(innp,       "Tj",           0,  "inexact?",                 '1', AUTOGL)
declare_instruction(bigp,       "Tb",           0,  "bignum?",                  '1', AUTOGL)
declare_instruction(ranp,       "Tr",           0,  "ratnum?",                  '1', AUTOGL)
declare_instruction(conp,       "Tc",           0,  "compnum?",                 '1', AUTOGL)
declare_instruction(renp,       "Tt",           0,  "rectnum?",                 '1', AUTOGL)
declare_instruction(numer,      "Gn",           0,  "numerator",                '1', AUTOGL)
declare_instruction(denom,      "Gd",           0,  "denominator",              '1', AUTOGL)
declare_instruction(rpart,      "Gr",           0,  "real-part",                '1', AUTOGL)
...
declare_instruction(gnot,       "G0",           0,  "bitwise-not",              '1', AUTOGL)
declare_instruction(gand,       "G1\0'(i-1)",   0,  "bitwise-and",              'p', AUTOGL)
...
declare_instruction(ssto8,      "S9",           0,  "substring->utf8",          '3', AUTOGL)
...
declare_instruction(ttyp,       "P09\0Po",      0,  "tty-port?",                'u', AUTOGL)
...
declare_instruction(fip,        "P70\0Pi",      0,  "clear-input-port",         'u', AUTOGL)
declare_instruction(fop,        "P71\0Po",      0,  "flush-output-port",        'u', AUTOGL)
declare_instruction(pposcaps,   "P75",          0,  "%port-poscaps",            '1', AUTOGL)
declare_instruction(ptell,      "P76",          0,  "%port-tell",               '1', AUTOGL)
declare_instruction(pseek,      "P77",          0,  "%port-seek",               '3', AUTOGL)
...
declare_instruction(utime,      "Zt",           0,  "%microtime",               '0', AUTOGL)
declare_instruction(uclock,     "Zk",           0,  "%microclock",              '0', AUTOGL)
declare_instruction(tzoff,      "Zz",           0,  "%tz-offset",               '0', AUTOGL)
