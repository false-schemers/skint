...
declare_instruction(isip,       "Ti",           0,  "exact?",                   '1', AUTOGL)
declare_instruction(isjp,       "Tj",           0,  "inexact?",                 '1', AUTOGL)
declare_instruction(bigp,       "Tb",           0,  "bignum?",                  '1', AUTOGL)
declare_instruction(rtnp,       "Tr",           0,  "ratnum?",                  '1', AUTOGL)
declare_instruction(comp,       "Tc",           0,  "compnum?",                 '1', AUTOGL)
declare_instruction(rctp,       "Tt",           0,  "rectnum?",                 '1', AUTOGL)
...
#if 0
/* future instructions */
declare_instruction(gnot,       "N90",          0,  "lognot",                   '1', AUTOGL)
declare_instruction(gand,       "N91\0'(i-1)",  0,  "logand",                   'p', AUTOGL)
declare_instruction(gior,       "N92\0'0",      0,  "logior",                   'p', AUTOGL)
declare_instruction(gxor,       "N93\0'0",      0,  "logxor",                   'p', AUTOGL)
declare_instruction(gash,       "N94",          0,  "ash",                      '2', AUTOGL)
declare_instruction(glen,       "N97",          0,  "loglen",                   '1', AUTOGL)
declare_instruction(gbitc,      "N98",          0,  "logbitc",                  '1', AUTOGL)
...
declare_instruction(sinh,       "G03",          0,  "sinh",                     '1', AUTOGL)
declare_instruction(cosh,       "G04",          0,  "cosh",                     '1', AUTOGL)
declare_instruction(tanh,       "G05",          0,  "tanh",                     '1', AUTOGL)
declare_instruction(log10,      "G06",          0,  "fllog10",                  '1', AUTOGL)
declare_instruction(asinh,      "G25",          0,  "asinh",                    '1', AUTOGL)
declare_instruction(acosh,      "G26",          0,  "acosh",                    '1', AUTOGL)
declare_instruction(atanh,      "G27",          0,  "atanh",                    '1', AUTOGL)
#endif
